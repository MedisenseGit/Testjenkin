	...
	else if($login_type == 2) 	// Type-2 Referring Partners
	{
		...
		if($getMappedDoctors == true) {
			foreach($getMappedDoctors as $hospList){
				...
				$result_doctor = $objQuery->mysqlSelect("a.ref_id as ref_id,a.ref_name as doc_name, a.doc_age as doc_age, a.ref_exp as doc_exp, a.doc_photo as doc_photo,  a.doc_qual as doc_qual,b.spec_id as spec_id, b.spec_name as spec_name","referal as a inner join specialization as b on a.doc_spec=b.spec_id inner join doctor_hosp as c on c.doc_id=a.ref_id inner join mapping_hosp_referrer as d on d.hosp_id=c.hosp_id","(a.doc_spec!=555 and a.anonymous_status!=1) and (c.hosp_id='".$hospList['hosp_id']."')","a.doc_type_val asc","","","0,10");
...
/*	$result_doctor = $objQuery->mysqlSelect('a.ref_id as ref_id, a.ref_name as doc_name, a.doc_age as doc_age, a.ref_exp as doc_exp, a.doc_photo as doc_photo, a.doc_qual as doc_qual, b.spec_id as spec_id, b.spec_name as spec_name','referal as a inner join specialization as b on a.doc_spec = b.spec_id',"","","","","0,10");
