...
$objQuery = new CLSQueryMaker();
 ...
 if( (API_KEY == $_POST['API_KEY']) || isset($_POST['login_type']) || isset($_POST['userid'])) {
	...
	{
		$postResult = $objQuery->mysqlSelect("*","blogs_offers_events_listing","","Create_Date desc","","","0,10");
		foreach($postResult as $postResultList){
			...
			if($postResultList['listing_type']=="Blog"){
				...
				$getPostResult = $objQuery->mysqlSelect("post_id as post_id,Login_User_Id as Login_User_Id, post_tittle as title, post_description as description, post_image as post_image, post_date as created_date,company_id as company_id, postkey as transaction_id, num_views as num_views","home_posts","post_id='".$postResultList['listing_type_id']."'","","","","");
				...
				$from_to_date = "";					
							...
							//$getPostResult = $objQuery->mysqlSelect("event_id as post_id,company_id as company_id, title as title,  description as description, photo as post_image, start_end_date as created_date, job_contact_info as contact_info, description_attachment as attachments, event_trans_id as transaction_id, num_views as num_views","offers_events","event_id='".$postResultList['listing_type_id']."' and event_type=2","","","","");
							//$postdate=$getPostResult[0]['created_date'];	

							$getPostResult = $objQuery->mysqlSelect("event_id as post_id,company_id as company_id, title as title,  description as description, photo as post_image, start_end_date as created_date, start_date as 	start_date, end_date as end_date, job_contact_info as contact_info, description_attachment as attachments, event_trans_id as transaction_id, num_views as num_views","offers_events","event_id='".$postResultList['listing_type_id']."' and event_type=2","","","","");
		...
		foreach($postResult as $postResultList){
			...
			if($postResultList['listing_type']=="Blog"){
				...
				$from_to_date = "";			
							...
							$getPostResult = $objQuery->mysqlSelect("event_id as post_id, title as title,company_id as company_id,  description as description, photo as post_image, start_end_date as created_date, start_date as 	start_date, end_date as end_date, job_contact_info as contact_info, description_attachment as attachments, event_trans_id as transaction_id, num_views as num_views","offers_events","event_id='".$postResultList['listing_type_id']."' and event_type=2","","","","");
							$from_to_date = $getPostResult[0]['start_date']." / ".$getPostResult[0]['end_date'];
							$postdate=$from_to_date;
							...
							$getPostResult = $objQuery->mysqlSelect("event_id as post_id, title as title, company_id as company_id,  description as description, photo as post_image, start_date as created_date, 	start_date as 	start_date, end_date as end_date, job_contact_info as contact_info, description_attachment as attachments, event_trans_id as transaction_id, num_views as num_views","offers_events","event_id='".$postResultList['listing_type_id']."' and event_type=1","","","","");
							$from_to_date = $getPostResult[0]['start_date']." / ".$getPostResult[0]['end_date'];
							$postdate=$from_to_date;
