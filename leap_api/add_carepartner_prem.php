...
if(API_KEY == $_POST['API_KEY']) {
	...
	if($login_type == 1) {		// Hospital Doctor Login
		...
		$chkMappedReferrer = $objQuery->mysqlSelect("*","mapping_hosp_referrer","partner_id='".$chkPartner[0]['partner_id']."' and hosp_id='".$selectHosp."'","","","","");
		...
		$compLogo='https://medisensecrm.com/premium/company_logo/'.$get_organisation[0]['Comp_Id'].'/'.$get_organisation[0]['Logo'];
