 ...
 if(API_KEY == $_POST['API_KEY'] ) {
	...
	if($login_type == 1) {	
		...
		foreach($get_Episodes as $listEpisode){
			...
			$examination_result = $objQuery->mysqlSelect('a.examination_id as examination_autoid, a.examination as examination_id, b.examination as examination_name, a.exam_result as exam_result, a.findings as findings, a.patient_id as patient_id, a.episode_id as episode_id, a.doc_id as doc_id, a.doc_type as doc_type','doc_patient_examination_active as a inner join examination as b on a.examination = b.examination_id',"a.episode_id='".$listEpisode['episode_id']."' and a.patient_id='".$listEpisode['patient_id']."'","","","","");
