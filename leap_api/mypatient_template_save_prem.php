...
//Appointment List
 if(API_KEY == $_POST['API_KEY']) {
	...
	$TransId=time();
		...
		$usercraete=$objQuery->mysqlInsert('doc_patient_episode_prescription_templates',$arrFields,$arrValues);
		...
		/* save for template table Ends here */
				...
				//	$prescription_instruction = $_POST['prescription_instruction'][$key];
					$prescription_timings = $_POST['prescription_timings'][$key];
					$prescription_duration = $_POST['prescription_duration'][$key];
					$prescription_ppID = $_POST['prescription_pp_id'][$key];
					...
					if($prescription_trade_name != "" && $prescription_generic_name != "" )
					{
						...
						$arrFieldsPEP[] = 'pp_id';
						$arrValuesPEP[] = $prescription_ppID;
						$arrFieldsPEP[] = 'doc_id';
						$arrValuesPEP[] = $admin_id;
						$arrFieldsPEP[] = 'doc_type';
						$arrValuesPEP[] = '1';
						...
						$arrFieldsPEP[] = 'prescription_timing';
						$arrValuesPEP[] = $prescription_timings;
						$arrFieldsPEP[] = 'prescription_duration';
						...
						$insert_patient_episode_prescriptions = $objQuery->mysqlInsert('doc_medicine_prescription_template_details',$arrFieldsPEP,$arrValuesPEP);
