...
//Attachment
 if(API_KEY == $_POST['API_KEY'] && isset($_POST['patient_id']) ) {
	...
	$count_res = $objQuery->mysqlSelect('count(attach_id) as count','doc_patient_attachments',"my_patient_id='".$patient_id."'","","","","");
	// echo $count_res;
	
	$attachment_res = $objQuery->mysqlSelect('*','doc_patient_attachments',"my_patient_id='".$patient_id."' and episode_id='".$episode_id."'","","","","");
