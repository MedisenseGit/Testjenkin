...
if(API_KEY == $_POST['API_KEY']) {	 
	...
	$checkApplicant = $objQuery->mysqlSelect("*","job_event_application","job_id='".$event_id."' and applicant_id='".$doctor_id."' and applicant_type='2' and type='Job'","","","","");
	...
	$getApplicantDetails = $objQuery->mysqlSelect("a.ref_name as Doc_Name,a.ref_mail as Email_id,a.contact_num as Contact_num,b.spec_name as Specialization","referal as a left join specialization as b on a.doc_spec=b.spec_id","a.ref_id='".$doctor_id."'" ,"","","","");
