...
//Practice Doctor Lists
 if(API_KEY == $_POST['API_KEY']) {
	...
	if($login_type==1)   //login type 1 for doctors
	{
		...
		$hospital_id = $getHospital[0]['hosp_id'];
		 ...
		 if($doctor_type == 1) {
			...
			$result_doctor = $objQuery->mysqlSelect("a.ref_id as ref_id,a.ref_name as doc_name, a.doc_age as doc_age, a.ref_exp as doc_exp, a.doc_photo as doc_photo,  a.doc_qual as doc_qual,b.spec_id as spec_id, b.spec_name as spec_name, a.ref_address as ref_address","referal as a inner join specialization as b on a.doc_spec=b.spec_id inner join doctor_hosp as c on a.ref_id = c.doc_id ","a.anonymous_status!=1","a.doc_type_val asc","","","0,10");
			} else {
			$result_doctor = $objQuery->mysqlSelect("a.ref_id as ref_id,a.ref_name as doc_name, a.doc_age as doc_age, a.ref_exp as doc_exp, a.doc_photo as doc_photo,  a.doc_qual as doc_qual,b.spec_id as spec_id, b.spec_name as spec_name, a.ref_address as ref_address","referal as a inner join specialization as b on a.doc_spec=b.spec_id inner join doctor_hosp as c on a.ref_id = c.doc_id ","a.anonymous_status!=1 and c.hosp_id='".$hospital_id."'","a.doc_type_val asc","","","0,10");
			}	
			...
			$result_doctor = $objQuery->mysqlSelect("a.ref_id as ref_id,a.ref_name as doc_name,a.doc_age as doc_age, a.doc_type_val as doc_type_val,a.ref_exp as doc_exp,a.ref_address as ref_address,a.doc_state as doc_state, a.doc_photo as doc_photo,a.doc_qual as doc_qual, b.spec_id as spec_id, b.spec_name as spec_name, a.ref_address as ref_address","referal as a inner join specialization as b on b.spec_id=a.doc_spec inner join doctor_hosp as c on c.doc_id=a.ref_id","a.anonymous_status!=1 and a.doc_spec='".$spec_id."'","a.doc_type_val asc","","","0,10");
			} else {
			$result_doctor = $objQuery->mysqlSelect("a.ref_id as ref_id,a.ref_name as doc_name,a.doc_age as doc_age, a.doc_type_val as doc_type_val,a.ref_exp as doc_exp,a.ref_address as ref_address,a.doc_state as doc_state, a.doc_photo as doc_photo,a.doc_qual as doc_qual, b.spec_id as spec_id, b.spec_name as spec_name, a.ref_address as ref_address","referal as a inner join specialization as b on b.spec_id=a.doc_spec inner join doctor_hosp as c on c.doc_id=a.ref_id","a.anonymous_status!=1 and a.doc_spec='".$spec_id."' and c.hosp_id='".$hospital_id."'","a.doc_type_val asc","","","0,10");
			}	
			$success = array('status' => "true","doctor_list" => $result_doctor);
			echo json_encode($success);
		} 
		else if($doctor_type == 6) {
			$result_doctor = $objQuery->mysqlSelect("a.ref_id as ref_id,a.ref_name as doc_name,a.doc_age as doc_age, a.doc_type_val as doc_type_val,a.ref_exp as doc_exp,a.ref_address as ref_address,a.doc_state as doc_state, a.doc_photo as doc_photo,a.doc_qual as doc_qual, b.spec_id as spec_id, b.spec_name as spec_name, a.ref_address as ref_address","referal as a inner join specialization as b on b.spec_id=a.doc_spec inner join doctor_hosp as c on c.doc_id=a.ref_id","a.doc_spec!=555 and a.anonymous_status!=1 and c.hosp_id='".$spec_id."'","a.doc_type_val asc","","","0,10");
			$success = array('status' => "true","doctor_list" => $result_doctor);
			echo json_encode($success);
		} 
		else{
	...
	else if($login_type==3)  //login type 3 for marketing person
	{
			...
			$result_doctor = $objQuery->mysqlSelect("a.partner_id as ref_id,a.contact_person as doc_name, a.doc_age as doc_age, a.ref_exp as doc_exp, a.doc_photo as doc_photo,a.doc_qual as doc_qual,b.spec_id as spec_id, b.spec_name as spec_name, a.location as ref_address","our_partners as a inner join specialization as b on a.specialisation=b.spec_id inner join mapping_hosp_referrer as c on c.partner_id=a.partner_id","c.market_person_id='".$doctor_id."'","","","","0,10");
