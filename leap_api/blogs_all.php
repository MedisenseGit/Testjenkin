...
$objQuery = new CLSQueryMaker();
 ...
 if( (API_KEY == $_POST['API_KEY']) || isset($_POST['login_type']) || isset($_POST['userid'])) {
	...
	{
		$postResult = $objQuery->mysqlSelect("*","blogs_offers_events_listing","","Create_Date desc","","","");
		foreach($postResult as $postResultList){
			...
			if($postResultList['listing_type']=="Blog"){
				...
				$from_to_date = "";				
							...
							$getPostResult = $objQuery->mysqlSelect("event_id as post_id,company_id as company_id, title as title,  description as description, photo as post_image, created_date as created_date, start_date as start_date, end_date as end_date, job_contact_info as contact_info, description_attachment as attachments, event_trans_id as transaction_id, num_views as num_views","offers_events","event_id='".$postResultList['listing_type_id']."' and event_type=2","","","","");
