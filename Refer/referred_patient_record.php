           ...
           <?php include_once('header_top_nav.php'); ?>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>All Patient Records<small>Total Count: <?php echo $TotalCount[0]['Result_Count']; ?></small></h2>
					...
					<table id="" class="table table-striped table-bordered">
					  ...
					  <?php foreach($allRecord as $list){ 
										...
										<tr>
											...
											$getDocDet = $objQuery->mysqlSelect("a.ref_name as Doc_Name,c.hosp_name as Doc_Hosp,c.hosp_city as Hosp_City","referal as a inner join doctor_hosp as b on a.ref_id=b.doc_id inner join hosp_tab as c on c.hosp_id=b.hosp_id inner join specialization as d on d.spec_id=a.doc_spec","a.ref_id='".$listDoc['Doc_Id']."'","","","","");
											?>
