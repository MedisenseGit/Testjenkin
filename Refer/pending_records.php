...
$allRecord = $objQuery->mysqlSelect('DISTINCT(a.patient_id) as Patient_Id','patient_tab as a inner join patient_referal as b on a.patient_id=b.patient_id inner join source_list as c on c.source_id=a.patient_src',"(c.partner_id='".$admin_id."') and (b.bucket_status=2)","a.patient_id desc","","","$eu, $limit");			
$pag_result = $objQuery->mysqlSelect("DISTINCT(a.patient_id) as Patient_Id","patient_tab as a inner join patient_referal as b on a.patient_id=b.patient_id inner join source_list as c on c.source_id=a.patient_src","(c.partner_id='".$admin_id."') and (b.bucket_status=2)","a.patient_id desc");
           ...
           <?php include_once('header_top_nav.php'); ?>
			...
			<form method="post" action="add_details.php" name="frmSrchBox">
			 <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 pull-right form-group top_search">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Pending Records<small>Total Count: <?php echo $_SESSION['tot_pending_count']; ?></small></h2>
