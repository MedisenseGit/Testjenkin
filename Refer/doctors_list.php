		...
		<input type="hidden" name="postTextSrch" value="" />
			 <div class="title_right">
				...
				<div style="margin-left:20px;"><label>Search Doctors :</label><br>  <input type="radio" name="searchType" value="1">  My Conncetions <input type="radio" name="searchType" value="2" checked>   Universal</div>
                  <div class="input-group">
                    <input type="text" name="postTextSrch" class="form-control" required="required" placeholder="Ex: Cardio Bangalore...">
				...
				<div class="row">
				 <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <?php if(empty($_GET['f']) && empty($_GET['s'])) {  ?><ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          ...
                          <li role="presentation" class=""><a href="#universal" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">All Doctors <span class="badge bg-red" style="font-size:8px;"><?php echo $_SESSION['universal_doc']; ?></span></a>
                          </li>
						  <li role="presentation" class=""><a href="#diagnostics" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Diagnostics <span class="badge bg-red" style="font-size:8px;"><?php echo $_SESSION['diagnostics_center']; ?></span></a>
                          </li>
						  <li role="presentation" class=""><a href="#onlinepharma" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Online Pharmacy <span class="badge bg-red" style="font-size:8px;"><?php echo $_SESSION['online_pharma']; ?></span></a>
                          </li>
						 ...
						 //get only Filter Value hospital doctors list	
							if(isset($_GET['f'])){
								$getFilterVal = $objQuery->mysqlSelect("a.ref_id as Ref_Id","referal as a inner join specialization as b on b.spec_id=a.doc_spec inner join doctor_hosp as c on c.doc_id=a.ref_id","a.doc_spec!=555 and a.anonymous_status!=1 and a.doc_spec='".$_GET['f']."'","a.doc_type_val asc","","","");
					...
					$getDocVal = $objQuery->mysqlSelect("a.ref_name as Ref_Name,a.doc_type_val as Doc_Type,a.ref_exp as Ref_Exp,a.ref_address as Ref_Address,a.doc_state as Doc_State,a.doc_photo as Doc_Image,b.spec_name as Specialization","referal as a inner join specialization as b on b.spec_id=a.doc_spec inner join doctor_hosp as c on c.doc_id=a.ref_id inner join hosp_tab as d on d.hosp_id=c.hosp_id","a.ref_id='".$getList['Ref_Id']."'","a.doc_type_val asc","","","");
                        ...
                        <div class="well profile_view">
                          ...
                          <div class="col-xs-12 bottom text-center">
							...
							<input type="hidden" name="ref_id" value="<?php echo $getList['Ref_Id']; ?>" />
                              <a href="Refer-Patient?d=<?php echo md5($getList['Ref_Id']); ?>&start=<?php echo $_GET['start']; ?>"><button type="button" name="cmdRefer" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="bottom" title="Send Case to doctor">
                                <i class="fa fa-user"> </i> SEND CASE</button></a>
					...
					?>
					  ...
					  <div role="tabpanel" class="tab-pane fade" id="diagnostics" aria-labelledby="home-tab">
									...
									<div class="x_panel">
									  <div class="x_content">
										<div class="row">
										  ...
										  <?php 
					//get only mapped hospital doctors list			
					$getDiagnostics = $objQuery->mysqlSelect("DISTINCT(a.ref_id) as Ref_Id,a.ref_name as Ref_Name,a.doc_type_val as Doc_Type,a.ref_exp as Ref_Exp,a.ref_address as Ref_Address,a.doc_state as Doc_State,a.doc_photo as Doc_Image,b.spec_name as Specialization","referal as a inner join specialization as b on b.spec_id=a.doc_spec inner join doctor_hosp as c on c.doc_id=a.ref_id","a.anonymous_status!=1 and a.doc_spec=89","a.doc_type_val asc","","","");
					
					
					if($getDiagnostics==true){
										
					foreach($getDiagnostics as $getList){ ?>
                     <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <!--<h4 class="brief"><i>Digital Strategist</i></h4>-->
					...
					?>	
					  ...
					  <div role="tabpanel" class="tab-pane fade" id="onlinepharma" aria-labelledby="home-tab">
									...
									<div class="x_panel">
									  <div class="x_content">
										<div class="row">
										  ...
										  <?php 
					//get only mapped hospital doctors list			
					$getOnlinePharma = $objQuery->mysqlSelect("DISTINCT(a.ref_id) as Ref_Id,a.ref_name as Ref_Name,a.doc_type_val as Doc_Type,a.ref_exp as Ref_Exp,a.ref_address as Ref_Address,a.doc_state as Doc_State,a.doc_photo as Doc_Image,b.spec_name as Specialization","referal as a inner join specialization as b on b.spec_id=a.doc_spec inner join doctor_hosp as c on c.doc_id=a.ref_id","a.anonymous_status!=1 and a.doc_spec=90","a.doc_type_val asc","","","");
					
					
					if($getOnlinePharma==true){
										
					foreach($getOnlinePharma as $getList){ ?>
                     <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <!--<h4 class="brief"><i>Digital Strategist</i></h4>-->
