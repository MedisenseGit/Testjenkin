          ...
          <div class="">
           <?php include_once('header_top_nav.php'); ?>
			...
			<div class="right">
                <div class="form-group pull-right top_search">
                  <div class="input-group">
                    <a href="Add-Patient" class="btn btn-primary btn-xs"><i class="fa fa-wheelchair"></i> ADD NEW CASE </a>
			...
			<?php
					...
					if($_GET['response']=="patient-created"){ ?>
						<div class="alert alert-success alert-dismissable">
												<a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
												<strong><i class="fa fa-check" aria-hidden="true"></i> <?php echo "Patient has been created successfully"; ?> </strong>
											  </div>
					<?php }
					?>
                  ...
                  <div class="x_title">
                    <h2>Sent Cases <small>Total Count: <?php echo $TotalCount[0]['Result_Count']; ?></small></h2>
