...
$(window).load(function () {
    ...
    $('#preloader').delay(350).fadeOut('slow', function () {
        $('.profile-page, .resume-page, .contact-page, .portfolio-page, about-page').hide();
    });
});
...
$(document).ready(function () {
    ...
    $('.menu div.contact-btn').on('click', function () {
	 ...
	 $('.menu div.about-btn').on('click', function () {
    ...
    $('.close-btn').on('click', function () {
        ...
        $('.profile-page, .resume-page, .portfolio-page, .contact-page, .about-page').fadeOut(800);
    });
