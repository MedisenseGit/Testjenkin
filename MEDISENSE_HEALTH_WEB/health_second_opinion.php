...
if(API_KEY == $_POST['apikey']){  //TO CHECK AUTHENTICATION OF POST VALUES
	...
	$url = "https://referralio.com/EMAIL/patmail.php?patmail=".$getPatInfo[0]['patient_email']."&patid=".$getPatInfo[0]['patient_id']."&patname=".$getPatInfo[0]['patient_name']."&mailtemp=".$mailTemplate;
		...
		//SMS notification to Successfull Registered Patient
					...
					$msg = urlencode ( "Hi ".$getPatInfo[0]['patient_name'].", We have registered your medical query with number : ". $getPatInfo[0]['patient_id'] . ".If you have any medical reports upload here - https://medisensecrm.com/MEDISENSE_HEALTH_WEB/PATIENT_ATTACHMENTS?d=".md5($getPatInfo[0]['patient_id'])."  We will try to get back in 24-48 Hrs. Thanks. MedisenseHealth.com" );
