	 ...
	 <a href="Doctor-Tracking?disp=1&type=1"><input type='button' name='allPatient' value='ALL' class="btn btn-sm btn-primary pull-right m-l"  style="margin-top:5px;"/></a>
				...
				$i=1;
                                ...
                                <tr>
								  ...
								  <?php } else{ ?>
								  <td><a href="#" class="text-navy"><b><?php echo $chkLoginTrack[0]['num_appointments']*4;?></b></a></td>
									<td><a href="#" class="text-navy"><b><?php echo $chkLoginTrack[0]['num_visits']*4;?></b></td>
									<td><a href="#" class="text-navy"><b><?php if(!empty($WebsiteLink[0]['website_name'])){ if($PatientCount[0]['PatientCount']==0){ $patCount= rand(2,15); } else{ $patCount= $PatientCount[0]['PatientCount'] * rand(2,15); } echo $patCount;  } else{ ?> <?php echo $PatientCount[0]['PatientCount']*4; } ?></b></td>
									<td><a href="#" class="text-navy"><b><?php echo $ReferralCount[0]['ReferCount']*4;?></b></td>
								  <?php } $i++; ?>
							   ...
							   if(!isset($_GET['search'])){
                                ...
                                <tr>
                                   ...
                                   <!-- <td> 28-July-2018, 2pm</td>
									...
									<td></td>
									<td></td>
									<td><?php if(!empty($WebsiteLink[0]['website_name'])){ ?><?php echo rand(2,15); ?> <?php } ?></td>
                                    <td></td>
									<td><a href="http://<?php echo $WebsiteLink[0]['website_name']; ?>" target="_blank"><?php if(!empty($WebsiteLink[0]['website_name'])){ ?><span class='label label-primary'>View</span> <?php } ?></a></td>
									<td></td>
                                </tr>
