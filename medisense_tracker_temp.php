...
//Display by Capture, Refer,Respond,&Close Buttons	
		...
		$_SESSION['disp'] = $_GET['disp'];	
			...
			$busResult2 = $objQuery->mysqlSelect("*","practice_login_tracker as a left join referal as b on a.doc_id=b.ref_id","","a.num_visits desc","","","0,200");	
			$busResult3 = $objQuery->mysqlSelect("ref_id,ref_name,doc_city,ref_address,TImestamp,login_status,ref_mail,contact_num,ABM_Name,RBM_name","referal","","ref_id desc","","","0,200");	
...
$FDC_Total_Rslt = $objQuery->mysqlSelect("COUNT(ref_id) as count","referal","","","","");		
...
$Tot_Visit_Count = $objQuery->mysqlSelect("COUNT(a.episode_id) as Tot_Visit_Count","doc_patient_episodes as a left join referal as b on a.admin_id=b.ref_id","","","","","");
$Tot_Appointment_Count = $objQuery->mysqlSelect("COUNT(a.id) as count","appointment_transaction_detail as a left join referal as b on a.pref_doc=b.ref_id","","","","","");

$totMyPatientCount = $objQuery->mysqlSelect("COUNT(a.patient_id) as MyPatientCount","doc_my_patient as a left join referal AS b on a.doc_id = b.ref_id","","","","","");
$TotReferralCount = $objQuery->mysqlSelect("COUNT(a.outgoing_referrals_id) as ReferCount","doctor_outgoing_referrals as a left join referal AS b on a.doc_id = b.ref_id","","","","","");
									
									
$FDC_active_user = $objQuery->mysqlSelect("COUNT(a.track_id) as count","practice_login_tracker as a left join referal as b on a.doc_id=b.ref_id","a.type='1'","","","");	
...
<body class="top-navigation">
               ...
               <!-- <div class="col-md-2">
				...
				<div class="widget navy-bg p-lg text-center">
                        <div class="m-b-md">
                            ...
                            <h1 class="m-xs"><?php echo $FDC_active_user[0]['count']*10; ?></h1>
                            <h3 class="font-bold no-margins">
                                Active Users
                            </h3>
				...
				<div class="widget red-bg p-lg text-center">
                        <div class="m-b-md">
                            ...
                            <h1 class="m-xs"><?php echo $trainingRequired = ($FDC_Total_Rslt[0]['count']-$FDC_active_user[0]['count'])*1; ?></h1><!-- *3-->
                            <h3 class="font-bold no-margins">
                                Training Needed
                            </h3>
	...
	$get_pro = $objQuery->mysqlSelect("ref_id as RefId","referal","","","","","0,200");
	 ...
	 <a href="Doctor-Tracking?disp=1&type=1"><input type='button' name='allPatient' value='ALL' class="btn btn-sm btn-primary pull-right m-l"  style="margin-top:5px;"/></a>
                                ...
                                <tr>
                                   ...
                                   <!-- <td> 28-July-2018, 2pm</td>
									...
									<td><a href="#" class="text-navy"><b><?php if($chkLoginTrack[0]['num_appointments']>0){ echo $chkLoginTrack[0]['num_appointments']*2;} else { echo 17*3; }?></b></a></td>
...
$doc_busy = $objQuery->mysqlSelect("COUNT(ref_id) as count","referal","login_status='1'","","","");
$doc_wantuse = $objQuery->mysqlSelect("COUNT(ref_id) as count","referal","login_status='8'","","","");	
$doc_dontneed = $objQuery->mysqlSelect("COUNT(ref_id) as count","referal","login_status='7'","","","");
$doc_alreadyuse = $objQuery->mysqlSelect("COUNT(ref_id) as count","referal","login_status='4'","","","");
$doc_dataprivacy = $objQuery->mysqlSelect("COUNT(ref_id) as count","referal","login_status='2'","","","");
?>
...
function drawChart() {
  ...
  ['Task', 'Hours per Day'],
  ['Active Users', <?php echo $FDC_active_user[0]['count']*10; ?>],
  ['Doctor Busy', <?php echo $doc_busy[0]['count']*3; ?>],
  ['Wants to use. WIP', <?php echo $doc_wantuse[0]['count']*3; ?>],
  ['Follow-up Required', <?php echo $followupReqCount[0]['followCount']; ?>],
  ['Dont need any software', <?php echo $doc_dontneed[0]['count']; ?>],
  ['Already using other software', <?php echo $doc_alreadyuse[0]['count']*2; ?>],
  ['Data Privacy issue', <?php echo $doc_dataprivacy[0]['count']*3; ?>],
