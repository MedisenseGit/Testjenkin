...
if(isset($_POST['cmdGetId'])){
	...
	header('location:patient-history');	
			...
			$back = $eu - $limit; 
			$next = $eu + $limit;
$autorespondedRecord = $objQuery->mysqlSelect("b.timestamp as Ref_Date,a.transaction_status as Trans_status,a.patient_id as Patient_Id,a.patient_name as Patient_Name,a.patient_src as Ref_By,b.ref_id as Doc_Id,b.status2 as Patient_status,b.response_status as Auto_Response,a.patient_loc as Location,a.pat_state as State,a.pat_country as Country","patient_tab as a inner join patient_referal as b on a.patient_id=b.patient_id inner join doctor_hosp as c on c.doc_id=b.ref_id inner join hosp_tab as d on d.hosp_id=c.hosp_id","b.ref_id='".$_SESSION['user_id']."' and b.response_status=1","a.patient_id desc","","","$eu, $limit");
$pag_result = $objQuery->mysqlSelect("a.patient_id as Patient_Id","patient_tab as a inner join patient_referal as b on a.patient_id=b.patient_id inner join doctor_hosp as c on c.doc_id=b.ref_id inner join hosp_tab as d on d.hosp_id=c.hosp_id","b.ref_id='".$_SESSION['user_id']."' and b.response_status=1","a.patient_id desc","");
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Auto responded Patient Records<small>Total Count:<?php echo $_SESSION['auto_resp_count']; ?></small></h2>
                  ...
                  <div class="x_content">
					...
					<table id="" class="table table-striped table-bordered">
                      ...
                      <tbody>
					  <?php foreach($autorespondedRecord as $list){ 
