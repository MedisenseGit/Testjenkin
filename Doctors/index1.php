...
<section id="signin_main" class="medisense signin-main centered" style=" margin-top:4%;>
								  ...
								  <h3 class="partner">Doctors Login</h3>
									<div id="form_1">
										<div class="form-header">
										 <img src="../Hospital/images/leap.png" alt="user login" />
									  </div>
										...
										<div class="form-footer">
											<div class="row">
												<div class="col-xs-7">
													...
													<a href="#" id="forgot_from_1">Forgot password?</a>
												</div>
												<div class="col-xs-5">
			...
			<p class="footer">Powered by <a href="http://www.medisenseleap.com/" target="_blank">Medisenseleap.com</a>
