<?php ob_start();
	...
	if(isset($_POST['save_patient']) || isset($_POST['save_patient_edit']) ){ //TO CHECK AUTHENTICATION OF POST VALUES
		...
		$txtNote3 = addslashes($_POST['se_query']);
			...
			$patientprofile = $objQuery->mysqlSelect("*","doc_my_patient","patient_id='".$_POST['patient_id']."'","","","","");
			...
			//Add Patient Attachments functionality
								...
								if(!empty($file_name)){
									...
									//Uploading image file
										$uploaddirectory = realpath("MyPatientAttach");
								...
								} // End of empty attachment conditions
			...
			//if ($episode_desc != '' || $episode_medical_complaint != '' || $episode_special_instruction != '')
				...
				if ($chkSaveTemplate == '1')
				{
					...
					{					
						...
						$insert_patient_episode_prescription_template_desc = $objQuery->mysqlInsert('doc_patient_episode_prescription_template_details',$arrFieldsPEPTD,$arrValuesPEPTD);
