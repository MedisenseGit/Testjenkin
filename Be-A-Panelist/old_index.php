...
<?php 	$i++;
	...
	<label class="label">Last name </span></label>
	<label class="input">
	<i class="icon-append fa fa-user"></i>
	...
	<div class="col-xs-12 col-md-4 col-sm-4">
		...
		<label class="label">Alternative No </label>
		<label class="input">
...
?>
		...
		<!--new line acadamic info-->
		
			<div class="hrline"><hr></div>
		<h3>Academic  information</h3>
		<h4><u>Type of Qualification</u></h4>
		<br>
...
<label class="input">
<i class="icon-append fa fa-calendar"></i>
<input type="text" name="end_date" id="datepicker1" value="">
</label>
</div>	
</div>
		...
		<h4><u>Internship Information</u></h4>
...
?>
		...
		<div class="row">
			...
			<div id="get-telenum" class="col-md-3 col-xs-12" style="display: none;">
