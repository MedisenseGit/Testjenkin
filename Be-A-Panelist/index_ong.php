                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-md-10 col-sm-8" style="margin-top:40px;">
                                            <div class="form-group">
                                                ...
                                                <!-- photouploadfun() was not required hence commented this line -->
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-4 col-sm-4">
                                            <div class="form-group">
												...
												<input autocomplete="true" type="text"  class="form-control" id="first_name" name="first_name" id="first_name" />
                                                <!--input type="text"  class="form-control" required list="browsers" name="first_name" id="first_name" />
                                                <datalist id="browsers" >
                                                    <option value="" ></option>
                                                    <?php 
                                                        //$SrcName= mysqlSelect("*","referal","","ref_name asc","","","");
                                                        //$i=30;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-md-4 col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <!-- Ajax Email Validation is not Required -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-md-4 col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select name="consult_lang[]" id="consult_lang" placeholder="Select Consultation Languages" multiple required >
