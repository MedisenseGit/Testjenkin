...
if(!empty($user_id) && !empty($finalHash))
{
	...
	{*/
		...
		{ 
			...
			$getEpiList['pref_country']		 	 = $list['pref_country'];
			$getEpiList['pref_doc']		 		 = $list['pref_doc'];
			$getEpiList['pref_hosp']		 	 = $list['pref_hosp'];
