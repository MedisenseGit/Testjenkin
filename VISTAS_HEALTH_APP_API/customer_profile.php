                ...
                <div class="col-lg-12 m-b-lg">
                    <div class="vertical-container no-margins"style="padding-left:70px;">
						...
						<div class="vertical-timeline-block" id="visit-details">
							 ...
							 <div class="ibox-content">
							<?php
								if($pharma_referal[0]['referral_type'] == 1){
									if (count($attachments) > 0)
								{ ?>
                               <div class="feed-element">
                                     
                                        <div class="media-body ">
                                          <label style="font-size:13px;">Customer Note:   </label><span style="font-weight: 500;font-size:13px;margin-left:8px;"><?php echo $pharma_referal[0]['customer_note']; ?>
									<ul>
									<?php 
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny table-responsive">
                                ...
                                <tr>
                                  ...
                                  <!--  <th data-toggle="false">VISITS</th>-->
									<th>Customer Note: <span style="font-weight: 500;"><?php echo $pharma_referal[0]['customer_note']; ?></span></th>
                                ...
                                <tr class="footable-even footable-detail-show">
									...
									<td>
									<?php $get_invest = mysqlSelect("*","patient_temp_investigation","patient_id = '". $pharma_referal[0]['patient_id']."' and episode_id='". $patient_episode_val['episode_id']."'","","","","");
									if(!empty($get_invest))
									{
									?>
