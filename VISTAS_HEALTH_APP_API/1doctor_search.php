...
{	
	...
	if($finalHash == $hashKey)
	{
		...
		{
			$postid1 = $_POST['search_string'];//$search_string;
			$postid2 = $_POST['search_string'];//$search_string;
		...
		{		// Specialty selected is not empty
				...
				//$result_doctor = mysqlSelect("a.ref_id as ref_id, md5(a.ref_id) as doc_encyid, a.ref_name as ref_name, a.ref_exp as ref_exp, a.doc_photo as doc_photo, a.doc_city as doc_city, a.doc_country as doc_country, a.doc_qual as doc_qual, a.doc_interest as doc_interest, a.geo_latitude as geo_latitude, a.geo_longitude as geo_longitude, a.cons_charge as cons_charge, a.cons_charge_currency_type as cons_charge_currency_type","referal as a inner join doctor_langauges as b on b.doc_id=a.ref_id inner join doc_specialization as c on c.doc_id = a.ref_id","a.doc_spec!=555 and a.anonymous_status=0 AND a.doc_country LIKE '%".$preferred_doc_origin."%' AND b.language_id = '".$preferred_language."' AND c.spec_id IN (".$specialization_id.")","a.ref_id DESC","","","$this1, $page_limit");
				
				$result_doctor = mysqlSelect("a.last_active_timestamp as last_active_timestamp,a.verified_by_medisense_user as verified_by_medisense_user,a.verified_by_medisense as verified_by_medisense,a.Publications_file as Publications_file,a.doc_pub as doc_pub,a.Research_Details_file as Research_Details_file, a.doc_research as doc_research,a.Professional_Construction_file as Professional_Construction_file,a.doc_contribute as doc_contribute,a.doc_interest as doc_interest,a.ref_id as ref_id, md5(a.ref_id) as doc_encyid, a.ref_name as ref_name, a.ref_exp as ref_exp, a.doc_photo as doc_photo, a.doc_city as doc_city, a.doc_country as doc_country, a.doc_qual as doc_qual, a.geo_latitude as geo_latitude, a.geo_longitude as geo_longitude, a.cons_charge as cons_charge, a.cons_charge_currency_type as cons_charge_currency_type","referal as a inner join doctor_langauges as b on b.doc_id=a.ref_id inner join doc_specialization as c on c.doc_id = a.ref_id", "((a.doc_spec!=555 and a.anonymous_status!=1) and (((a.ref_name LIKE '%".$postid1."%' or a.ref_address LIKE '%".$postid1."%' or a.doc_city LIKE '%".$postid1."%' or a.doc_state LIKE '%".$postid1."%') and (a.ref_address LIKE '%".$postid2."%' or a.doc_city LIKE '%".$postid2."%' or a.doc_state LIKE '%".$postid2."%')) AND c.spec_id IN (".$specialization_id.")))","a.ref_id DESC","","","$this1, $page_limit");
		
		}
		else 
		{  // Specialty selected is empty
				//$result_doctor = mysqlSelect(" Publications_file,doc_pub, Research_Details_file,doc_research,Professional_Construction_file, doc_contribute,ref_id, md5(ref_id) as doc_encyid, ref_name, ref_exp, doc_photo, doc_city, doc_country, doc_qual, doc_interest, geo_latitude, geo_longitude, cons_charge, cons_charge_currency_type","referal", "((doc_spec!=555 and anonymous_status!=1) and (((ref_name LIKE '%".$postid1."%' or ref_address LIKE '%".$postid1."%' or doc_city LIKE '%".$postid1."%' or doc_state LIKE '%".$postid1."%') and (ref_address LIKE '%".$postid2."%' or doc_city LIKE '%".$postid2."%' or doc_state LIKE '%".$postid2."%'))))","ref_id DESC","","","$this1, $page_limit");
				
				//$val = "and (ref_address LIKE '%".$postid2."%' or doc_city LIKE '%".$postid2."%' or doc_state LIKE '%".$postid2."%')";
				$result_doctor = mysqlSelect("last_active_timestamp as last_active_timestamp,verified_by_medisense,verified_by_medisense_user,Publications_file,doc_pub, Research_Details_file,doc_research,Professional_Construction_file, doc_contribute,ref_id, md5(ref_id) as doc_encyid, ref_name, ref_exp, doc_photo, doc_city, doc_country, doc_qual, doc_interest, geo_latitude, geo_longitude, cons_charge, cons_charge_currency_type","referal","(doc_spec!=555 and anonymous_status!=1) and (ref_name LIKE '%".$postid1."%' or ref_address LIKE '%".$postid1."%' or doc_city LIKE '%".$postid1."%' or doc_state LIKE '%".$postid1."%') or (ref_address LIKE '%".$postid2."%' or doc_city LIKE '%".$postid2."%' or doc_state LIKE '%".$postid2."%') ","ref_id desc","","","","$this1, $page_limit");
