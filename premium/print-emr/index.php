<?php
	...
	if(empty($admin_id)){
		...
		if(COUNT($patient_tab)==0){
			...
			$doc_present_spectacal_presc = mysqlSelect("*","present_examination_opthal_spectacle_prescription","episode_id = '".$patient_episodes[0]['episode_id']."' ","","","","");
...
<html>
	...
	<body id="<?php echo $_GET['pid']; ?>" data-pmail="<?php echo $patient_email; ?>" data-mobile="<?php echo $patient_mob; ?>">
		<div id="actions">
			...
			<a href="../Refer-Out-Doctor" target="_blank" style="float:right;valign:middle;margin-top:10px;"><img src="add_icon.png" width="18"/></a><br>
		...
		<div class="container" id="main-content">
				...
				<table cellpadding="2" cellspacing="2" border="1" class="table table-bordered col-lg-12" width="100%">
					...
					<tbody>
						<tr>
							...
							<td style="vertical-align:middle;text-align:center;"><?php echo "<b>AIDED: </b>".$get_exam_refraction[0]['distacnce_vision_right'].",<b> UNAIDED: </b>".$get_exam_refraction[0]['distacnce_vision_right_unaided'];  ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo "<b>AIDED: </b>".$get_exam_refraction[0]['distance_vision_left'].", <b>UNAIDED: </b>".$get_exam_refraction[0]['distance_vision_left_unaided'];  ?></td>
							<td style="vertical-align:middle;text-align:left;padding-left: 20px;">Near Vision</td>
							<td style="vertical-align:middle;text-align:center;"><?php echo "<b>AIDED: </b>".$get_exam_refraction[0]['near_vision_right'].", <b>UNAIDED: </b>".$get_exam_refraction[0]['near_vision_right_unaided'];  ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo "<b>AIDED: </b>".$get_exam_refraction[0]['near_vision_left'].", <b>UNAIDED: </b>".$get_exam_refraction[0]['near_vision_left_unaided'];  ?></td>
						</tr>
						<tr>
						...
						<tr>
							<td style="vertical-align:middle;text-align:left;padding-left: 20px;font-weight:bold;">IOP</td>
							<td style="vertical-align:middle;text-align:left;"><?php if(!empty($get_exam_refraction[0]['IopRE'])){ echo $get_exam_refraction[0]['IopRE']." mm of HG"; }  ?></td>
							<td style="vertical-align:middle;text-align:left;"><?php if(!empty($get_exam_refraction[0]['IopLE'])){ echo $get_exam_refraction[0]['IopLE']." mm of HG"; }  ?></td>
							<td style="vertical-align:middle;text-align:left;padding-left: 20px;font-weight:bold;"></td>
			...
			<br>
			<div id="present_power_glass" cellpadding="0" cellspacing="0" border="0">
				<table cellpadding="2" cellspacing="2" border="1" class="table table-bordered col-lg-12" width="100%">
					<thead>
						<th colspan="9" class="text-center" style="vertical-align:middle;text-align:center;"><font size="3">Present power of glasses</font></th>
					</thead>
					<thead>
						<th colspan="5" class="text-center" style="vertical-align:middle;text-align:center;"><font size="3">RIGHT EYE</font></th>
					...
					<thead>
						...
						<th class="text-center" style="vertical-align:middle;text-align:center;">Vision</th>
						<th class="text-center" style="vertical-align:middle;text-align:center;">Sphere</th>
						<th class="text-center" style="vertical-align:middle;text-align:center;">Cyl</th>
						<th class="text-center" style="vertical-align:middle;text-align:center;">Axis</th>
						<th class="text-center" style="vertical-align:middle;text-align:center;">Vision</th>
					...
					<tbody>
						<tr>
							<td>D.V</td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['dvSphereRE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['DvCylRE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['DvAxisRE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['DvVisionRE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['DvSpeherLE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['DvCylLE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['DvAxisLE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['DvVisionLE']; ?></td>
						</tr>
						<tr>
							<td>N.V</td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['NvSpeherRE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['NvCylRE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['NvAxisRE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['NvVisionRE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['NvSpeherLE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['NvCylLE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['NvAxisLE']; ?></td>
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['NvVisionLE']; ?></td>
						</tr>
						<tr>
							<td>IPD</td>
							<td colspan="4" style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['IpdRE']; ?></td>
							<td colspan="4" style="vertical-align:middle;text-align:center;"><?php echo $doc_present_spectacal_presc[0]['IpdLE']; ?></td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div id="spec_prescription" cellpadding="0" cellspacing="0" border="0">
				<table cellpadding="2" cellspacing="2" border="1" class="table table-bordered col-lg-12" width="100%">
					<thead>
						<th colspan="9" class="text-center" style="vertical-align:middle;text-align:center;"><font size="3">Spectacle Prescriptions</font></th>
					</thead>
					<thead>
						<th colspan="5" class="text-center" style="vertical-align:middle;text-align:center;"><font size="3">RIGHT EYE</font></th>
						<th colspan="4" class="text-center" style="vertical-align:middle;text-align:center;"><font size="3">LEFT EYE</font></th>
					...
					<tbody>
						<tr>
							...
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_patient_spectacle_prescriptions[0]['DvVisionRE']; ?></td>
							...
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_patient_spectacle_prescriptions[0]['DvVisionLE']; ?></td>
						</tr>
						<tr>
							<td>N.V</td>
							...
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_patient_spectacle_prescriptions[0]['NvVisionRE']; ?></td>
							...
							<td style="vertical-align:middle;text-align:center;"><?php echo $doc_patient_spectacle_prescriptions[0]['NvVisionLE']; ?></td>
						</tr>
						<tr>
							<td>IPD</td>
							<td colspan="4" style="vertical-align:middle;text-align:center;"><?php echo $doc_patient_spectacle_prescriptions[0]['IpdRE']; ?></td>
							<td colspan="4" style="vertical-align:middle;text-align:center;"><?php echo $doc_patient_spectacle_prescriptions[0]['IpdLE']; ?></td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div id="diagnosis" >
				<ul>
					<?php if(!empty($patient_episodes[0]['prescription_note'])){ ?>
					...
					<?php if($patient_episodes[0]['patient_education']!=0){ 
						...
						?>
					<li><strong>Instructions :</strong><br><?php echo $get_patient_education[0]['edu_description']; ?></li>
					<?php } ?>
					<?php if(!empty($patient_episodes[0]['next_followup_date'])){ ?>
					<li>
						<h3>NEXT FOLLOWUP VISIT : <?php echo date('d-M-Y',strtotime($patient_episodes[0]['next_followup_date'])); ?></h3>
					</li>
					<?php } ?>
					<?php if($patient_episodes[0]['outward_ref_id']!=0){
						...
						?>
					<li>
						<h3>For further treatment and advice, please visit :</h3>
						<?php echo $get_outward_docdetails[0]['doctor_name'].",<br>".$get_outward_docdetails[0]['doc_address']."<br>".$get_outward_docdetails[0]['doctor_city']; ?>
					</li>
					<?php } ?>
				</ul>
			</div>
			<!-- <div id="diagnosis" >
				<ul>
					<?php if(!empty($patient_episodes[0]['patientNote'])){ ?>
					<li><strong>Patient Note :</strong><br><?php echo nl2br($patient_episodes[0]['patientNote']); ?></li>
					<?php } ?>
				</ul>
			</div> -->
			<?php 	
