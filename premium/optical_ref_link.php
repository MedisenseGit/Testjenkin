				 ...
				 <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left"  action="my_patient_profile_save.php"  name="frmAddPatient" id="frmAddPatient">
                    ...
                    <div class="ibox-content text-center p-md">
						<!--<div class="input-group">
							...
							<div class="row">
						<?php if($_GET['response']=="update-spectacle"){ ?>
						<div class="alert alert-success alert-dismissable">
								<button aria-hidden="true" data-dismiss="alert" class="close"  type="button">×</button>
								<strong>Spectacle prescriptions updated successfully </strong>
						</div>
						<?php }
						
											$doc_patient_spectacle_prescriptions = mysqlSelect("*","examination_opthal_spectacle_prescription","episode_id = '". $getEpisode[0]['episode_id'] ."' ","spectacle_id ASC","","","");
											if (COUNT($doc_patient_spectacle_prescriptions) > 0)
											{
											?>	
											
			<div class="table-responsive">								
		<table cellpadding="2" cellspacing="2" border="1" class="table table-striped col-lg-12" width="100%">
				<thead>
