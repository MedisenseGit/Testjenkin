...
$getPayList= mysqlSelect("*","out_patient_billing","doc_id='".$admin_id."' and active_status='1'","","","","");
$getTotAmount= mysqlSelect("SUM(total_amount) as tot_amount","out_patient_billing","doc_id='".$admin_id."' and active_status='1'","","","","");
