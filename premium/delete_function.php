...
$get_diagnoInfo = mysqlSelect("*","Diagnostic_center as a left join doc_diagnostics as b on a.diagnostic_id=b.diagnostic_id","b.doc_id='".$admin_id."'","b.doc_diagno_id desc","","","");
}

if(isset($_GET['doc_pharma_id'])){
mysqlDelete('doc_pharma',"doc_pharma_id='".$_GET['doc_pharma_id']."'");
			
$get_pharmaInfo = mysqlSelect("*","pharma as a left join doc_pharma as b on a.pharma_id=b.pharma_id","b.doc_id='".$admin_id."'","b.doc_pharma_id desc","","","");
 }
