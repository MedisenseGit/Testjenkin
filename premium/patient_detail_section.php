...
.minimized {
    ...
    height: 36px;
                     ...
                     <h1 class="text-navy"><b><?php echo $patient_tab[0]['patient_name']; ?><!--(<?php echo $patient_tab[0]['patient_id']; ?>)--></b>  <small><a href="#"  data-toggle="modal" class="text-navy" data-target="#myModal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a></small></h1>
				          ...
				          <?php 
						  $get_app_Status = mysqlSelect("*","appointment_transaction_detail","pref_doc='".$admin_id."' and patient_id='".$patient_tab[0]['patient_id']."'","id desc","","","");
						...
						<div class="panel panel-primary draggable-panel toolbar-panel ui-draggable ui-resizable videoCallDisplay1" id=			"toolbox-tools" style="position:absolute;display:none;top:50px;left: 200px;z-index:1001;">
								<div class="panel-heading lang-panel-header-tools">Calling To <?php echo $patient_tab[0]['patient_name']; ?> <i class="fa fa-times pull-right close-panel" id="close-toolbox-tools"></i><i class="fa pull-right fa-chevron-down" id="toggle-toolbox-tools"></i>
								</div>
							<iframe  width="100%" height="100%" class="iframeVideo" style="height:90%;width:100%;overflow:scroll" id="toolbox-tools" 	id="resizable" class="resizable" class="panel panel-primary draggable-panel toolbar-panel ui-draggable ui-resizable" 	src="" allow="camera;microphone">
							</iframe>
			...
			<div class="modal inmodal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								...
								<form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left"  action="<?php echo HOST_URL_PREMIUM; ?>my_patient_profile_save.php"  name="frmAddPatient" id="frmAddPatient">
