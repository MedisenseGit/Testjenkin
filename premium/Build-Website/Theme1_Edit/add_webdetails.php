...
if(isset($_POST['add_home'])){
	...
	$home_pic4 = $time."-".basename($_FILES['txtPhoto3']['name']);
	...
	if(!empty(basename($_FILES['txtPhoto']['name']))) {
		$arrFields_home[] = 'home_image1';
		$arrValues_home[] = $home_pic1;
	}
	if(!empty(basename($_FILES['txtPhoto1']['name']))) {
		$arrFields_home[] = 'home_image2';
		$arrValues_home[] = $home_pic2;
	}
	if(!empty(basename($_FILES['txtPhoto2']['name']))) {
		$arrFields_home[] = 'home_image3';
		$arrValues_home[] = $home_pic3;
	}
	if(!empty(basename($_FILES['txtPhoto3']['name']))) {
		$arrFields_home[] = 'home_image4';
		$arrValues_home[] = $home_pic4;
	}
	...
	{ 
		...
		$folder_name	=	"buildDocWebsite/theme1/theme1ImageAttach";
		$sub_folder		=	$detailID;
...
if(isset($_POST['add_about'])){
	...
	$about_main_logo = $time."-".basename($_FILES['txtMainLogo']['name']);
	...
	if(!empty(basename($_FILES['txtSignature']['name']))) {
		$arrFields_about[] = 'about_signature';
		$arrValues_about[] = $about_Signature;
	}
	
	if(!empty(basename($_FILES['txtBgImage']['name']))) {
		$arrFields_about[] = 'about_background';
		$arrValues_about[] = $about_bg;
	}
	
	if(!empty(basename($_FILES['txtMainLogo']['name']))) {
		$arrFields_about[] = 'about_main_logo';
		$arrValues_about[] = $about_main_logo;
	}
	...
	if(COUNT($get_about) == 0) {
		...
		$detailID = $aboutcreate;  //Get doc web Id
	...
	if(basename($_FILES['txtMainLogo']['name']!==""))
	{ 
		$folder_name	=	"buildDocWebsite/theme1/theme1ImageAttach";
		$sub_folder		=	$detailID;
		$filename		=	$_FILES['txtMainLogo']['name'];
		$file_url		=	$_FILES['txtMainLogo']['tmp_name'];
		fileuploadFunc($folder_name,$sub_folder,$filename,$file_url); //for file upload
...
if(isset($_POST['add_specialty'])){
	...
	$txtSurgName3 		= addslashes($_POST['spec_surgical3_name']);	
	...
	$txtPatDomesticTitle = addslashes($_POST['se_pat_domestic_title']);
	$txtPatInternationalTitle = addslashes($_POST['se_pat_international_title']);	
	$txtPatCommunityServiceTitle = addslashes($_POST['se_pat_communityservice_title']);
	...
	$arrFields_specialty[] = 'spec_domestic_title';
	$arrValues_specialty[] = $txtPatDomesticTitle;
	$arrFields_specialty[] = 'spec_domestic_count';
	$arrValues_specialty[] = $txtPatDomestic;
	$arrFields_specialty[] = 'spec_international_title';
	$arrValues_specialty[] = $txtPatInternationalTitle;
	$arrFields_specialty[] = 'spec_international_count';
	$arrValues_specialty[] = $txtPatInternational;
	$arrFields_specialty[] = 'spec_cs_title';
	$arrValues_specialty[] = $txtPatCommunityServiceTitle;
...
if(isset($_POST['add_awards']))
{
	...
	if(COUNT($get_award) == 0) 
	{
		...
		$detailID = $awardcreate;  //Get doc web Id
...
if(isset($_POST['add_hospital'])){
	...
	if(!empty(basename($_FILES['txtHospPhoto1']['name']))) 
	{
	...
	if(!empty(basename($_FILES['txtHospPhoto2']['name'])))
	{
	...
	if(!empty(basename($_FILES['txtHospPhoto3']['name']))) 
	{
	...
	if(!empty(basename($_FILES['txtHospPhoto4']['name']))) {
	...
	if(!empty(basename($_FILES['txtHospPhoto5']['name']))) {
...
if(isset($_POST['add_contact']))
{
	...
	if(COUNT($get_contact) == 0) 
	{
		...
		$detailID = $contactcreate;  //Get doc web Id
