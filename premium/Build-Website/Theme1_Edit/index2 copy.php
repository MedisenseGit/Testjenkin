	  ...
	  <input type="hidden" id="doc_id" name="doc_id" value="<?php echo $admin_id; ?>"  placeholder="" required class="form-control typeahead_1">
        ...
        <div class="inner">
         <h2> <span>HEllo, I'm </span><br>
		  <input type="text" id="se_doc_name" name="se_doc_name" value="<?php echo $getdetails[0]['home_username']; ?>"  placeholder=" User Name" required class="form-control typeahead_1" />

		  <input id="se_doc_designation" name="se_doc_designation" value="<?php echo $getdetails[0]['home_designation']; ?>" placeholder="Designation" required type="text" />
		 </h2>
        ...
        <div class="inner">
          ...
          <div class="about-con">
            <ul>
              ...
              <li>Speciality:  <input type="text" id="about_phone" name="about_phone" value="<?php echo $getdetails[0]['about_phone']; ?>" placeholder="+91 8884688660" ></li>
              <li>Practicing In: <input type="text" id="about_email" name="about_email"  value="<?php echo $getdetails[0]['about_email']; ?>" placeholder="atul56kumar@yahoo.com" ></li>
      ...
      <article class="content skills gray-bg" id="chapterskills">
        ...
        <div class="inner">
          ...
          <h3>Surgical Skills</h3>
		   <textarea class="form-control"  id="spec_surgical" name="spec_surgical"  placeholder="Dr Atul practices vitreoretinal surgery as his pursuance of passion. He has the distinction of performing over 18,000 retinal surgeries with a success rate of more than 98%."  ><?php echo $getdetails[0]['spec_surgical']; ?></textarea>
		  ...
		  <div class="skills-con">
            ...
            <div class="container-sub skill-list">
              <div class="row">
                <h3>Specialities</h3>
               <textarea rows="3"  id="spec_specialities" name="spec_specialities" placeholder="Dr. Bharath has commendable skills in vitreoretinal surgery and is a specialist in diseases of the retina, vitreous and uvea and their management. His academic disciplines include"  ><?php echo $getdetails[0]['spec_specaialities']; ?></textarea>
            ...
            <div class="container-sub">
              <div class="row">
				...
				<div class="row" >
					 ...
					 <div class="container-sub skill-list"><strong><input type="text" id="se_pat_domestic_title" name="se_pat_domestic_title"  value="<?php echo $getdetails[0]['spec_domestic_title']; ?>" placeholder="Domestic Patients Treated" ></strong>
				 ...
				 <div class="row" >
					...
					<div class="container-sub skill-list"><strong><input type="text" id="se_pat_international_title" name="se_pat_international_title"  value="<?php echo $getdetails[0]['spec_international_title']; ?>" placeholder="International Patients Treated" ></strong>
				 ...
				 <div class="row" >
					...
					<div class="container-sub skill-list"><strong><input type="text" id="se_pat_communityservice_title" name="se_pat_communityservice_title"  value="<?php echo $getdetails[0]['spec_cs_title']; ?>" placeholder="Patients Treated as Community Service" ></strong>
      ...
      <article class="content experience white-bg" id="chapterexperience">
	   <form method="post" name="frmAddEducation" id="frmAddEducation" action="add_webdetails.php">
        ...
        <div class="inner">
         ...
         <textarea rows="10"  name="edu_title" placeholder="Dr Atul Kumar was born in September, 1956. He completed his schooling from Modern school, New Delhi."  ><?php echo $getdetails[0]['edu_title']; ?></textarea>
            ...
            <div class="container-sub">
              ...
              <div class="row">
                <div class="education-details">
                 ...
                 <div class="col-6 margin-bottom50 margin-top50 no-margin-top"> <textarea rows="10"  maxlength="500" name="awardinfo1" placeholder="The Padma shri was awarded to Dr Atul Kumar in January 2007 by the 13th president of India, Shri Pranab Mukherjee."  ><?php echo $getdetails[0]['award_info1']; ?></textarea> </div>
                </div>
                <div class="full-divider"></div>
                <div class="education-details">
                  <div class="col-6 margin-bottom50 margin-top50">
                ...
                <div class="col-6 margin-bottom50 margin-top50 no-margin-top"> <textarea rows="10"  maxlength="500" name="awardinfo2" placeholder="The President of India has also conferred Dr. B.C. Roy National award to him for excellence in field of medicine in the category of Eminent Medical Teacher."  ><?php echo $getdetails[0]['award_info2']; ?></textarea> </div>
                 </div>
                <div class="full-divider"></div>
                <div class="education-details">
                  <div class="col-6 margin-bottom50 margin-top50">
                ...
                <div class="col-6 margin-bottom50 margin-top50 no-margin-top"> <textarea rows="10"  maxlength="500" name="awardinfo3" placeholder="The University Grants Commission recognized his scientific work by giving Hari Om Asharam Trust Award for role as outstanding social scientist for interaction between science and society."  ><?php echo $getdetails[0]['award_info3']; ?></textarea> </div>
                 </div>
				 <div class="full-divider"></div>
                <div class="education-details">
                  <div class="col-6 margin-bottom50 margin-top50">
                ...
                <div class="col-6 margin-bottom50 margin-top50 no-margin-top"> <textarea rows="10"  maxlength="500" name="awardinfo4" placeholder="The University Grants Commission recognized his scientific work by giving Hari Om Asharam Trust Award for role as outstanding social scientist for interaction between science and society."  ><?php echo $getdetails[0]['award_info4']; ?></textarea> </div>
                 </div>
				 <div class="full-divider"></div>
                <div class="education-details">
                  <div class="col-6 margin-bottom50 margin-top50">
                ...
                <div class="col-6 margin-bottom50 margin-top50 no-margin-top"> <textarea rows="10"  maxlength="500" name="awardinfo6" placeholder="The University Grants Commission recognized his scientific work by giving Hari Om Asharam Trust Award for role as outstanding social scientist for interaction between science and society."  ><?php echo $getdetails[0]['award_info6']; ?></textarea> </div>
                 </div>
