<div class="col-lg-12" style="background-color:#f8f8f8; border:1px dashed #cecdcb; padding-top:20px; margin-bottom:20px;">
								...
								$last_five_complaints = mysqlSelect("symptoms_id","doctor_frequent_symptoms","(doc_id='".$admin_id."' and doc_type='1') or (emr_type='".$getDocEMR[0]['spec_group_id']."' and doc_id='0' and doc_type='0')","freq_count desc","","","8");
								...
								<label class="pull-left">Suffering since:  </label>
									<div class="col-sm-6"><input type="text" name="suffering_since" class="form-control"></div>
								</div>
								<br>
								</div>
								<br>