...
if($_POST['act'] == 'status-check') {
	...
	//$GetVCRequests = mysqlSelect("a.id as acc_id, a.doc_id as doc_id, a.patient_id as patient_id, a.unique_trans_id as unique_trans_id, a.appoint_trans_id as appoint_trans_id, b.patient_name as patient_name, b.patient_addrs as patient_addrs, b.pat_state as pat_state, b.pat_country as pat_country, b.doc_video_link as doc_video_link, c.pay_status as pay_status", "appointment_accept_reject as a inner join doc_my_patient as b on b.transaction_id = a.appoint_trans_id inner join appointment_transaction_detail as c on c.appoint_trans_id = b.transaction_id", "a.doc_id='".$admin_id."' AND (consult_status=1 OR consult_status=2)", "a.id DESC", "", "", "0,15");
	
	$GetVCRequests = mysqlSelect("a.id as acc_id,a.doc_id as doc_id ,a.patient_id as patient_id ,a.unique_trans_id as unique_trans_id,a.appoint_trans_id as appoint_trans_id,b.patient_name as patient_name,c.address AS patient_addrs,c.state as pat_state,c.country as pat_country,c.doc_video_link as doc_video_link, c.pay_status as pay_status", "appointment_accept_reject as a inner join patients_appointment as b on a.patient_id=b.patient_id 
INNER JOIN patients_transactions as c on c.patient_id=b.patient_id", "a.doc_id='".$admin_id."' AND (a.consult_status=1 OR a.consult_status=2)", "a.id DESC", "", "", "0,15");
