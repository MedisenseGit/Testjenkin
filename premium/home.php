...
<title>Welcome to PRACTICE Premium</title>
...
<?php include_once('sidemenu.php'); ?>
		...
		<?php include_once('header_top.php'); ?>
            <div class="row wrapper border-bottom white-bg page-heading">
				...
				<div class="col-lg-6" style="margin-top: 20px;margin-bottom: 10px;">
				<a href="https://www.mohfw.gov.in/pdf/Telemedicine.pdf" target="_blank" >Telemedicine Guidelines from Medical Council of India for Registered Medical practitioners </a>
				</div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row m-b-lg m-t-lg">
                ...
                <div class="col-md-4">
					<?php if($secretary_id!=1) { ?><div class="pull-right"><a href="Profile"><i class="fa fa-pencil-square-o"></i> EDIT</a></div><?php } ?>
                    <div class="profile-image">
                        <img src="<?php if(!empty($getDoctorProfile[0]['Doc_Photo'])){ echo "../Doc/".$getDoctorProfile[0]['Doc_Id']."/".$getDoctorProfile[0]['Doc_Photo']; } else { echo "../assets/img/anonymous-profile.png"; } ?>" class="img-circle circle-border m-b-md" width="128" alt="profile">
                    </div>
                    <div class="profile-info">
                        <div class="">
                            <div>
                                <h2 class="no-margins">
                                    <?php echo $getDoctorProfile[0]['Doc_name']; ?>
                                </h2>
                                <h4><?php echo $getDoctorProfile[0]['Doc_city'].", ".$getDoctorProfile[0]['Doc_State'].", ".$getDoctorProfile[0]['Doc_Country']; ?></h4>
                                <small>
                                    <i class="fa fa-mobile"></i> <?php echo $getDoctorProfile[0]['Doc_contact']; ?>,<br> <i class="fa fa-envelope"></i> <?php echo $getDoctorProfile[0]['doc_mail']; ?>
                                </small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-2">
                    <table class="table small m-b-xs">
						...
						<tr>
							 <td>
                          <a href="My-Patients "><strong><span class="label label-primary"><?php echo $countMyPatient[0]['Total_count']; ?></span></strong> MY PATIENTS</a>
                            </td>
						</tr>
						<tr>	
                            <td>
                                <a href="Cases-Recieved"><strong><span class="label label-danger"><?php echo $Total_Recieved_Count[0]['Total_count']; ?></span></strong> CASES RECEIVED</a>
                            </td>
                        </tr>
            ...
            <div class="row">
				...
				<div class="panel-heading">
					...
					<?php 
					$allResult = mysqlSelect("*","blogs_offers_events_listing","view_user='1' or view_user='3'","Create_Date desc","","","0,6");
					$countall  = mysqlSelect("COUNT(listing_id) as Count_All","blogs_offers_events_listing","view_user='1' or view_user='3'","Create_Date desc","","","0,6");
                    ...
                    <div class="social-feed-box">
                        ...
                        <div class="social-body">
						   ...
						   <?php 
							...
							<div class="btn-group pull-right m-r-xs">
							<a target="_blank" class="fb-xfbml-parse-ignore" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo HOST_MAIN_URL."Refer/";?><?php echo $blogtype; ?>%2F<?php echo $gethypenTitle; ?>%2F<?php echo $postkey; ?>" data-layout="button_count" data-size="small" data-mobile-iframe="true"><button class="btn btn-success btn-circle btn-outline" type="button"><i class="fa fa-facebook"></i> 
                           </button></a>
							</div>
                        </div>
                        <div class="social-footer">
							...
							<?php
							$getComment = mysqlSelect("*","home_post_comments","topic_id='".$postnonencyid."' and topic_type='".$posttype."'","","","","");
							foreach($getComment as $commentList)
							{ 
								if($commentList['login_User_Type']=="1")
								{  //For Partner
								...
								else if($commentList['login_User_Type']=="2")
								{ //For Doctor
								...
								else if($commentList['login_User_Type']=="3")
								{  //For Hospital
                ...
                <div class="input-group input-group-sm">
				   ...
				   <div id="tab-2" class="tab-pane">
					<?php 
					$blogResult = mysqlSelect("*","blogs_offers_events_listing","(listing_type='Blog') and (view_user='1' or view_user='3')","Create_Date desc","","","0,5");
					$blogcount = mysqlSelect("COUNT(listing_id) as CountBlog","blogs_offers_events_listing","(listing_type='Blog') and (view_user='1' or view_user='3')","Create_Date desc","","","");
			...
			$('.bt-add-comJob<?php echo $postResultList['listing_id']; ?>').click(function(){
				...
				$getSponsoresProduct= mysqlSelect("a.sp_id as sp_id,a.sp_title as sp_title,a.sp_description as sp_description,a.sp_image as sp_image","sponsores_products as a left join sponsors as b on a.sponsores_id=b.sponsor_id","a.sponsores_id='".$getDoctorProfile[0]['sponsor_id']."'","","","","");
				if(count($getSponsoresProduct)>0)
				{
					//print_r($getDoctorProfile);
						?>
                        <!--    <div class="vertical-timeline-content">
                                <div class="ibox float-e-margins">
                                    
                                    <div class="ibox-content">
                                       <center> <div class="slick_demo_3 autoplay">
										<?php 
										
										while(list($key, $value) = each($getSponsoresProduct)){ ?>
										<a href="Product-Details-Page?sp_id=<?php echo $value['sp_id']; ?>" target="_blank">	
										<div>
											<img src="sponsors_products/<?php echo $value['sp_id']; ?>/<?php echo $value['sp_image']; ?>" width="300"/>
										</div>
										</a>
										<?php } ?>
				...
				<?php } ?>
                        ...
                        <div class="vertical-timeline-block" id="sendLink">
                            ...
                            <h3>Send E-Visiting Card</h3>

                            <p class="small">
                                Send E-Visiting Card to your patients
                            </p>
							<input type="hidden" name="txtHospId" id="txtHospId" value="<?php echo $_SESSION['login_hosp_id']; ?>" />
							<input type="hidden" name="txtHospName" id="txtHospName" value="<?php echo $_SESSION['login_hosp_name']; ?>" />
							<div class="form-group">
							
                                <label>Name</label>
                                <input type="text" name="txtUser" id="txtUser" class="form-control" placeholder="Name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txMobile" id="txMobile" class="form-control" placeholder="Mobile No." minlength="10" maxlength="10">
                            </div>
							<a href="#" data-toggle="modal" data-target="#myModal" class="pull-left">VIEW HISTORY</a>
										 ...
										 <table class="table table-striped">
                                            ...
                                            <div class="chat-discussion">
											 <div class="chat-message">
												...
												<table class="table table-striped">		
														<tbody>
												<?php $linkHistory = mysqlSelect("*","appointment_link_history","doc_id='".$admin_id."'","cur_date desc","","",""); 
													
													foreach($linkHistory as $historyList)
													{
												   ...
												   <tr>
													...
													<td><?php echo $historyList['name']; ?> </td>
													<td><?php echo $historyList['email_id']; ?></td>
													<td><?php echo $historyList['mobile']; ?></td>
													<td><?php echo date('d M Y H:i a',strtotime($historyList['cur_date'])); ?></td>
													</tr>
												 <?php } ?>
													</tbody>
												</table>
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        <table class="table table-hover no-margins">
                                            ...
                                            <tbody>
											<?php 
											//$myPatient = mysqlSelect("patient_name,patient_email,patient_mob","doc_my_patient","doc_id='".$admin_id."'","patient_id desc","","","0,3");
											
											$myPatient = mysqlSelect("a.patient_id as patient_id,a.patient_name as patient_name,a.patient_mobile as patient_mob","patients_appointment as a inner join patients_transactions as b on a.patient_id=b.patient_id","b.doc_id='".$admin_id."'","a.patient_id desc","","","0,3");
        ...
        datasets: [
            {
				...
				$Total_Received = mysqlSelect("COUNT(a.patient_id) as Total_count","doc_patient_episodes as a left join patients_appointment as b on a.patient_id=b.patient_id","(a.admin_id='".$admin_id."') and (DATE_FORMAT(a.date_time,'%Y-%m-%d') between '".$startdate."' and '".$enddate."')","","","","");
