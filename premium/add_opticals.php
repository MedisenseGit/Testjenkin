...
$get_opticalInfo = mysqlSelect("*","opticals as a left join doc_opticals as b on a.optical_id=b.optical_id","b.doc_id='".$admin_id."'","b.doc_optical_id desc","","","");
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label class="control-label" for="product_name">Optical Name</label>
                            <input type="text" id="optical_name" name="optical_name" value="" placeholder="Optical Name" required class="form-control typeahead_1">
                        </div>
                    </div>
					<div class="col-sm-3">
                        <div class="form-group">
					...
					<div class="col-sm-1">
                        <div class="form-group">
						 <label class="control-label" for="status" style="margin-top:40px;"></label>
                             <button type="submit" name="add_optical"  class="btn btn-outline btn-primary"><i class="fa fa-plus"></i> Add </button>
						</div>
                    </div>
                </div>
			</form>
                        ...
                        <div class="ibox-content" >
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
									...
									{
									foreach($get_opticalInfo as $list)
									{ 									
									?>
                                    <tr>
                                       
                                         <td><?php echo $list['optical_name']; ?> </td>
										<td><?php echo $list['optical_email']; ?></td>
                                        <td><?php echo $list['optical_contact_num']; ?></td> 
										<td><?php echo $list['optical_city']; ?></td>										
                                       <?php if($secretary_id!=1) { ?>	<td><a href="javascript:void(0)" onclick="return delOptical(<?php echo $list['doc_optical_id']; ?>);" class="btn btn-danger btn-bitbucket btn-xs">
