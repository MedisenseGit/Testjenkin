...
if(isset($_GET['sympid']) && !empty($_GET['sympid'])){
	...
	} else
	{
		...
		//$insert_symptoms=mysqlInsert('doc_patient_lids_active',$arrFileds,$arrValues);
		...
		$insert_lids=mysqlInsert('doc_patient_lids_active',$arrFileds,$arrValues);
			...
			mysqlDelete('doc_patient_lids_active',"lids='".$params[0]."' and doc_id='".$admin_id."' and doc_type='1' and eye_type='1' and patient_id='".$_GET['patientid']."' and status='1'");
				...
				/*$check_symp = mysqlSelect("*","examination_ophthal_frequent_lids","lids_id='".$symp_id."' and doc_id='".$admin_id."' and doc_type='1' and eye_type='1'","","","","");
					...
					if(count($check_symp)>0){
						...
						$update_icd=mysqlUpdate('examination_ophthal_frequent_lids',$arrFieldsSYMPFREQ,$arrValuesSYMPFREQ,"flids_id = '".$check_symp[0]['flids_id']."'");
					}
					else{
						...
						$arrFieldsSYMPFREQ[] = 'freq_count';
						$arrValuesSYMPFREQ[] = "1";
						$insert_freq_symp=mysqlInsert('examination_ophthal_frequent_lids',$arrFieldsSYMPFREQ,$arrValuesSYMPFREQ);
...
$get_all_lids = mysqlSelect("*","examination_ophthal_lids","(doc_id='".$admin_id."' and doc_type='1' and eye_type='1') or (doc_id='0' and doc_type='0' and eye_type='1') ","lids_id DESC","","","");			
