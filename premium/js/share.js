...
{ 
						...
						$('.bt-send-link').click(function(){
							var theUserName = $('#txtUser');
							var theUserEmail = $('#txtEmail');
							var theUserMobile = $('#txMobile');
							var theHospId = $('#txtHospId');
							var theHospName = $('#txtHospName');
							...
							if( !theUserEmail.val() && !theUserMobile.val()){ 
								...
								$.ajax({
									...
									data: 'act=add-com&userName='+theUserName.val()+'&userMail='+theUserEmail.val()+'&userMobile='+theUserMobile.val()+'&hospID='+theHospId.val()+'&hospName='+theHospName.val(),
									success: function(html){
										theUserEmail.val('');
										theUserMobile.val('');
									//alert('Link Sent Successfully');
									swal({
											title: "Appointment Link Sent Successfully!",
											text: "",
											type: "success"
										});
									}  
						...
						// Error on while sharing appointment link 
                ...
                closeOnConfirm: false
					...
					window.location.assign("https://medisensecrm.com/premium/Profile");
				});	
						...
						$('#cmdshareinner').click(function(){
							...
							if( !recEmail.val()){ 
								...
								$.ajax({
									type: "POST",
									url: "http://pixeleyecare.com/Partners/add_details.php",
