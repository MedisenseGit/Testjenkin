$(document).ready(function() {
 ...
 $("#cancelTempPrescription").hide();
	...
	$("#view-trend-analysis").hide();
		...
		$("#vaccineDetailSec").hide();
		$("#growthDetailSec").hide();
		$("#vitalDetailSec").hide();
		$("#visit-tracker").hide();
		$("#custom-view-trend-analysis").css("display","none");
	 $("#growthChartDisp").hide();
	...
	$("#vaccineDtl").click(function(){
		...
		$("#custom-view-trend-analysis").css("display","none");
		$("#growthDetailSec").hide();
		$("#vaccineDetailSec").show();
		$("#vitalDetailSec").hide();
		$("#growthChartDisp").hide();
		$("#visit-tracker").hide();
	});
	$("#growthDtl").click(function(){
		...
		$("#custom-view-trend-analysis").css("display","none");
		$("#vaccineDetailSec").hide();
		$("#growthDetailSec").show();
		$("#vitalDetailSec").hide();
		$("#growthChartDisp").hide();
		$("#visit-tracker").hide();
	});
	$("#vitalDtl").click(function(){		
		$("#view-video_call").hide();
		$("#view-latest-reports").hide();
		$("#view-trend-analysis").hide();
		$("#add-visit-dtails").hide();
	...
	$("#growthChartClick").click(function(){		
		$("#view-video_call").hide();
		$("#view-latest-reports").hide();
		$("#view-trend-analysis").hide();
		$("#add-visit-dtails").hide();
		...
		$("#growthDetailSec").hide();
		$("#vitalDetailSec").hide();
		$("#growthChartDisp").show();
		$("#visit-tracker").hide();
	});
	
	$("#visitTracker").click(function(){		
		$("#view-video_call").hide();
		$("#view-latest-reports").hide();
		$("#view-trend-analysis").hide();
		$("#add-visit-dtails").hide();
	...
	$("body").on("click", ".bpCondition", function() {
		...
		var patbp = $(this).val();	
		var patientid = $(this).attr("data-patient-id");
		var url = hostUrl+"upadte_medical_history.php?updatecon=1&patientid="+patientid+"&patbp="+patbp;
		console.log(patbp,url);
		//$(this).parent("span").remove();
	...
	$("body").on("click", ".cholestrolCondition", function() {
		...
		var patchol = $(this).val();	
		var patientid = $(this).attr("data-patient-id");
		var url = hostUrl+"upadte_medical_history.php?updatecon=1&patientid="+patientid+"&patchol="+patchol;
		console.log(patchol,url);
		//$(this).parent("span").remove();
		...
		if(patchol == "") {
			...
			$.get(url, function(response) {
                ...
                toastr.success('', 'Cholestrol Updated Successfully');
	...
	$("body").on("click", ".thyroidCondition", function() {
		...
		var patthy = $(this).val();	
		var patientid = $(this).attr("data-patient-id");
		var url = hostUrl+"upadte_medical_history.php?updatecon=1&patientid="+patientid+"&patthy="+patthy;
		console.log(patthy,url);
		//$(this).parent("span").remove();
		...
		if(patthy == "") {
			...
			$.get(url, function(response) {
                ...
                toastr.success('', 'Thyroid Updated Successfully');
	...
	$("body").on("click", ".asthamaCondition", function() {
		...
		var patast = $(this).val();	
		var patientid = $(this).attr("data-patient-id");
		var url = hostUrl+"upadte_medical_history.php?updatecon=1&patientid="+patientid+"&patast="+patast;
		console.log(patast,url);
		//$(this).parent("span").remove();
		...
		if(patast == "") {
			...
			$.get(url, function(response) {
                ...
                toastr.success('', 'Asthama Updated Successfully');
	...
	$("body").on("click", ".epilepsyCondition", function() {
		...
		var patepi = $(this).val();	
		var patientid = $(this).attr("data-patient-id");
		var url = hostUrl+"upadte_medical_history.php?updatecon=1&patientid="+patientid+"&patepi="+patepi;
		console.log(patepi,url);
		//$(this).parent("span").remove();
		...
		if(patepi == "") {
			...
			$.get(url, function(response) {
                ...
                toastr.success('', 'Epilepsy Updated Successfully');
	...
	$("body").on("change", "#selectDignosticCenter", function() {
		...
		var diagnoid = $(this).val();
		 swal({
                        ...
                        text: "You must receive explicit consent of the patient that entitles you to share the Electronic medical record or E-prescription to diagnostic centers. (They will only be able to see patient name and tests ordered and not other details) ",
                        type: "warning",
	...
	$("body").on("change", "#selectPharma", function() {
		...
		var pharmaid = $(this).val();
		 swal({
                        ...
                        text: "You must receive explicit consent of the patient that entitles you to share the Electronic medical record or E-prescription to Pharmacies. (They will only be able to see patient name and Prescription and not other details)",
                        type: "warning",
                        showCancelButton: true,
                        confirmButtonColor: "#DD6B55",
                        confirmButtonText: "Yes, refer it!",
