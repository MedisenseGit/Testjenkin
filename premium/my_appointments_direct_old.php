...
$checkDilation= $objQuery->mysqlSelect("*","appointment_token_system","doc_id='".$admin_id."' and doc_type='1' and set_diation_timer<'".date('H:i:s')."' and app_date='".date('Y-m-d')."'","","","","");
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<?php } ?><!-- data-target="#myModal<?php echo $Todaylist['appoint_trans_id']; ?>" -->
