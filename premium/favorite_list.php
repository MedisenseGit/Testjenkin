...
if(isset($_GET['s'])){
	...
	$countRslt = mysqlSelect("COUNT(a.ref_id) as count","referal as a inner join specialization as b on a.doc_spec=b.spec_id inner join doctor_hosp as c on c.doc_id=a.ref_id inner join hosp_tab as d on d.hosp_id=c.hosp_id","((a.doc_spec!=555 and a.anonymous_status!=1) and ((a.ref_name LIKE '%".$_GET['s']."%' or a.doc_interest LIKE '%".$_GET['s']."%' or a.doc_research LIKE '%".$_GET['s']."%' or a.doc_contribute LIKE '%".$_GET['s']."%' or a.doc_pub LIKE '%".$_GET['s']."%' or d.hosp_name LIKE '%".$_GET['s']."%') or ((b.spec_name LIKE '%".$postid1."%' or a.ref_name LIKE '%".$postid1."%' or a.ref_address LIKE '%".$postid1."%' or a.doc_state LIKE '%".$postid1."%') and (a.ref_address LIKE '%".$postid2."%' or a.doc_state LIKE '%".$postid2."%' or b.spec_name LIKE '%".$postid2."%'))))","a.doc_type_val asc","","","");
			...
			$back = $eu - $limit; 
			$next = $eu + $limit;
	$getFavour = mysqlSelect("a.ref_id as Ref_Id,a.ref_name as Ref_Name,a.doc_type_val as Doc_Type,a.ref_exp as Ref_Exp,a.ref_address as Ref_Address,a.doc_state as Doc_State,a.doc_photo as Doc_Image,b.spec_name as Specialization,c.favourite_id as Favour_Id","referal as a inner join specialization as b on a.doc_spec=b.spec_id inner join add_favourite_doctor as c on c.doc_id=a.ref_id","(a.doc_spec!=555 and a.anonymous_status!=1) and (c.user_id='".$admin_id."' and c.user_type=1)","a.doc_type_val asc","","","$eu, $limit");
	$pag_result = mysqlSelect("*","referal as a inner join specialization as b on a.doc_spec=b.spec_id inner join add_favourite_doctor as c on c.doc_id=a.ref_id","(a.doc_spec!=555 and a.anonymous_status!=1) and (c.user_id='".$admin_id."' and c.user_type=1)","a.doc_type_val asc","");
...
if(isset($_POST['cmdDel'])){
	...
	//echo $favour_id;	
	mysqlDelete('add_favourite_doctor',"favourite_id='".$favourid ."'");			
	$response="delete";
	header("Location:Favorites?response=".$response);
}
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Favorite Doctors</strong>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="contact-box center-version">
                    ...
                    <div class="contact-box-footer">
						...
						<div class="tooltip-demo">
                            ...
                            <a class="btn btn-xs btn-white" data-toggle="tooltip" data-placement="top" title="Remove from your favorite list"><i class="fa fa-trash-o"></i> Remove</a>
                        </div>
						</div>
                    </div>
