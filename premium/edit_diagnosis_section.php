<div class="col-lg-12" style="background-color:#f8f8f8; border:1px dashed #cecdcb; padding-top:20px; margin-bottom:20px;">
								...
								<?php
								$get_diagnosis = mysqlSelect("a.icd_id as icd_id,b.icd_code as icd_name,a.patient_diagnosis_id as patient_diagnosis_id","patient_diagnosis as a inner join icd_code as b on a.icd_id=b.icd_id","a.episode_id='".$edit_patient_episodes[0]['episode_id']."'","","","","");
