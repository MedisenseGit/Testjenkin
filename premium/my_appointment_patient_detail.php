...
$appointmentResult = $objQuery->mysqlSelect("a.patient_name as Patient_name,a.appoint_trans_id as Trans_ID,a.pay_status as Pay_Status,a.Visiting_date as Visit_Date,a.Visiting_time as Visit_Time,a.Time_stamp as Create_Date","appointment_transaction_detail as a inner join referal as b on a.pref_doc=b.ref_id","a.appoint_trans_id='".$transid."'","","","","");
$getPatientDetails = $objQuery->mysqlSelect("*","new_hospvisitor_details","Transaction_id='".$appointmentResult[0]['Trans_ID']."'","","","","");
$getTiming = $objQuery->mysqlSelect("*","timings","Timing_id='".$appointmentResult[0]['Visit_Time']."'","","","","");

$status_val=array("At reception"=>"6","Consulted"=>"2","Cancelled"=>"3","Missed"=>"5");	
//Update patient status
if(isset($_POST['cmdAppStatus1'])){
	if($_POST['slct_val1']==6){
                            ...
                            <div class="row">
								...
								<input type="hidden" name="cmdAppStatus1" value="" /> 
									...
									<div class="btn-group pull-right">
									   ...
									   <li><a href="#" onclick="return ChangeAppStatus1(6,<?php echo $appointmentResult[0]['Trans_ID']; ?>);">At reception</a></li>
										<li><a href="#" onclick="return ChangeAppStatus1(2,<?php echo $appointmentResult[0]['Trans_ID']; ?>);">Consulted</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7" id="cluster_info">
                                    <dl class="dl-horizontal" >
                                        ...
                                        <dt>Visit Date:</dt> <dd><?php echo date('M d-Y',strtotime($appointmentResult[0]['Visit_Date']))."<br> Time: ".$getTiming[0]['Timing']; ?></dd>
