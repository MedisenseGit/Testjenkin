...
$get_diagnoInfo = mysqlSelect("*","Diagnostic_center as a left join doc_diagnostics as b on a.diagnostic_id=b.diagnostic_id","b.doc_id='".$admin_id."' or b.company_id='".$getDocDetails[0]['company_id']."'","b.doc_diagno_id desc","","","");
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
										...
										<td><?php echo $list['diagnosis_city']; ?></td>										
                                       	<?php if($secretary_id!=1 && $list['doc_id']!== '0') { ?><td><a href="javascript:void(0)" onclick="return delDiagnostics(<?php echo $list['doc_diagno_id']; ?>);" class="btn btn-danger btn-bitbucket btn-xs">
