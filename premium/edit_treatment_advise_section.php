<div class="col-lg-12" style="background-color:#f8f8f8; border:1px dashed #cecdcb; padding-top:20px; margin-bottom:20px;">
								...
								<?php $last_five_treatment = mysqlSelect("*","doctor_frequent_treatment","(doc_id='0' and doc_type='0') or (doc_id='".$admin_id."' and doc_type='1')","freq_count DESC","","","5");
								...
								<?php 
								$getTreatment= mysqlSelect("b.treatment as treatment,a.treatment_id as treatment_id","doc_patient_treatment_active as a left join doctor_frequent_treatment as b on a.dft_id=b.dft_id","a.episode_id='".$edit_patient_episodes[0]['episode_id']."'","a.treatment_id asc","","","");
