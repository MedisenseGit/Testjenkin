...
if(!empty($doctor_id) && !empty($finalHash)) 
{
	...
	{ 
		...
		$get_AppointDetails = mysqlSelect('patient_id','patients_transactions',"patient_trans_id ='".$appoint_id."'","","","","");
		$patient_id			= $get_AppointDetails[0]['patient_id'];
		
		$get_MyPatient = mysqlSelect('a.patient_id as patient_id,a.patient_name as patient_name ,a.patient_email as patient_email,a.patient_gender as patient_gen,b.patient_age as patient_age,b.height_cms as height,b.weight as weight,b.hyper_cond as hyper_cond,b.smoking as smoking,b.alcoholic as alcoholic,b.diabetes_cond as diabetes_cond,b.prev_intervention as prev_inter,b.neuro_issue as neuro_issue,b.kidney_issue as kidney_issue,b.other_details as  other_details,b.blood_group as pat_blood,b.pat_bp as pat_bp,b.pat_thyroid as pat_thyroid,b.pat_cholestrole as pat_cholestrole,b.pat_epilepsy as pat_epilepsy,b.pat_asthama as pat_asthama,b.doc_video_link as doc_video_link',' patients_appointment AS a INNER JOIN patients_transactions as b ON a.patient_id = b.patient_id',"a.patient_id ='".$patient_id."'","","","","");
		foreach($get_MyPatient as $listget_MyPatient)
		{
			...
			{	
				...
				{
					$patient_tab = mysqlSelect("*","patients_appointment","patient_id='".$get_reports[0]['user_id']."'","","","","");
