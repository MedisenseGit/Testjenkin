...
/*if(!empty($doctor_id) && !empty($finalHash)) {
	...
	// $result = mysqlSelect('accessToken','referal',"ref_id='".$doctor_id."'");
	...
	{*/
		...
		foreach($get_MyPatient as $listget_MyPatient){
			...
			$login_user = mysqlSelect('b.login_id as login_id, b.civil_id as civil_id','user_family_member as a inner join login_user as b on b.login_id = a.user_id',"a.member_id='".$listget_MyPatient['member_id']."'","","","","");
				$getEpiList['civil_id']=$login_user[0]['civil_id'];
