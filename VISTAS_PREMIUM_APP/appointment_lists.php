...
if(!empty($doctor_id) && !empty($finalHash)) {
	...
	if($finalHash == $hashKey) 
	{
		...
		if($filter_type == 1)
		{
			...
			//$appointmentResult = mysqlSelect("c.Time_slot as Time_slot,c.Visiting_date as Visiting_date,c.Visiting_time as Visiting_time,c.id as appoint_id, c.appoint_trans_id as appoint_trans_id, c.patient_id as patient_id, c.patient_name as patient_name, c.pref_doc as doc_id, c.hosp_id as hosp_id, c.pay_status as status, a.app_date as app_date, a.app_time as app_time, c.Time_stamp as created_date, b.patient_email as patient_email, b.patient_mob as patient_mob, b.doc_video_link as doc_video_link, c.Time_stamp as Time_stamp, c.appointment_type as appointment_type, b.member_id as member_id","appointment_token_system as a inner join doc_my_patient as b on b.patient_id = a.patient_id inner join appointment_transaction_detail as c on c.appoint_trans_id = a.appoint_trans_id","a.doc_id='".$doctor_id."' and a.doc_type='1' and a.hosp_id='".$hospital_id."' and (a.app_date>='".$ToDay."') ","a.app_date DESC","","","");	

			//$appointmentResult = mysqlSelect("c.Time_slot AS Time_slot, c.Visiting_date AS Visiting_date, c.Visiting_time AS Visiting_time, c.id AS appoint_id, c.appoint_trans_id AS appoint_trans_id, c.patient_id AS patient_id, c.patient_name AS patient_name, c.pref_doc AS doc_id, c.hosp_id AS hosp_id, c.pay_status AS STATUS , a.app_date AS app_date, a.app_time AS app_time, c.Time_stamp AS created_date, b.patient_email AS patient_email, b.patient_mob AS patient_mob, b.doc_video_link AS doc_video_link, c.Time_stamp AS Time_stamp, c.appointment_type AS appointment_type, b.member_id AS member_id","appointment_token_system AS aINNER JOIN doc_my_patient AS b ON b.patient_id = a.patient_id INNER JOIN appointment_transaction_detail AS c ON c.appoint_trans_id = a.appoint_trans_id","a.doc_id =3727 AND a.doc_type = '1' AND a.hosp_id =1093  AND (a.app_date >='2021-11-27') ","","","","");
			
			$appointmentResult = mysqlSelect('c.Time_slot AS Time_slot, c.Visiting_date AS Visiting_date, c.Visiting_time AS Visiting_time, c.id AS appoint_id, c.appoint_trans_id AS appoint_trans_id, c.patient_id AS patient_id, c.patient_name AS patient_name, c.pref_doc AS doc_id, c.hosp_id AS hosp_id, c.pay_status AS STATUS , a.app_date AS app_date, a.app_time AS app_time, c.Time_stamp AS created_date, b.patient_email AS patient_email, b.patient_mob AS patient_mob, b.doc_video_link AS doc_video_link, c.Time_stamp AS Time_stamp, c.appointment_type AS appointment_type, b.member_id AS member_id','appointment_token_system AS a INNER JOIN doc_my_patient AS b ON b.patient_id = a.patient_id INNER JOIN appointment_transaction_detail AS c ON c.appoint_trans_id = a.appoint_trans_id',"a.doc_id = '".$doctor_id."' AND a.app_date >= '".$ToDay."'","","","","");
		...
		{
			$appointmentResult = mysqlSelect("c.Time_slot as Time_slot,c.Visiting_date as Visiting_date,c.Visiting_time as Visiting_time,c.id as appoint_id, c.appoint_trans_id as appoint_trans_id, c.patient_id as patient_id, c.patient_name as patient_name, c.pref_doc as doc_id, c.hosp_id as hosp_id, c.pay_status as status, a.app_date as app_date, a.app_time as app_time, c.Time_stamp as created_date, b.patient_email as patient_email, b.patient_mob as patient_mob, b.doc_video_link as doc_video_link, c.Time_stamp as Time_stamp, c.appointment_type as appointment_type, b.member_id as member_id","appointment_token_system as a inner join doc_my_patient as b on b.patient_id = a.patient_id inner join appointment_transaction_detail as c on c.appoint_trans_id = a.appoint_trans_id","a.doc_id='".$doctor_id."' and a.doc_type='1' and a.hosp_id='".$hospital_id."' and c.pay_status='VC Confirmed' or c.pay_status='Consulted'","a.app_date DESC","","","$this1, $page_limit");
		...
		else if($filter_type == 4)
		{
			...
			$appointmentResult = mysqlSelect("c.Time_slot as Time_slot,c.Visiting_date as Visiting_date,c.Visiting_time as Visiting_time,c.id as appoint_id, c.appoint_trans_id as appoint_trans_id, c.patient_id as patient_id, c.patient_name as patient_name, c.pref_doc as doc_id, c.hosp_id as hosp_id, c.pay_status as status, a.app_date as app_date, a.app_time as app_time, c.Time_stamp as created_date, b.patient_email as patient_email, b.patient_mob as patient_mob, b.doc_video_link as doc_video_link, c.Time_stamp as Time_stamp, c.appointment_type as appointment_type, b.member_id as member_id","appointment_token_system as a inner join doc_my_patient as b on b.patient_id = a.patient_id inner join appointment_transaction_detail as c on c.appoint_trans_id = a.appoint_trans_id"," a.doc_id='".$doctor_id."' and b.member_id='".$member_id."' and a.doc_type='1' and  c.pay_status='VC Confirmed' or c.pay_status='Consulted'","a.app_date DESC","","","$this1, $page_limit");
