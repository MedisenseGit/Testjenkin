...
{	
	...
	foreach($appointResult as $appoint_order) 
		{
			...
			$order_details['schedule']    = $appoint_order['Time_stamp'];
	...
	$second_opinion_order=$objQuery->mysqlSelect("a.patient_name as patient_name,b.timestamp as timestamp,b.status2 as order_status","patient_tab as a inner join patient_referal as b on a.patient_id=b.patient_id"," a.login_user_id='".$user_data[0]['login_id']."'  and service_type = 1 ","","","","");
	...
	$medical_travel_list = $objQuery->mysqlSelect("a.patient_name as patient_name,b.timestamp as timestamp,b.status2 as order_status","patient_tab as a inner join patient_referal as b on a.patient_id=b.patient_id"," a.login_user_id='".$user_data[0]['login_id']."'  and service_type = 2 ","","","","");
