...
if(HEALTH_API_KEY == $data ->api_key)
	{
		$userDetails = mysqlSelect("*","login_user","login_id='".$data ->userid."'","","","","");
		...
		$doc_details= array();
			...
			$chkDay = mysqlSelect("day_id,time_id","doc_time_set","md5(doc_id)='".$data ->docId."' and time_set='1'","","time_id,day_id","","");
			$postResult = mysqlSelect("*","health_home_posts","md5(Login_User_Id)='".$data->docId."' and Login_User_Type='doc' and post_type='blog'","post_id desc","","","");
			$docVideo = mysqlSelect("*","health_home_posts","md5(Login_User_Id)='".$data->docId."' and Login_User_Type='doc' and post_type='video'","post_id desc","","","");
			
			$latestblog = mysqlSelect("*","health_home_posts","post_type='blog'","post_id desc","","","0,3");
			
			$familyResult = mysqlSelect("*","user_family_member","user_id='".$data ->userid."'","","","","");
			
			$getSpec= mysqlSelect("*","specialization","","spec_name asc","","","");
