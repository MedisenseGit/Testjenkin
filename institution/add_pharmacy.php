...
$get_pharmaInfo = mysqlSelect("*","pharma as a left join doc_pharma as b on a.pharma_id=b.pharma_id","","b.doc_pharma_id desc","","","");
        ...
        <div class="wrapper wrapper-content">
			...
			<form method="post" name="frmAddPayments" autocomplete="off" action="add_details.php" autocomplete="off">
                <div class="row">
					...
					<div class="col-sm-1">
                        <div class="form-group">
						 <label class="control-label" for="status" style="margin-top:5px;"></label>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                       ...
                                       <td><a href="javascript:void(0)" onclick="return delPharma(<?php echo $list['doc_pharma_id']; ?>,<?php echo $list['pharma_id']; ?>);" class="btn btn-danger btn-bitbucket btn-xs">
