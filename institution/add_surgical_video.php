    ...
    <?php include_once('sidemenu.php'); ?>
        ...
        <?php include_once('header_top.php'); ?>
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Add Surgical Video</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="Home">Home</a>
                        </li>
                        <li>
                            <a href="Surgical-Video">Surgical Video List</a>
                        </li>
                        <li class="active">
                            <strong>Add Surgical Video</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="ibox float-e-margins">
				 ...
				 <form enctype="multipart/form-data" method="post" action="add_details.php" >
					...
					<div class="form-group"><label class="col-sm-2 control-label">Author </label>
                                    ...
                                    <div class="col-sm-10 m-b-xl"><select data-placeholder="Choose doctor..." class="chosen-select" name="slctDoc" required="required"  tabindex="2">
					...
					<div class="form-group">
                         <label class="col-sm-2 control-label">Video Title <span class="required">*</span></label>
                                    ...
                                    <div class="col-sm-10 m-b-xl"><input type="text" name="video_title" required="required" class="form-control"></div>
					</div><br><br>
					<div class="form-group">
                         <label class="col-sm-2 control-label">Add Youtube Video Url <span class="required">*</span></label>

                                    <div class="col-sm-10 m-b-xl"><input type="text" name="video_link" required="required" placeholder="Enter Youtube Url - www.youtube.com/watch?v=rdmycu13Png" class="form-control"></div>
					</div><br><br>
					<div class="form-group">
