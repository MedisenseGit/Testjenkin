<?php
	...
	$getPharma = mysqlSelect("*","pharma","company_id='".$admin_id."'","","","","");
	//DIAGNOSTIC TABLE DETAILS
	$getDiagnos = mysqlSelect("*","Diagnostic_center","company_id='".$admin_id."'","","","","");
	$sel_hosp_name = mysqlSelect("company_name as comp_name","compny_tab ","company_id='".$admin_id."'","","","","");
	...
	<body>
		...
		<script>
			...
			$(document).ready(function(){
				...
				$get_PatientDetails = mysqlSelect("a.patient_id as patient_id ,a.patient_name as patient_name ,a.patient_mobile as patient_mob","patients_appointment as a INNER JOIN patients_transactions as b ON a.patient_id =b.patient_id INNER JOIN referal as c on c.ref_id = b.doc_id INNER JOIN doctor_hosp as d ON d.doc_id=b.doc_id  INNER JOIN hosp_tab as e ON e.hosp_id = d.hosp_id INNER JOIN specialization as f ON f.spec_id = c.doc_spec","d.hosp_id='".$admin_id."'","","","","");
