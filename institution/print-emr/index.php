...
<html>
	...
	<?php } ?>
	    <a href="<?php echo $completeURL;?>Referred-EMR" class="btn">BACK</a>
		
		<a href="#" onclick="open(location, '_self').close();window.location.href = '<?php echo $completeURL;?>Referred-EMR';" class="btn" >EXIT</a>
