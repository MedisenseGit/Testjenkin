...
$marketPerson = mysqlSelect("a.person_id as Person_Id,a.person_name as Person_Name,a.person_mobile as Person_Mobile,a.person_email as Person_Email,b.hosp_name as Hosp_Name,b.hosp_city as Hosp_City,b.hosp_state as Hosp_State","hosp_marketing_person as a inner join hosp_tab as b on a.hosp_id=b.hosp_id","b.company_id='".$admin_id."'","a.person_id desc","","","");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content table-responsive">
                      ...
                      <i class="fa fa-edit"></i></a></center></td> <!--onclick="return showMarketTeam(<?php echo $list['Person_Id']; ?>);"-->
                        </tr>
                           <?php }  ?>
                            </tbody>
                        </table>
