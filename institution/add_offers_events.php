            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="Offers-Events-List">Offers Events List</a>
                        </li>
                        <li class="active">
				 ...
				 <form enctype="multipart/form-data" method="post" action="add_details.php" >
					...
					<div class="form-group">
                         <label class="col-sm-2 control-label">Event Title <span class="required">*</span></label>
                                    ...
                                    <div class="col-sm-10 m-b-xl"><input type="text" name="offer_title" required="required" class="form-control"></div>
					</div><br><br>
					<div class="form-group">
					...
					<div class="form-group">
                                    ...
                                    <div class="col-sm-10 m-b-xl"><textarea class="form-control"  name="org_committee" rows="15"></textarea></div>
                    </div>
					<div class="form-group">
									 <label class="col-sm-2 control-label">Keynote Speakers<span class="required">*</span></label>

                                    <div class="col-sm-10 m-b-xl"><textarea class="form-control"  name="key_speaker" rows="15"></textarea></div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
								...
								<div class="col-sm-2 pull-right">
								<button type="submit" name="addOffers" class="btn btn-primary block full-width m-b "><i class="fa fa-paper-plane"></i> PUBLISH</button>
								</div>
