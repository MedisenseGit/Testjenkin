...
//$get_compInfo = mysqlSelect("*","compny_tab","company_id='".$admin_id."'","","","","");
                ...
                <div class="col-md-4">
                    <div class="ibox float-e-margins">
                        ...
                        <div>
							...
							<?php if(!empty($getCompanyProfile[0]['company_logo'])){ 
                                $logo_url=IMG_URL_VIEW."premium/company_logo/".$getCompanyProfile[0]['company_id']."/".$getCompanyProfile[0]['company_logo'];
                                //echo $logo_url;
                                ?>
                                <img alt="image" class="img-xlg img-responsive" src="<?php echo $logo_url;  ?>">
                             <?php }  else { ?>
							 <img alt="image" class="img-xlg img-responsive" src="../assets/img/anonymous-profile.png">
                             <?php  } ?>
							</div>
                            <div class="ibox-content profile-content">
                                <h4><strong><?php echo $getCompanyProfile[0]['company_name']; ?></strong></h4>
                                <p><i class="fa fa-map-marker"></i> <?php if(!empty($getCompanyProfile[0]['company_addrs'])){ echo ", ".$getCompanyProfile[0]['company_addrs']; } ?></p>
                                <br>
                                <p>
								<i class="fa fa-phone"></i> <?php echo $getCompanyProfile[0]['mobile']; ?><br>
								<i class="fa fa-envelope"></i> <?php echo $getCompanyProfile[0]['email_id']; ?>
                                </p>
                        ...
                        <div class="tab-content">
                            ...
                            <form method="post" class="form-horizontal" enctype="multipart/form-data" action="add_details.php" method="post"  name="frmAddPatient" >
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10"><input type="text" id="txtOrgName" name="txtOrgName" value="<?php echo $getCompanyProfile[0]['company_name']; ?>" class="form-control"></div>
                                
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">Contact Person Name</label>

                                    <div class="col-sm-10"><input type="text" id="txtContactPerson" name="txtContactPerson" value="<?php echo $getCompanyProfile[0]['owner_name']; ?>" class="form-control"></div>
                                
								</div>
								<div class="form-group"><label class="col-sm-2 control-label">Address</label>

                                    <div class="col-sm-10"><textarea class="form-control" id="txtAddress" name="txtAddress" rows="3"><?php echo $getCompanyProfile[0]['company_addrs']; ?></textarea></div>
                                </div>
								<div class="form-group"><label class="col-sm-2 control-label">Mobile <span class="required">*</span></label>

                                    <div class="col-sm-4"><input type="text" class="form-control" id="txtMobile" name="txtMobile" value="<?php echo $getCompanyProfile[0]['mobile']; ?>" placeholder="10 digit mobile no."></div>
									<label class="col-sm-2 control-label">Email</label>

                                    <div class="col-sm-4"><input id="txtEmail" name="txtEmail" value="<?php echo $getCompanyProfile[0]['email_id']; ?>" class="form-control"></div>
