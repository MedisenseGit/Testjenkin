...
//TELECUNSALTAION DETAILS
 ...
 $gettelDeta = mysqlSelect("c.id as appoint_id,c.patient_name as patient_name,c.pay_status as status, a.app_date as app_date, a.app_time as app_time,c.Email_address as patient_email, c.Mobile_no as patient_mob,b.ref_name as Ref_Name,a.appoint_trans_id as appoint_trans_id,d.hosp_name as hosp_name","appointment_token_system as a inner join referal as b on b.ref_id = a.doc_id inner join appointment_transaction_detail as c on c.appoint_trans_id = a.appoint_trans_id inner join hosp_tab as d on d.hosp_id=c.hosp_id","c.appointment_type='2' or c.appointment_type='3'","c.id Desc","","","$no_of_records_per_page");


//APPIONTMENT DETAILS

$getAppointDeta = mysqlSelect("c.id as appoint_id,c.patient_name as patient_name,c.pay_status as status, a.app_date as app_date, a.app_time as app_time,c.Email_address as patient_email, c.Mobile_no as patient_mob,b.ref_name as Ref_Name,a.appoint_trans_id as appoint_trans_id,d.hosp_name as hosp_name","appointment_token_system as a inner join referal as b on b.ref_id = a.doc_id inner join appointment_transaction_detail as c on c.appoint_trans_id = a.appoint_trans_id inner join hosp_tab as d on d.hosp_id=c.hosp_id","c.appointment_type='0' or c.appointment_type='1'","c.id Desc","","","$no_of_records_per_page");


//PHARMA TABLE DETAILS
 $getPharma = mysqlSelect("*","pharma","company_id='".$admin_id."'","pharma_id desc","","","$no_of_records_per_page");

//DIAGNOSTIC TABLE DETAILS

$getDiagnos = mysqlSelect("*","Diagnostic_center","company_id='".$admin_id."'","diagnostic_id desc","","","$no_of_records_per_page");

//hosptial details

$getHosp = mysqlSelect("*","hosp_tab","","hosp_id desc","","","$no_of_records_per_page");

//SECOND OPINION DETAILS


$getSecOp = mysqlSelect("a.patient_id as PID,a.patient_name as patient_name ,a.patient_id as patient_id ,a.TImestamp as TImestamp,b.status2 as Status,c.ref_name as Ref_Name,e.hosp_name as hosp_name","patient_tab as a inner join patient_referal as b on a.patient_id=b.patient_id  inner join referal as c on c.ref_id=b.ref_id inner join doctor_hosp as d on d.doc_id=c.ref_id inner join hosp_tab e on e.hosp_id=d.hosp_id","a.opinion_for='0'","a.patient_id desc","","","$no_of_records_per_page");


$data_diagno = mysqlSelect("count(a.dr_id) as did","diagnostic_referrals as a inner join Diagnostic_center as b on b.diagnostic_id=a.diagnostic_id","","","","","");


$data_pharma = mysqlSelect("count(a.pr_id) as pid","pharma_referrals as a inner join pharma as b on b.pharma_id=a.pharma_id ","","","","","");

$data_SecOp = mysqlSelect("count(a.patient_id) as soid","patient_tab as a inner join patient_referal as b on a.patient_id=b.patient_id  inner join doctor_hosp as c on c.doc_id=b.ref_id inner join hosp_tab as d on d.hosp_id=c.hosp_id","a.opinion_for='0'","","","","");


//TOTAL NUMBER OF TELECUNSULTATION


$data_tele = mysqlSelect("count(distinct id) as tid","appointment_transaction_detail","","","","","");

//PENDING TELECUNSULTATION


$tele_pend = mysqlSelect("count(distinct id) as peid","appointment_transaction_detail","tele_communication='1' and pay_status='VC Confirmed'","","","","");

//hospital count

$data_hosp=mysqlSelect("count(hosp_id) as hosp_id","hosp_tab ","","","","","");

$sel_hosp_name = mysqlSelect("company_name as comp_name","compny_tab ","","","","","");
...
<body>
    ...
    <?php include_once('sidemenu.php'); ?>
		...
		<?php include_once('header_top.php'); ?>
			...
			<div class="row" >
				<div class="col-lg-2 col" style="margin:40px 10px 40px 60px;background-color:#957DAD; border-radius:10px;">
					<h3 style="text-align:center;color:#337ab7;margin: 35px 0px;color:#ffff"><a><span style="color:#000000;">Hospitals <hr><br><?php echo number_format($data_hosp[0][hosp_id]); ?></span></a></h3>
				</div>
				<div class="col-lg-2 col" style="margin:40px 10px;background-color:#957DAD; border-radius:10px;">
					<h3 style="text-align:center;color:#337ab7;margin: 35px 0px;color:#ffff"><a><span style="color:#000000;">Teleconsultations <hr>Paid / Total  <br><?php echo number_format($tele_pend[0][peid]); ?> / <?php echo number_format($data_tele[0][tid]); ?></span></a></h3>
				</div>
				<div href="Cases-Recieved" class="col-lg-2 col" style="margin:40px 0px;background-color:#FF968A;border-radius:10px;">
					<h3 style="text-align:center;color:#337ab7;margin: 35px 0px;color:#ffff"><a><span style="color:#000000;">Second Opinion <hr><br><?php echo number_format($data_SecOp[0][soid]); ?></span></a></h3>
				</div>
				<div class="col-lg-2" style="margin:40px 10px; background-color:#97C1A9;border-radius:5px;">
					<h3 style="text-align:center;color:#337ab7;margin: 35px 0px;color:#ffff"><a><span style="color:#000000;">Diagnostic Orders<hr><br><?php echo number_format($data_diagno[0][did]); ?></span></a></h3>
				</div>	
				<div class="col-lg-2" style="margin:40px 10px; background-color:#ECD5E3;border-radius:10px;">
					<h3 style="text-align:center;color:#337ab7;margin: 35px 0px; color:#ffff"><a><span style="color:#000000;">Pharma Orders<hr><br><?php echo number_format($data_pharma[0][pid]); ?></span></a></h3>
				</div>		
			</div>
                            ...
                            <tbody>
									...
									<a>
										<tr>
										   ...
										   <td><a><?php echo $list5['Ref_Name'];  ?> | <?php echo $list5['hosp_name'];  ?></a></td>
                            ...
                            <tbody>
									...
									<a>
										...
										<td><a href="Reschedule?a=<?php echo $list6['appoint_trans_id']; ?>"><?php echo $list6['patient_name'];  ?></a></td>
										   <td><a><?php echo $list6['Ref_Name'];  ?> | <?php echo $list5['hosp_name'];  ?></a></a></td>
        ...
        <div class="row" style="margin-right:100px;padding-left:40px;">
			<div class="col-lg-6">
				<h2 style="text-align:center;color:#00000;"><?php echo $sel_hosp_name[0][comp_name];?> Pharma</h2>
				<div class="wrapper wrapper-content animated fadeInRight">
					<div class="ibox-content table-responsive">
						<table class="table table-striped">
                            <thead>
			...
			<div class="col-lg-6">
				<h2 style="text-align:center;color:#00000;"><?php echo $sel_hosp_name[0][comp_name];?> Diagnostic</h2>
				<div class="wrapper wrapper-content animated fadeInRight">
					<div class="ibox-content table-responsive">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
								...
								<tr>
									...
									<td><a><?php echo $list4['Reffered_Date'];  ?></a></td>
        ...
        <div class="row" style="margin-right:100px;padding-left:40px;padding-bottom:80px;">
								...
								<tbody>
									...
									<a>
										<tr>
										   ...
										   <td><a><?php echo $list2['Ref_Name'];  ?> | <?php echo $list2['hosp_name'];  ?></a></td>
			...
			<div class="col-lg-6">
				<h2 style="text-align:center;color:#00000;">Hospital</h2>
				<div class="wrapper wrapper-content animated fadeInRight">
					<div class="ibox-content table-responsive">
						<table class="table table-striped">
                            <thead>
                            ...
                            <tbody>
								<?php foreach($getHosp as $hosp){	
										?>
									<a>
										<tr>
										   <td><a><?php echo $hosp['hosp_name'];  ?></a></td>
										   <td><a><?php echo $hosp['hosp_contact_name'];  ?></a></td>
										   <td><a><?php echo $hosp['hosp_addrs'];  ?> | <?php echo $hosp['hosp_city'];  ?></a></td>
										    <td><a><?php echo $hosp['hosp_contact'];?> | <br><a><?php echo $hosp['hosp_email'];  ?> </a></td>
										</tr>
									</a>
									<?php } ?>
                            </tbody>
                        </table>
						<small><a href="Add-Hospital">More</a></small>
					</div>
				</div>
