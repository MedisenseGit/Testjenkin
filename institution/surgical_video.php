    ...
    <?php include_once('sidemenu.php'); ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active">
                           <strong>Surgical Video</strong>
                        </li>
                    </ol>
					
                </div>
				 <div class="col-lg-2 mgTop pull-right">
					<a href="Add-Videos"> <button type="button" class="btn btn-w-m btn-success"><i class="fa fa-rss"></i> Add Surgical Video</button></a>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
				<?php 
				$getPostResult = mysqlSelect("*","home_posts","company_id='".$admin_id."' and post_type='surgical'","post_id desc","","","0,20");
												
				if(empty($getPostResult)) { ?>
				<div class="tab-content">			
					<div class="tab-pane m-l-xxl active">
						<center><p>You haven't shared any content on this page so far. <br>Would you like to add a Surgical Video ?<br>Click here to add</p>
				...
				<?php } else { ?>
					...
					foreach($getPostResult as $postResultList){
							...
							$postid=md5($postResultList['post_id']);
							$posttype=$postResultList['listing_type'];
							$postdate=$postResultList['Create_Date'];	
							$posttitle=$postResultList['post_tittle'];
							$numviews=$postResultList['num_views'];
							$getCode=$postResultList['video_id'];
							//$getCode  = str_replace("https://www.youtube.com/watch?v=", "", $postResultList['video_url']);
							...
							if(!empty($postResultList['post_image'])){
							$postimage="../premium/Postimages/".$postResultList['post_id']."/".$postResultList['post_image'];
							} else {
							$postimage="";
							}
							$url="Blogs";
                    ...
                    <div class="social-feed-box">
                        ...
                        <div class="social-footer">
							<div class="social-comment">
									<a href="" class="pull-left">
										<img alt="image" src="<?php if(!empty($getCompanyProfile[0]['company_logo'])){ echo "../premium/company_logo/".$getCompanyProfile[0]['company_id']."/".$getCompanyProfile[0]['company_logo']; } else { echo "../assets/img/anonymous-profile.png"; } ?>">
									</a>
									<div class="media-body">
