...
$getPostResult = mysqlSelect("*","home_posts","md5(post_id)='".$_GET['id']."'","","","","");
...
$get_pro = mysqlSelect("a.ref_id as RefId","referal as a inner join doctor_hosp as b on a.ref_id=b.doc_id inner join hosp_tab as c on c.hosp_id=b.hosp_id","md5(c.company_id)='".$admin_id."'","a.Tot_responded desc","","","");

$getPostKey=urlencode($getPostResult[0]['postkey']);
$getTitle= hyphenize($getPostResult[0]['post_tittle']);
$shareLink=HOST_MAIN_URL."Refer/share-blogs/".$getTitle."/".$getPostKey;
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
				...
				<?php   //TO CHECK USER TYPE WHETHER HE IS DOCTOR OR NOT
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div>
							...
							<?php if(!empty($getPostResult[0]['post_image'])){ ?>
							   <img alt="image" class="img-responsive" src="../premium/Postimages/<?php echo $getPostResult[0]['post_id']; ?>/<?php echo $getPostResult[0]['post_image']; ?>">
                            <?php } 
					...
					<br>
                          <a target="_blank" class="fb-xfbml-parse-ignore" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo HOST_MAIN_URL; ?>Refer%2Fshare-blogs%2F<?php echo $getTitle; ?>%2F<?php echo $getPostKey; ?>" data-layout="button_count" data-size="small" data-mobile-iframe="true"><button class="btn btn-success dim" type="button"><i class="fa fa-facebook"></i></button></a>
                           <a target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo $getPostResult[0]['post_tittle']."...For more info visit : ".HOST_MAIN_URL."Refer/share-blogs/".$getTitle."/".$getPostKey; ?>"  data-size="small"><button class="btn btn-info dim" type="button"><i class="fa fa-twitter"></i></button></a>
						...
						$('.bt-add-com').click(function(){
							...
							$getComment = mysqlSelect("*","home_post_comments","md5(topic_id)='".$_GET['id']."' and topic_type LIKE'%".$getPostResult[0]['post_type']."%'","comment_id desc","","","");
