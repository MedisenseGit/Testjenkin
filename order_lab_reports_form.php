...
if(isset($_POST['cmdLabTest'])){
    ...
    if(!$errorMessage){
        ...
        $arrFields_lab_tests = array();
        $arrValues_lab_tests = array();
        
        $arrFields_lab_tests[] = 'login_id';
        $arrValues_lab_tests[] = $user[0]['login_id'];

        $arrFields_lab_tests[] = 'customer_name';
        $arrValues_lab_tests[] = $patName;
        $arrFields_lab_tests[] = 'customer_mobile';
        $arrValues_lab_tests[] = $patMobile;
        $arrFields_lab_tests[] = 'customer_email';
        $arrValues_lab_tests[] = $patEmail;
        $arrFields_lab_tests[] = 'customer_address';
        $arrValues_lab_tests[] = $patAddress;
        $arrFields_lab_tests[] = 'customer_city';
        $arrValues_lab_tests[] = $patCity;
        $arrFields_lab_tests[] = 'customer_state';
        $arrValues_lab_tests[] = $patState;
        $arrFields_lab_tests[] = 'customer_country';
        $arrValues_lab_tests[] = $patCountry;
        $arrFields_lab_tests[] = 'customer_pincode';
        $arrValues_lab_tests[] = $patPincode;

        $arrFields_lab_tests[] = 'created_date';
        $arrValues_lab_tests[] = $Cur_Date;
        
        if(isset($_POST['addressCheckBox'])){ //if delivery address same as cabove address check box is ticked
            $arrFields_lab_tests[] = 'shipping_address';
            $arrValues_lab_tests[] = $patAddress;
            $arrFields_lab_tests[] = 'shipping_city';
            $arrValues_lab_tests[] = $patCity;
            $arrFields_lab_tests[] = 'shipping_state';
            $arrValues_lab_tests[] = $patState;
            $arrFields_lab_tests[] = 'shipping_country';
            $arrValues_lab_tests[] = $patCountry;
            $arrFields_lab_tests[] = 'shipping_pincode';
            $arrValues_lab_tests[] = $patPincode;
        }else{ // if any of the address selected
            $addressID = $_POST['addressRadio'];
            
            $arrFields_lab_tests[] = 'shipping_address';
            $arrValues_lab_tests[] = $_POST['shipAddress-'.$addressID];
            $arrFields_lab_tests[] = 'shipping_city';
            $arrValues_lab_tests[] = $_POST['shipCity-'.$addressID];
            $arrFields_lab_tests[] = 'shipping_state';
            $arrValues_lab_tests[] = $_POST['ShipState-'.$addressID];
            $arrFields_lab_tests[] = 'shipping_country';
            $arrValues_lab_tests[] = $_POST['shipCountry-'.$addressID];
            $arrFields_lab_tests[] = 'shipping_pincode';
            $arrValues_lab_tests[] = $_POST['shipPincode-'.$addressID];                
        }
        
        $add_lab_tests = $objQuery->mysqlInsert('health_lab_test_request',$arrFields_lab_tests,$arrValues_lab_tests);
        $lab_test_id = mysql_insert_id();
        ...
        if($lab_test_id){
            foreach($_FILES['file-3']['tmp_name'] as $key => $tmp_name ){
                ...
                if(!empty($file_name)){
                    ...
                    $report_attach = $objQuery->mysqlInsert('health_lab_test_request_attachments',$arrFields_attach,$arrValues_attach);
                ...
                ?>
                    <div class="col-lg-12 cutomCss" style="height: 45vh;">
                            ...
                            <span class="sucess">
                                ...
                                ?>
                                            <div class="alert alert-success alert-dismissable">
                                                ...
                                                <strong>Lab Tests Order successfully placed.</strong>
                                            </div>
                                <?php
                                        break;
                                        case '1' :
                        ...
                        <div class="page-title-box">
                            <h2 class="page-title">Lab Tests Order Placed.</h2>
                ...
                <?php }else { ?>
                    <div class="col-lg-12 cutomCss" style=""><br>
                        ...
                        <form enctype="multipart/form-data" method="post" name="formAddReports">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p style="color: red;"><b>Note: All the above fileds are mandotory before you order your Lab Tests</b></p>
                                </div>
                            </div><br>

                            <div class="row" style="margin: 10px;">	
                                <label for="reportFiles" class="control-label requiredStar">Attach Lab Tests ( Allowed file types: jpg, jpeg, png)</label>
            
                                <div class="form-group col-lg-12">
                                    <div class="file-loading">
                                        <input accept=".jpg,.jpeg,.png" id="file-3" name="file-3[]" class="file"  id="reportFiles" type="file" id="attachFile" multiple data-preview-file-type="any" data-upload-url="#" tabindex="7" required />
                                    </div>
                                </div>
                            </div><br>
                            ...
                            <div class="row" style="margin: 10px;">
                                <button type="submit" id="cmdLabTest" name="cmdLabTest" class="btn btn-primary block full-width m-b " style="border-radius: 20px;">Order Lab Tests</button>     
                            </div>
                        </form>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form enctype="multipart/form-data" method="post" name="frmAddMember" action="add_form_details.php">
                                            ...
                                            <input type="hidden" name="labTest" value="labTest">
