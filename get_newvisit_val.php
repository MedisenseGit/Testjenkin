...
ob_start();
	...
	$Fatname = addslashes($_POST['fathername']);
	$Motname = addslashes($_POST['mothername']);
	$Husbname = addslashes($_POST['husbname']);
	...
	$Timestamp = addslashes($_POST['timestamp']);
				...
				$arrFields[] = 'pat_name';
				$arrValues[] = $Patname;
				$arrFields[] = 'Husband_wife_name';
				$arrValues[] = $Husbname;
				$arrFields[] = 'Father_name';
				$arrValues[] = $Fatname;
				$arrFields[] = 'Mother_name';
				$arrValues[] = $Motname;
			...
			$docmail .= $getDocDet[0]['hosp_email4'];
				...
				/*	if(!empty($docmail)){
						...
						$ccmail="medical@medisense.me";
									...
									$url .= "&patContact=".urlencode($Mobno);
					...
					/*if(!empty($docnum)){
					$msg = "Dear Doctor ".$Patname."( Ph: ".$Mobno." )has expressed interest to meet you in person. Please check your mail for more information. Thanks";
					send_msg($docnum,$msg);
					}
