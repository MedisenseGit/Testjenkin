...
$objQuery = new CLSQueryMaker();
	...
	$objQuery->mysqlDelete('doc_patient_treatment_active',"doc_id='".$admin_id."' and doc_type ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_drug_allergy_active',"doc_id='".$admin_id."' and doc_type ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_family_history_active',"doc_id='".$admin_id."' and doc_type ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_drug_active',"doc_id='".$admin_id."' and doc_type ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_examination_active',"doc_id='".$admin_id."' and doc_type ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_symptoms_active',"doc_id='".$admin_id."' and doc_type ='2' and status='1'");

	$objQuery->mysqlDelete('doctor_temp_frequent_medicine',"doc_id='".$admin_id."' and doc_type ='2' and status='1'");

	$objQuery->mysqlDelete('patient_temp_investigation',"doc_id='".$admin_id."' and doc_type ='2' and status='1'");

	$objQuery->mysqlDelete('patient_diagnosis',"doc_id='".$admin_id."' and doc_type ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_lids_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_type ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_lids_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_type ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_conjuctiva_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_conjuctiva_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_sclera_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_sclera_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_cornea_ant_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_cornea_ant_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_cornea_post_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_cornea_post_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_anterior_chamber_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_anterior_chamber_active',"doc_id='".$admin_id."' and doc_type ='2' and	eye_side ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_iris_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_iris_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_pupil_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_pupil_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_angle_active',"doc_id='".$admin_id."' and doc_type ='2'  and eye_side ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_angle_active',"doc_id='".$admin_id."' and doc_type ='2'  and eye_side ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_lens_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_lens_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_viterous_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_viterous_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='2' and status='1'");

	$objQuery->mysqlDelete('doc_patient_fundus_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='1' and status='1'");
	$objQuery->mysqlDelete('doc_patient_fundus_active',"doc_id='".$admin_id."' and doc_type ='2' and eye_side ='2' and status='1'");
	...
	$get_OphthalTrendAnalysisDate1 = $objQuery->mysqlSelect("date_added","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvSphereRE1 = $objQuery->mysqlSelect("DvSphereRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvCylRE1 = $objQuery->mysqlSelect("DvCylRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvAxisRE1 = $objQuery->mysqlSelect("DvAxisRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvSpeherLE1 = $objQuery->mysqlSelect("DvSpeherLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvCylLE1 = $objQuery->mysqlSelect("DvCylLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvAxisLE1 = $objQuery->mysqlSelect("DvAxisLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvSpeherRE1 = $objQuery->mysqlSelect("NvSpeherRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvCylRE1 = $objQuery->mysqlSelect("NvCylRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvAxisRE1 = $objQuery->mysqlSelect("NvAxisRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvSpeherLE1 = $objQuery->mysqlSelect("NvSpeherLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvCylLE1 = $objQuery->mysqlSelect("NvCylLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvAxisLE1 = $objQuery->mysqlSelect("NvAxisLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_IpdRE1 = $objQuery->mysqlSelect("IpdRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_IpdLE1 = $objQuery->mysqlSelect("IpdLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
...
<body class="pace-done mini-navbar">
    ...
    <div id="wrapper">
                                    ...
                                    <div class="input-group">
                                       ...
                                       <input type="text" id="serPatient" placeholder="Enter name or mobile number to search an existing patient or add a new patient" name="search" value="" class="form-control input-lg typeahead_1">
                                        <div class="input-group-btn">
											...
											<a href="?p=0" class="btn btn-lg btn-primary " >
                                                Add New
                                            </a>
                                        </div>
                                    </div>
				...
				<div class="col-md-3 pull-right">
				 ...
				 <img src="../waitingBtn.png" title="Waiting Room" width="120"/>
                        ...
                        <table class="table table-striped">
							...
							$get_app_token_details = $objQuery->mysqlSelect("*","appointment_token_system","doc_id='".$admin_id."' and doc_type='2' and app_date='".$cur_Date."' and status!='Cancelled'","token_no asc","","","");
		...
		<div class="row m-l-lg">
			 <p>
								<?php if($secretary_id!=1) { ?><a class="btn btn-success btn-rounded btn-outline m-l" href="?p=<?php echo $_GET['p']; ?>" id="addvisitDetails"><i class="fa fa-hospital-o"></i> Add Visit Details </a><?php } ?>
                ...
                <div class="col-lg-12 m-b-lg">
                    ...
                    <div id="vertical-timeline" class="vertical-container light-timeline no-margins">
                        ...
                        <div class="vertical-timeline-block" id="add-visit-dtails">
							...
							<tbody>
								...
								<div id="lidsBeforeRE">
								<?php
								//$last_five_lids = $objQuery->mysqlSelect("*","examination_ophthal_lids","(doc_id='".$admin_id."' and doc_type='2' and eye_type='1') or (doc_id='0' and doc_type='0' and eye_type='1')","lids_name ASC","","","");
								$last_five_lids = $objQuery->mysqlSelect("*","examination_ophthal_lids","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","lids_name ASC","","","");
							...
							<td>
								...
								<?php
								//$last_five_lids = $objQuery->mysqlSelect("*","examination_ophthal_lids","(doc_id='".$admin_id."' and doc_type='2' and eye_type='2') or (doc_id='0' and doc_type='0' and eye_type='2')","lids_name ASC","","","");
								if(COUNT($last_five_lids)>0) {
									foreach($last_five_lids as $last_five_lidsList) {
									?>
							...
							<tr>
								...
								<?php
								$get_conjuctiva = $objQuery->mysqlSelect("*","examination_ophthal_conjuctiva","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","conjuctiva_name ASC","","","");
							...
							<tr>
								...
								<div class="col-lg-12" style="background-color:#f8f8f8; border:1px dashed #cecdcb; padding-top:20px; margin-bottom:20px;">
										...
										<?php
										$get_sclera = $objQuery->mysqlSelect("*","examination_ophthal_sclera","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","scelra_name ASC","","","");
							...
							<tr>
								...
								<td>
									...
									<?php
									$get_corneaAnt = $objQuery->mysqlSelect("*","examination_ophthal_cornea_anterior","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","cornea_ant_name ASC","","","");
							...
							<tr>
								...
								<td>
									...
									<?php
									$get_corneaPost = $objQuery->mysqlSelect("*","examination_ophthal_cornea_posterior","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","cornea_post_name ASC","","","");
							...
							<tr>
								...
								<td>
									...
									<?php
									$get_chamber = $objQuery->mysqlSelect("*","examination_ophthal_chamber","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","chamber_name ASC","","","");
							...
							<tr>
								...
								<td>
									...
									<?php
									$get_iris = $objQuery->mysqlSelect("*","examination_ophthal_iris","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","iris_name ASC","","","");
									if(COUNT($get_iris)>0) {
							...
							<tr>
								...
								<td>
									...
									<?php
									$get_pupil = $objQuery->mysqlSelect("*","examination_ophthal_pupil","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","pupil_name ASC","","","");
							...
							<tr>
								...
								<td>
									...
									<?php
									$get_angle = $objQuery->mysqlSelect("*","examination_ophthal_angle","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","angle_name ASC","","","");
							...
							<tr>
								...
								<td>
									...
									<?php
									$get_lens = $objQuery->mysqlSelect("*","examination_ophthal_lens","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","lens_name ASC","","","");
									if(COUNT($get_lens)>0) {
							...
							<tr>
								...
								<td>
									...
									<?php
									$get_viterous = $objQuery->mysqlSelect("*","examination_ophthal_viterous","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","viterous_name ASC","","","");
							...
							<tr>
								...
								<?php
								$get_fundus = $objQuery->mysqlSelect("*","examination_ophthal_fundus","(doc_id='".$admin_id."' and doc_type='2') or (doc_id='0' and doc_type='0')","fundus_name ASC","","","");
								...
								<table cellpadding="2" cellspacing="2" border="1" class="table table-bordered col-lg-12" width="100%">
																			...
																			<tbody>
																			<tr><td>D.V</td>
																			<td><input type="text" class="tagName" name="DvSpeherRE" id="DvSpeherRE"  style="width:150px;"></td>
																			<td><input type="text" class="tagName" name="DvCylRE" id="DvCylRE"  style="width:150px;"></td>
																			<td><input type="text" class="tagName" name="DvAxisRE" id="DvAxisRE"  style="width:150px;"></td>
																			<td><input type="text" class="tagName" name="DvSpeherLE" id="DvSpeherLE"  style="width:150px;"></td>
																			<td><input type="text" class="tagName" name="DvCylLE" id="DvCylLE"  style="width:150px;"></td>
																			<td><input type="text" class="tagName" name="DvAxisLE" id="DvAxisLE"  style="width:150px;"></td>
																			</tr>

																			<tr><td>N.V</td>
																			<td><input type="text" class="tagName" name="NvSpeherRE" id="NvSpeherRE"  style="width:150px;"></td>
																			<td><input type="text" class="tagName" name="NvCylRE" id="NvCylRE"  style="width:150px;"></td>
																			<td><input type="text" class="tagName" name="NvAxisRE" id="NvAxisRE"  style="width:150px;"></td>
																			<td><input type="text" class="tagName" name="NvSpeherLE" id="NvSpeherLE"  style="width:150px;"></td>
																			<td><input type="text" class="tagName" name="NvCylLE" id="NvCylLE"  style="width:150px;"></td>
																			<td><input type="text" class="tagName" name="NvAxisLE" id="NvAxisLE"  style="width:150px;"></td>
																			</tr>

																			<tr><td>IPD</td>
																			<td colspan="3"><input type="text" class="tagName" name="IpdRE" id="IpdRE"  style="width:450px;"></td>
																			<td colspan="3"><input type="text" class="tagName" name="IpdLE" id="IpdLE"  style="width:450px;"></td>
																			</tr>
																			</tbody>
							...
							$edit_spectacal_presc = $objQuery->mysqlSelect("*","examination_opthal_spectacle_prescription","md5(episode_id) = '".$_GET['episode']."' ","","","","");
							...
							<tbody>
								<tr>
									...
									<td style="vertical-align:middle;">
											...
											<?php if($edit_spectacal_presc[0]['distacnce_vision_right']=="6/60"){ ?>
											<option value="6/60" selected>6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24">6/24</option>
											<option value="6/18">6/18</option>
											<option value="6/12">6/12</option>
											<option value="6/9">6/9</option>
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distacnce_vision_right']=="6/36"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36" selected>6/36</option>
											<option value="6/24">6/24</option>
											<option value="6/18">6/18</option>
											<option value="6/12">6/12</option>
											<option value="6/9">6/9</option>
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distacnce_vision_right']=="6/24"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24" selected>6/24</option>
											<option value="6/18">6/18</option>
											<option value="6/12">6/12</option>
											<option value="6/9">6/9</option>
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distacnce_vision_right']=="6/18"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24">6/24</option>
											...
											<option value="6/9">6/9</option>
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distacnce_vision_right']=="6/12"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24">6/24</option>
											<option value="6/18">6/18</option>
											...
											<option value="6/9">6/9</option>
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distacnce_vision_right']=="6/9"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24">6/24</option>
											<option value="6/18">6/18</option>
											...
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distacnce_vision_right']=="6/6"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24">6/24</option>
											<option value="6/18">6/18</option>
									...
									<td style="vertical-align:middle;">
											...
											<?php if($edit_spectacal_presc[0]['distance_vision_left']=="6/60"){ ?>
											<option value="6/60" selected>6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24">6/24</option>
											<option value="6/18">6/18</option>
											...
											<option value="6/9">6/9</option>
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distance_vision_left']=="6/36"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36" selected>6/36</option>
											<option value="6/24">6/24</option>
											<option value="6/18">6/18</option>
											...
											<option value="6/9">6/9</option>
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distance_vision_left']=="6/24"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24" selected>6/24</option>
											<option value="6/18">6/18</option>
											...
											<option value="6/9">6/9</option>
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distance_vision_left']=="6/18"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24">6/24</option>
											<option value="6/18" selected>6/18</option>
											...
											<option value="6/9">6/9</option>
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distance_vision_left']=="6/12"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24">6/24</option>
											<option value="6/18">6/18</option>
											...
											<option value="6/9">6/9</option>
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distance_vision_left']=="6/9"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24">6/24</option>
											<option value="6/18">6/18</option>
											...
											<option value="6/9" selected>6/9</option>
											<option value="6/6">6/6</option>
											<?php } else if($edit_spectacal_presc[0]['distance_vision_left']=="6/6"){ ?>
											<option value="6/60">6/60</option>
											<option value="6/36">6/36</option>
											<option value="6/24">6/24</option>
											<option value="6/18">6/18</option>
								...
								<tr>
									...
									<select class="form-control" name="slctNearVisionRE" id="slctNearVisionRE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" style="width:200px;">
										<?php if($edit_spectacal_presc[0]['near_vision_right']=="N. 36"){ ?>
											<option value="N. 36" selected>N. 36</option>
											<option value="N. 18">N. 18</option>
											<option value="N. 12">N. 12</option>
											<option value="N. 10">N. 10</option>
											<option value="N. 8">N. 8</option>
											<option value="N. 6">N. 6</option>
										<?php } else if($edit_spectacal_presc[0]['near_vision_right']=="N. 18"){ ?>
											<option value="N. 36">N. 36</option>
											<option value="N. 18" selected>N. 18</option>
											<option value="N. 12">N. 12</option>
											<option value="N. 10">N. 10</option>
											<option value="N. 8">N. 8</option>
											<option value="N. 6">N. 6</option>
										<?php } else if($edit_spectacal_presc[0]['near_vision_right']=="N. 12"){ ?>
											<option value="N. 36">N. 36</option>
											<option value="N. 18">N. 18</option>
											<option value="N. 12" selected>N. 12</option>
											<option value="N. 10">N. 10</option>
											<option value="N. 8">N. 8</option>
											<option value="N. 6">N. 6</option>
										<?php } else if($edit_spectacal_presc[0]['near_vision_right']=="N. 10"){ ?>
											<option value="N. 36">N. 36</option>
											<option value="N. 18">N. 18</option>
											<option value="N. 12">N. 12</option>
											<option value="N. 10" selected>N. 10</option>
											<option value="N. 8">N. 8</option>
											<option value="N. 6">N. 6</option>
										<?php } else if($edit_spectacal_presc[0]['near_vision_right']=="N. 8"){ ?>
											<option value="N. 36">N. 36</option>
											<option value="N. 18">N. 18</option>
											<option value="N. 12">N. 12</option>
											<option value="N. 10">N. 10</option>
											<option value="N. 8" selected>N. 8</option>
											<option value="N. 6">N. 6</option>
										<?php }else if($edit_spectacal_presc[0]['near_vision_right']=="N. 6"){ ?>
											<option value="N. 36">N. 36</option>
											<option value="N. 18">N. 18</option>
											<option value="N. 12">N. 12</option>
											<option value="N. 10">N. 10</option>
											<option value="N. 8">N. 8</option>
											<option value="N. 6" selected>N. 6</option>
										<?php } else { ?>
											<option value="">Select</option>
											<option value="N. 36">N. 36</option>
											<option value="N. 18">N. 18</option>
									...
									<select class="form-control" name="slctNearVisionLE" id="slctNearVisionLE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" style="width:200px;">
											<?php if($edit_spectacal_presc[0]['near_vision_left']=="N. 36"){ ?>
											<option value="N. 36" selected>N. 36</option>
											<option value="N. 18">N. 18</option>
											<option value="N. 12">N. 12</option>
											<option value="N. 10">N. 10</option>
											<option value="N. 8">N. 8</option>
											<option value="N. 6">N. 6</option>
										<?php } else if($edit_spectacal_presc[0]['near_vision_left']=="N. 18"){ ?>
											<option value="N. 36">N. 36</option>
											<option value="N. 18" selected>N. 18</option>
											<option value="N. 12">N. 12</option>
											<option value="N. 10">N. 10</option>
											<option value="N. 8">N. 8</option>
											<option value="N. 6">N. 6</option>
										<?php } else if($edit_spectacal_presc[0]['near_vision_left']=="N. 12"){ ?>
											<option value="N. 36">N. 36</option>
											<option value="N. 18">N. 18</option>
											<option value="N. 12" selected>N. 12</option>
											<option value="N. 10">N. 10</option>
											<option value="N. 8">N. 8</option>
											<option value="N. 6">N. 6</option>
										<?php } else if($edit_spectacal_presc[0]['near_vision_left']=="N. 10"){ ?>
											<option value="N. 36">N. 36</option>
											<option value="N. 18">N. 18</option>
											<option value="N. 12">N. 12</option>
											<option value="N. 10" selected>N. 10</option>
											<option value="N. 8">N. 8</option>
											<option value="N. 6">N. 6</option>
										<?php } else if($edit_spectacal_presc[0]['near_vision_left']=="N. 8"){ ?>
											<option value="N. 36">N. 36</option>
											<option value="N. 18">N. 18</option>
											<option value="N. 12">N. 12</option>
											<option value="N. 10">N. 10</option>
											<option value="N. 8" selected>N. 8</option>
											<option value="N. 6">N. 6</option>
										<?php } else if($edit_spectacal_presc[0]['near_vision_left']=="N. 6"){ ?>
											<option value="N. 36">N. 36</option>
											<option value="N. 18">N. 18</option>
											<option value="N. 12">N. 12</option>
											<option value="N. 10">N. 10</option>
								...
								if(COUNT($last_five_lids)>0) {
									...
									foreach($last_five_lids as $last_five_lidsList) {
										$active_lids_RE = $objQuery->mysqlSelect("*","doc_patient_lids_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and lids='".$last_five_lidsList['lids_id']."' and md5(patient_id)='".$_GET['p']."' and eye_type='1'","","","","");
							...
							<td>
								...
								if(COUNT($last_five_lids)>0) {
									foreach($last_five_lids as $last_five_lidsList) {
										$active_lids_LE = $objQuery->mysqlSelect("*","doc_patient_lids_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and lids='".$last_five_lidsList['lids_id']."' and md5(patient_id)='".$_GET['p']."' and eye_type='2'","","","","");
							...
							<tr>
								...
								if(COUNT($get_conjuctiva)>0) {
									foreach($get_conjuctiva as $get_conjuctivaList) {
										$active_conjuctiva_RE = $objQuery->mysqlSelect("*","doc_patient_conjuctiva_active","md5(episode_id)='".$_GET['episode']."' and  doc_id='".$admin_id."' and doc_type='2' and status='0' and conjuctiva='".$get_conjuctivaList['conjuctiva_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='1'","","","","");
								...
								if(COUNT($get_conjuctiva)>0) {
									foreach($get_conjuctiva as $get_conjuctivaList) {
										$active_conjuctiva_LE = $objQuery->mysqlSelect("*"," doc_patient_conjuctiva_active","md5(episode_id)='".$_GET['episode']."' and  doc_id='".$admin_id."' and doc_type='2' and status='0' and conjuctiva='".$get_conjuctivaList['conjuctiva_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='2'","","","","");
							...
							<tr>
								...
								<div class="col-lg-12" style="background-color:#f8f8f8; border:1px dashed #cecdcb; padding-top:20px; margin-bottom:20px;">
										...
										if(COUNT($get_sclera)>0) {
											foreach($get_sclera as $get_scleraList) {
												$active_sclera_RE = $objQuery->mysqlSelect("*","doc_patient_sclera_active","md5(episode_id)='".$_GET['episode']."' and  doc_id='".$admin_id."' and doc_type='2' and status='0' and sclera='".$get_scleraList['sclera_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='1'","","","","");
								...
								if(COUNT($get_sclera)>0) {
									foreach($get_sclera as $get_scleraList) {
										$active_sclera_LE = $objQuery->mysqlSelect("*","doc_patient_sclera_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and sclera='".$get_scleraList['sclera_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='2'","","","","");
							...
							<tr>
								...
								<td>
									...
									if(COUNT($get_corneaAnt)>0) {
										foreach($get_corneaAnt as $get_corneaAntList) {
											$active_cornea_RE = $objQuery->mysqlSelect("*","doc_patient_cornea_ant_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and cornea_ant='".$get_corneaAntList['cornea_ant_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='1'","","","","");
								...
								<td>
									...
									if(COUNT($get_corneaAnt)>0) {
										foreach($get_corneaAnt as $get_corneaAntList) {
											$active_cornea_LE = $objQuery->mysqlSelect("*","doc_patient_cornea_ant_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and cornea_ant='".$get_corneaAntList['cornea_ant_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='2'","","","","");
							...
							<tr>
								...
								<td>
									...
									if(COUNT($get_corneaPost)>0) {
										foreach($get_corneaPost as $get_corneaPostList) {
											$active_corneaPost_RE = $objQuery->mysqlSelect("*","doc_patient_cornea_post_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and cornea_post='".$get_corneaPostList['cornea_post_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='1'","","","","");
								...
								<td>
									...
									if(COUNT($get_corneaPost)>0) {
										foreach($get_corneaPost as $get_corneaPostList) {
											$active_corneaPost_LE = $objQuery->mysqlSelect("*","doc_patient_cornea_post_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and cornea_post='".$get_corneaPostList['cornea_post_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='2'","","","","");
							...
							<tr>
								...
								<td>
									...
									if(COUNT($get_chamber)>0) {
										foreach($get_chamber as $get_chamberList) {
											$active_chamber_RE = $objQuery->mysqlSelect("*","doc_patient_anterior_chamber_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and chamber='".$get_chamberList['chamber_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='1'","","","","");
								...
								<td>
									...
									if(COUNT($get_chamber)>0) {
										foreach($get_chamber as $get_chamberList) {
											$active_chamber_LE = $objQuery->mysqlSelect("*","doc_patient_anterior_chamber_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and chamber='".$get_chamberList['chamber_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='2'","","","","");
							...
							<tr>
								...
								<td>
									...
									if(COUNT($get_iris)>0) {
										foreach($get_iris as $get_irisList) {
											$active_iris_RE = $objQuery->mysqlSelect("*","doc_patient_iris_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and iris='".$get_irisList['iris_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='1'","","","","");
								...
								<td>
									...
									if(COUNT($get_iris)>0) {
										foreach($get_iris as $get_irisList) {
											$active_iris_LE = $objQuery->mysqlSelect("*","doc_patient_iris_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and iris='".$get_irisList['iris_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='2'","","","","");
							...
							<tr>
								...
								<td>
									...
									if(COUNT($get_pupil)>0) {
										foreach($get_pupil as $get_pupilList) {
											$active_pupil_RE = $objQuery->mysqlSelect("*","doc_patient_pupil_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and pupil='".$get_pupilList['pupil_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='1'","","","","");
								...
								<td>
									...
									if(COUNT($get_pupil)>0) {
										foreach($get_pupil as $get_pupilList) {
											$active_pupil_LE = $objQuery->mysqlSelect("*","doc_patient_pupil_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and pupil='".$get_pupilList['pupil_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='2'","","","","");
							...
							<tr>
								...
								<td>
									...
									if(COUNT($get_angle)>0) {
										foreach($get_angle as $get_angleList) {
											$active_angle_RE = $objQuery->mysqlSelect("*","doc_patient_angle_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and angle='".$get_angleList['angle_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='1'","","","","");
								...
								<td>
									...
									if(COUNT($get_angle)>0) {
										foreach($get_angle as $get_angleList) {
											$active_angle_LE = $objQuery->mysqlSelect("*","doc_patient_angle_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and angle='".$get_angleList['angle_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='2'","","","","");
							...
							<tr>
								...
								<td>
									...
									if(COUNT($get_lens)>0) {
										foreach($get_lens as $get_lensList) {
											$active_lens_RE = $objQuery->mysqlSelect("*","doc_patient_lens_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and lens='".$get_lensList['lens_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='1'","","","","");
								...
								<td>
									...
									if(COUNT($get_lens)>0) {
										foreach($get_lens as $get_lensList) {
											$active_lens_LE = $objQuery->mysqlSelect("*","doc_patient_lens_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and lens='".$get_lensList['lens_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='2'","","","","");
							...
							<tr>
								...
								<td>
									...
									if(COUNT($get_viterous)>0) {
										foreach($get_viterous as $get_viterousList) {
											$active_viterous_RE = $objQuery->mysqlSelect("*","doc_patient_viterous_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and viterous='".$get_viterousList['viterous_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='1'","","","","");
								...
								<td>
									...
									if(COUNT($get_viterous)>0) {
										foreach($get_viterous as $get_viterousList) {
											$active_viterous_LE = $objQuery->mysqlSelect("*","doc_patient_viterous_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and viterous='".$get_viterousList['viterous_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='2'","","","","");
							...
							<tr>
								...
								if(COUNT($get_fundus)>0) {
									foreach($get_fundus as $get_fundusList) {
										$active_fundus_RE = $objQuery->mysqlSelect("*","doc_patient_fundus_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and fundus='".$get_fundusList['fundus_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='1'","","","","");
								...
								<td>
									...
									if(COUNT($get_fundus)>0) {
										foreach($get_fundus as $get_fundusList) {
											$active_fundus_LE = $objQuery->mysqlSelect("*","doc_patient_fundus_active","md5(episode_id)='".$_GET['episode']."' and doc_id='".$admin_id."' and doc_type='2' and status='0' and fundus='".$get_fundusList['fundus_id']."' and md5(patient_id)='".$_GET['p']."' and eye_side='2'","","","","");
									...
									<input type="number" step="1" style="margin-left: 100px;
																margin-top: 50px;
																 width: 60px; text-align:center;" name="se_refractionRE_value1" id="se_refractionRE_value1" placeholder="Add " data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['refraction_right_value1'];  ?>" data-patient-id="<?php echo $patient_id; ?>" id="get_refractionRE" value="" class="searchRefractionRE" tabindex="1" />
									  ...
									  <input type="number" step="1" style="margin-top: 0px;
																margin-left: 300px;
																width: 60px;text-align:center;" name="se_refractionRE_value2" id="se_refractionRE_value2" placeholder="Add " data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['refraction_right_value2'];  ?>" data-patient-id="<?php echo $patient_id; ?>" id="get_refractionRE"  value="" class="searchRefractionRE" tabindex="1" />
									...
									<input type="number" step="1" style="margin-left: 100px;
																margin-top: 50px;
																 width: 60px; text-align:center;" name="se_refractionLE_value1" id="se_refractionLE_value1" placeholder="Add " data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['refraction_left_value1'];  ?>" data-patient-id="<?php echo $patient_id; ?>" id="get_refractionRE"  value="" class="searchRefractionRE" tabindex="1" />
									  ...
									  <input type="number" step="1" style="margin-top: 0px;
																margin-left: 300px;
																width: 60px;text-align:center;" name="se_refractionLE_value2" id="se_refractionLE_value2" placeholder="Add " data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['refraction_left_value2'];  ?>" data-patient-id="<?php echo $patient_id; ?>" id="get_refractionRE"  value="" class="searchRefractionRE" tabindex="1" />
								...
								<table cellpadding="2" cellspacing="2" border="1" class="table table-bordered col-lg-12" width="100%">
																			...
																			<tbody>
																			<tr><td>D.V</td>
																			<td><input type="text" class="tagName Spectacle" name="DvSpeherRE" id="DvSpeherRE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['dvSphereRE'];  ?>"  style="width:150px;"></td>
																			<td><input type="text" class="tagName Spectacle" name="DvCylRE" id="DvCylRE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['DvCylRE'];  ?>" style="width:150px;"></td>
																			<td><input type="text" class="tagName Spectacle" name="DvAxisRE" id="DvAxisRE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['DvAxisRE'];  ?>" style="width:150px;"></td>
																			<td><input type="text" class="tagName Spectacle" name="DvSpeherLE" id="DvSpeherLE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['DvSpeherLE'];  ?>" style="width:150px;"></td>
																			<td><input type="text" class="tagName Spectacle" name="DvCylLE" id="DvCylLE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['DvCylLE'];  ?>" style="width:150px;"></td>
																			<td><input type="text" class="tagName Spectacle" name="DvAxisLE" id="DvAxisLE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['DvAxisLE'];  ?>" style="width:150px;"></td>
																			</tr>

																			<tr><td>N.V</td>
																			<td><input type="text" class="tagName Spectacle" name="NvSpeherRE" id="NvSpeherRE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['NvSpeherRE'];  ?>" style="width:150px;"></td>
																			<td><input type="text" class="tagName Spectacle" name="NvCylRE" id="NvCylRE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['NvCylRE'];  ?>" style="width:150px;"></td>
																			<td><input type="text" class="tagName Spectacle" name="NvAxisRE" id="NvAxisRE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['NvAxisRE'];  ?>"  style="width:150px;"></td>
																			<td><input type="text" class="tagName Spectacle" name="NvSpeherLE" id="NvSpeherLE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['NvSpeherLE'];  ?>"  style="width:150px;"></td>
																			<td><input type="text" class="tagName Spectacle" name="NvCylLE" id="NvCylLE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['NvCylLE'];  ?>"  style="width:150px;"></td>
																			<td><input type="text" class="tagName Spectacle" name="NvAxisLE" id="NvAxisLE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['NvAxisLE'];  ?>" style="width:150px;"></td>
																			</tr>

																			<tr><td>IPD</td>
																			<td colspan="3"><input type="text" class="tagName Spectacle" name="IpdRE" id="IpdRE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['IpdRE'];  ?>"  style="width:450px;"></td>
																			<td colspan="3"><input type="text" class="tagName Spectacle" name="IpdLE" id="IpdLE" data-spectacle-id="<?php echo $edit_spectacal_presc[0]['spectacle_id']; ?>" value="<?php echo $edit_spectacal_presc[0]['IpdLE'];  ?>"  style="width:450px;"></td>
																			</tr>
																			</tbody>
					...
					<div class="vertical-timeline-block" id="medical-history">
							...
							<h2>Medical History</h2>
								...
								<div class="input-group">
								<?php
									$getAllergyRes= $objQuery->mysqlSelect("*","doc_patient_drug_allergy_active","patient_id='".$patient_id."' and doc_id ='".$admin_id."' and doc_type='2' and status='0'","","","","");
								...
								<h4>Drug Abuse</h4>
								<div class="input-group">
								<?php $last_five_drugs = $objQuery->mysqlSelect("drug_abuse_id","doctor_frequent_drug_abuse","doc_id='".$admin_id."' and doc_type='2'","freq_count DESC","","","5");
								...
								<div class="input-group">
								<?php
									$getDrugRes= $objQuery->mysqlSelect("b.drug_abuse as drug_abuse,a.drug_active_id as drug_active_id","doc_patient_drug_active","a.doc_id='".$admin_id."' and a.patient_id='".$patient_id."' and a.doc_type='2' and a.status='0'","","","","");
									if(!empty($getDrugRes)){
								...
								<div class="input-group">
								<?php $last_five_history = $objQuery->mysqlSelect("family_history_id","doctor_frequent_family_history","doc_id='".$admin_id."' and doc_type='2'","freq_count DESC","","","5");
						...
						<div class="vertical-timeline-block" id="visit-details">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny table-responsive">
								...
								?>
                                <tr>
                                    <td>#Visit <?php echo $visit_count." - ".$patient_episode_val['formated_date_time']; ?> <a href="print-emr/?pid=<?php echo md5($patient_tab[0]['patient_id']);?>&episode=<?php echo md5($patient_episode_val['episode_id']); ?>" target="_blank" class="btn btn-white btn-bitbucket pull-right"><i class="fa fa-print"></i> Print</a>
									...
									$get_exam_lids = $objQuery->mysqlSelect("b.lids_name as lids_name,a.lids as lids","doc_patient_lids_active as a left join examination_ophthal_lids as b on a.lids=b.lids_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_type='1'","","","","");
									$get_exam_lidsLE = $objQuery->mysqlSelect("b.lids_name as lids_name,a.lids as lids","doc_patient_lids_active as a left join examination_ophthal_lids as b on a.lids=b.lids_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_type='2'","","","","");

									$get_exam_conjuctivaRE = $objQuery->mysqlSelect("b.conjuctiva_name as conjuctiva_name,a.conjuctiva as conjuctiva","doc_patient_conjuctiva_active as a left join examination_ophthal_conjuctiva as b on a.conjuctiva=b.conjuctiva_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='1'","","","","");
									$get_exam_conjuctivaLE = $objQuery->mysqlSelect("b.conjuctiva_name as conjuctiva_name,a.conjuctiva as conjuctiva","doc_patient_conjuctiva_active as a left join examination_ophthal_conjuctiva as b on a.conjuctiva=b.conjuctiva_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='2'","","","","");

									$get_exam_scleraRE = $objQuery->mysqlSelect("b.scelra_name as scelra_name,a.sclera as sclera","doc_patient_sclera_active as a left join examination_ophthal_sclera as b on a.sclera=b.sclera_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='1'","","","","");
									$get_exam_scleraLE = $objQuery->mysqlSelect("b.scelra_name as scelra_name,a.sclera as sclera","doc_patient_sclera_active as a left join examination_ophthal_sclera as b on a.sclera=b.sclera_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='2'","","","","");

									$get_exam_cornea_anteriorRE = $objQuery->mysqlSelect("b.cornea_ant_name as cornea_ant_name,a.cornea_ant as cornea_ant","doc_patient_cornea_ant_active as a left join examination_ophthal_cornea_anterior as b on a.cornea_ant=b.cornea_ant_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='1'","","","","");
									$get_exam_cornea_anteriorLE = $objQuery->mysqlSelect("b.cornea_ant_name as cornea_ant_name,a.cornea_ant as cornea_ant","doc_patient_cornea_ant_active as a left join examination_ophthal_cornea_anterior as b on a.cornea_ant=b.cornea_ant_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='2'","","","","");

									$get_exam_cornea_posteriorRE = $objQuery->mysqlSelect("b.cornea_post_name as cornea_post_name,a.cornea_post as cornea_post","doc_patient_cornea_post_active as a left join examination_ophthal_cornea_posterior as b on a.cornea_post=b.cornea_post_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='1'","","","","");
									$get_exam_cornea_posteriorLE = $objQuery->mysqlSelect("b.cornea_post_name as cornea_post_name,a.cornea_post as cornea_post","doc_patient_cornea_post_active as a left join examination_ophthal_cornea_posterior as b on a.cornea_post=b.cornea_post_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='2'","","","","");

									$get_exam_anterior_chamberRE = $objQuery->mysqlSelect("b.chamber_name as chamber_name,a.chamber as chamber","doc_patient_anterior_chamber_active as a left join examination_ophthal_chamber as b on a.chamber=b.chamber_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='1'","","","","");
									$get_exam_anterior_chamberLE = $objQuery->mysqlSelect("b.chamber_name as chamber_name,a.chamber as chamber","doc_patient_anterior_chamber_active as a left join examination_ophthal_chamber as b on a.chamber=b.chamber_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='2'","","","","");


									$get_exam_anterior_irisRE = $objQuery->mysqlSelect("b.iris_name as iris_name,a.iris as iris","doc_patient_iris_active as a left join examination_ophthal_iris as b on a.iris=b.iris_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='1'","","","","");
									$get_exam_anterior_irisLE = $objQuery->mysqlSelect("b.iris_name as iris_name,a.iris as iris","doc_patient_iris_active as a left join examination_ophthal_iris as b on a.iris=b.iris_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='2'","","","","");

									$get_exam_pupil_RE = $objQuery->mysqlSelect("b.pupil_name as pupil_name,a.pupil as pupil","doc_patient_pupil_active as a left join examination_ophthal_pupil as b on a.pupil=b.pupil_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='1'","","","","");
									$get_exam_pupil_LE = $objQuery->mysqlSelect("b.pupil_name as pupil_name,a.pupil as pupil","doc_patient_pupil_active as a left join examination_ophthal_pupil as b on a.pupil=b.pupil_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='2'","","","","");

									$get_exam_angle_RE = $objQuery->mysqlSelect("b.angle_name as angle_name,a.angle as angle","doc_patient_angle_active as a left join examination_ophthal_angle as b on a.angle=b.angle_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='1'","","","","");
									$get_exam_angle_LE = $objQuery->mysqlSelect("b.angle_name as angle_name,a.angle as angle","doc_patient_angle_active as a left join examination_ophthal_angle as b on a.angle=b.angle_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='2'","","","","");

									$get_exam_lens_RE = $objQuery->mysqlSelect("b.lens_name as lens_name,a.lens as lens","doc_patient_lens_active as a left join examination_ophthal_lens as b on a.lens=b.lens_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='1'","","","","");
									$get_exam_lens_LE = $objQuery->mysqlSelect("b.lens_name as lens_name,a.lens as lens","doc_patient_lens_active as a left join examination_ophthal_lens as b on a.lens=b.lens_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='2'","","","","");

									$get_exam_viterous_RE = $objQuery->mysqlSelect("b.viterous_name as viterous_name,a.viterous as viterous","doc_patient_viterous_active as a left join examination_ophthal_viterous as b on a.viterous=b.viterous_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='1'","","","","");
									$get_exam_viterous_LE = $objQuery->mysqlSelect("b.viterous_name as viterous_name,a.viterous as viterous","doc_patient_viterous_active as a left join examination_ophthal_viterous as b on a.viterous=b.viterous_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='2'","","","","");

									$get_exam_fundus_RE = $objQuery->mysqlSelect("b.fundus_name as fundus_name,a.fundus as fundus","doc_patient_fundus_active as a left join examination_ophthal_fundus as b on a.fundus=b.fundus_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='1'","","","","");
									$get_exam_fundus_LE = $objQuery->mysqlSelect("b.fundus_name as fundus_name,a.fundus as fundus","doc_patient_fundus_active as a left join examination_ophthal_fundus as b on a.fundus=b.fundus_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.eye_side='2'","","","","");

									$get_exam_refraction = $objQuery->mysqlSelect("*","examination_opthal_spectacle_prescription","episode_id = '".$patient_episode_val['episode_id']."' and doc_id = '".$admin_id."' and doc_type = '2'","","","","");
								...
								<input type="number" step="1" style="margin-left: 100px;
									...
									<td>
									<?php $get_invest = $objQuery->mysqlSelect("*","patient_temp_investigation","patient_id = '". $patient_tab[0]['patient_id'] ."' and episode_id='". $patient_episode_val['episode_id']."'","","","","");
									if(!empty($get_invest))
									{
									?>
                                ...
                                <div class="modal-content animated bounceInRight">
									...
									<?php
									$get_exam_spectacle = $objQuery->mysqlSelect("*","examination_opthal_spectacle_prescription","episode_id = '".$patient_episode_val['episode_id']."' and doc_id = '".$admin_id."' and doc_type = '2'","","","","");
                                ...
                                <div class="modal-content animated bounceInRight">
										...
										<div class="form-group col-md-9">
														...
														<select data-placeholder="Refer to Opticles" class="chosen-select diagnoCenter" name="selectOpticleCenter" id="selectOpticleCenter" data-patient-id="<?php echo $patient_tab[0]['patient_id']; ?>" data-episode-id="<?php echo $patient_episode_val['episode_id']; ?>" tabindex="3">
															<option value=""></option>
															<?php $getOpticles= $objQuery->mysqlSelect("*","Opticle_center as a left join doc_opticles as b on a.opticale_id=b.opticale_id","b.doc_id='".$admin_id."'","b.doc_opticle_id desc","","","");
       ...
       <?php include_once('footer.php'); ?>
		...
		<!--<div class="small-chat-box fadeInRight animated">
			...
			<div class="content">
			<?php $allRecord = $objQuery->mysqlSelect("patient_id,patient_name,patient_email,patient_mob,patient_loc,TImestamp","doc_my_patient","doc_id='".$admin_id."'","patient_id desc","","","5");
...
<?php
	...
	$get_OphthalTrendAnalysisDate = $objQuery->mysqlSelect("date_added","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvSphereRE = $objQuery->mysqlSelect("DvSphereRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvCylRE = $objQuery->mysqlSelect("DvCylRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvAxisRE = $objQuery->mysqlSelect("DvAxisRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvSpeherLE = $objQuery->mysqlSelect("DvSpeherLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvCylLE = $objQuery->mysqlSelect("DvCylLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_DvAxisLE = $objQuery->mysqlSelect("DvAxisLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvSpeherRE = $objQuery->mysqlSelect("NvSpeherRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvCylRE = $objQuery->mysqlSelect("NvCylRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvAxisRE = $objQuery->mysqlSelect("NvAxisRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvSpeherLE = $objQuery->mysqlSelect("NvSpeherLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvCylLE = $objQuery->mysqlSelect("NvCylLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_NvAxisLE = $objQuery->mysqlSelect("NvAxisLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_IpdRE = $objQuery->mysqlSelect("IpdRE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
	$get_IpdLE = $objQuery->mysqlSelect("IpdLE","trend_analysis_ophthal","patient_id='".$patient_id."'","trend_id asc","","","0,5");
