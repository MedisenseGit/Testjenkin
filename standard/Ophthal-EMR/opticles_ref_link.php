...
$checkPatient= $objQuery->mysqlSelect("*","doc_my_patient","md5(patient_id)='".$_GET['d']."'","","","","");
$getReferredDetails= $objQuery->mysqlSelect("*","diagnostic_referrals","md5(patient_id)='".$_GET['d']."'","referred_date desc","","","");

$getEpisode= $objQuery->mysqlSelect("*","doc_patient_episodes","md5(episode_id)='".$_GET['e']."'","","","","");
            ...
            <div class="row">
                ...
                <div class="col-md-4">
				 ...
				 <div class="col-md-12">
				   <div class="ibox-content p-md">
				 <?php
				 	$doc_patient_spectacle_prescriptions = $objQuery->mysqlSelect("*","examination_opthal_spectacle_prescription","episode_id = '". $getEpisode[0]['episode_id'] ."' ","","","","");
