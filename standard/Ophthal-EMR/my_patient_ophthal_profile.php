                    ...
                    <div id="vertical-timeline" class="vertical-container light-timeline no-margins">
                        ...
                        <div class="vertical-timeline-block" id="add-visit-dtails">
							...
							<input type="hidden" name="patient_name" value="<?php echo $patient_tab[0]['patient_name']; ?>">
								...
								<div class="input-group">
								<?php $last_five_complaints = $objQuery->mysqlSelect("symptoms_id","doctor_frequent_symptoms","doc_id='".$admin_id."' and doc_type='2'","freq_count asc","","","5");
								...
								<h4>Examination</h4>
								<div class="input-group">
								<?php $last_five_examination = $objQuery->mysqlSelect("b.examination_id as examination_id,b.examination as examination","doctor_frequent_examination as a left join examination as b on a.examination_id=b.examination_id","a.doc_id='".$admin_id."' and a.doc_type='2'","a.freq_count DESC","","","5");
							...
							<tr>
								...
								<div class="input-group">
								<?php $last_five_tests = $objQuery->mysqlSelect("a.main_test_id as main_test_id,b.test_name_site_name as test_name_site_name","doctor_frequent_investigations as a left join patient_diagnosis_tests as b on a.main_test_id=b.id","a.doc_id='".$admin_id."' and a.doc_type='2'","a.freq_test_count DESC","","","8");
								...
								<h4>Treatment</h4>
								<div class="input-group">
								<?php $last_five_treatment = $objQuery->mysqlSelect("*","doctor_frequent_treatment","doc_id='".$admin_id."' and doc_type='2'","freq_count DESC","","","5");
