                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div>
							...
							<?php if(!empty($getDocInfo[0]['doc_photo'])){ ?>
                                <img alt="image" class="img-xlg img-responsive" src="https://medisensecrm.com/Doc/<?php echo $getDocInfo[0]['ref_id']; ?>/<?php echo $getDocInfo[0]['doc_photo']; ?>">
                             <?php }  else { ?>
                            ...
                            <div class="ibox-content profile-content">
                                ...
                                <p><b>Experience:</b> <?php echo $getDocInfo[0]['ref_exp']; ?> Yrs<br>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="tab-content">
						   ...
						   <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left"  action="add_patient_details.php"  name="frmAddPatient" id="frmAddPatient">
								...
								<div class="form-group"><label class="col-sm-2 control-label">Medical Reports <span class="required">*</span></label>
                                    ...
                                    <div class="col-sm-10">
                                       <!--  <input type="file" id="inputImage" name="file-3[]" required="required" multiple="true" class="hide">  -->
									    <input type="file" id="file-3" name="file-3[]" value="" class="form-control" />
								...
								<button type="submit" name="refer_patient" id="refer_patient" class="btn btn-primary block full-width m-b ">SEND CASE </button>
								</div>
								</div>
							</form>
                            ...
                            <div id="tab-2" class="tab-pane">
								...
								<input type="hidden" name="selectref" value="<?php echo $getDocInfo[0]['ref_id'];?>" />
								<input type="hidden" name="doc_spec" value="<?php echo $getDocInfo[0]['doc_spec'];?>" />
								<input type="hidden" name="se_doc_name" value="<?php echo $getDocInfo[0]['ref_name'];?>" />
								<div class="form-group">
									<label class="col-sm-2 control-label">Preferred Date <span class="required">*</span></label>

                                   <div class="col-sm-4"><select data-placeholder="Choose Preferred Date..." class="chosen-select" name="check_date" id="check_date" required="required" onchange="return getDocTiming(this.value);" tabindex="2">
									...
									$chkdate=date('D', $date);
									$getDocDays= $objQuery->mysqlSelect("DISTINCT(b.day_id) as DayId","doc_time_set as a left join seven_days as b on a.day_id=b.day_id","a.doc_id='".$getDocInfo[0]['ref_id']."'","","","","");
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-4"><input type="text"  name="se_pat_name" id="se_pat_name" required="required" class="form-control"></div>
                                
									<label class="col-sm-2 control-label">Age </label>

                                    <div class="col-sm-4"><input type="text" name="se_pat_age" id="se_pat_age" class="form-control"></div>
                                </div>
								<div class="form-group">
								<label class="col-sm-2 control-label">Gender <span class="required">*</span></label>
                                      <div class="col-sm-10">  <div class="radio radio-info radio-inline">
								...
								<div class="form-group"><label class="col-sm-2 control-label">Mobile <span class="required">*</span></label>
                                    ...
                                    <div class="col-sm-4"><input type="text" class="form-control" name="se_phone_no" id="se_phone_no" required="required" placeholder="10 digit mobile no."></div>
									<label class="col-sm-2 control-label">Email</label>

                                    <div class="col-sm-4"><input type="email" name="se_email" id="se_email" class="form-control"></div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">City <span class="required">*</span></label>
                                    ...
                                    <div class="col-sm-10"><input type="text" name="se_city" id="se_city" required="required" class="form-control"></div>
                                </div>
								<div class="form-group"><label class="col-sm-2 control-label">Address <span class="required">*</span></label>

                                    <div class="col-sm-10"><textarea class="form-control" name="se_address" id="se_address" required="required" rows="3"></textarea></div>
                                </div>
								
								<div class="form-group">
								<div class="col-sm-4 pull-right">
								<!-- <button type="submit" name="request_appointment" class="btn btn-primary block full-width m-b ">REQUEST APPOINTMENT</button> -->
								<button type="submit" name="request_appointment" id="request_appointment" class="btn btn-primary block full-width m-b "><i class="fa fa-floppy-o"></i> REQUEST APPOINTMENT</button>
