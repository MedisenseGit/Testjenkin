...
include('functions.php');	
					...
					$blogResult = $objQuery->mysqlSelect("*","blogs_offers_events_listing","listing_type='Blog'","Create_Date desc","","","6,200");
					foreach($blogResult as $postResultList){
						...
						if($postResultList['listing_type']=="Blog"){
							...
							$postimage="../Contributors/Postimages/".$getPostResult[0]['post_id']."/".$getPostResult[0]['post_image'];
							} else {
							$postimage="";
							}
							$url="Blogs";
                    ...
                    <div class="social-feed-box">
                        ...
                        <div class="social-footer">
							...
							$userName=$getUser[0]['ref_name'];
								...
								//Profile Pic
								if(!empty($getUser[0]['doc_photo'])){ 
								$userimg="../Contributors/docProfilePic/".$commentList['login_id']."/".$getUser[0]['doc_photo']; 
								}else{
								$userimg="../assets/img/anonymous-profile.png";
								}
							}	
