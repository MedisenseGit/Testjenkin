...
if(isset($_POST['bookAppointment'])){
	...
	$get_department = $objQuery->mysqlSelect("*","specialization","spec_id='".$getDocDet[0]['doc_spec']."'","","","","");
	...
	//Insert to appointment table
				...
				$arrValues_app1[] = date('Y-m-d',strtotime($_POST['dateadded']));
	...
	//Patient Info EMAIL notification Sent to Doctor
					if(!empty($docmail)){
						...
						$prefDate=date('d-M-Y',strtotime($_POST['dateadded']));
					...
					$msg = "Dear Doctor ".$chkPatDet[0]['patient_name']."( Ph: ".$chkPatDet[0]['patient_mob']." )has expressed interest to meet you in person. Please check your email for more details. Thanks ".$getSource[0]['partner_name'];
