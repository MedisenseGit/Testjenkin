<div class="col-lg-12" style="background-color:#f8f8f8; border:1px dashed #cecdcb; padding-top:20px; margin-bottom:20px;">
								...
								<?php
								$getSymptomActive= $objQuery->mysqlSelect("b.symptoms as symptoms,a.symptoms_id as symptoms_id,b.complaint_id as complaint_id","doc_patient_symptoms_active as a left join chief_medical_complaints as b on a.symptoms=b.complaint_id","a.episode_id='".$edit_patient_episodes[0]['episode_id']."' and a.doc_type='2' and a.status='0'","","","","");
