...
if(isset($_POST['updatePatient'])){
	...
	$updatePat=$objQuery->mysqlUpdate('patient_tab',$arrFields,$arrValues,"patient_id='".$_POST['patient_id']."'");
	$response="update";
...
if(isset($_POST['refer_patient'])){ //TO CHECK AUTHENTICATION OF POST VALUES
	...
	$txtNote1 = addslashes($_POST['se_info']);
	$se_query = addslashes($_POST['se_query']);
	$se_description = addslashes($_POST['se_description']);
	$docid = addslashes($_POST['selectref']);
	$refpartner = addslashes($_POST['selectRefpartner']);
	
	// get Doc SpecID
	$getDocSpecId= $objQuery->mysqlSelect("doc_spec","referal","ref_id='".$docid."'","","","","");
