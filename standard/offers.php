...
$getPostKey=urlencode($getOffersResult[0]['event_key']);
...
if($getOffersResult[0]['event_type']=="1"){
	...
	$checkEventApplied = $objQuery->mysqlSelect("*","job_event_application","applicant_id='".$admin_id."' and job_id='".$getOffersResult[0]['event_id']."'","","","","");
	...
	$post_type="Jobs";
	//To Check Job apllied or not
	$checkJobApplied = $objQuery->mysqlSelect("*","job_event_application","applicant_id='".$admin_id."' and job_id='".$getOffersResult[0]['event_id']."'","","","","");
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
			...
			<?php if($_GET['response']=="job-success"){ ?>
				...
				<?php   //TO CHECK USER TYPE WHETHER HE IS DOCTOR OR NOT
									...
									$getOrg = $objQuery->mysqlSelect("company_name,company_addrs,company_logo","compny_tab","company_id='".$getOffersResult[0]['company_id']."'","","","","");
									$username=$getOrg[0]['company_name'];
									$userprof=$getOrg[0]['company_addrs'];
									//Profile Pic
									if(!empty($getOrg[0]['company_logo'])){
									$userimg="../premium/company_logo/".$getOffersResult[0]['company_id']."/".$getOrg[0]['company_logo']; 
									}else{
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div>
							...
							<?php if(!empty($getOffersResult[0]['photo'])){ ?>
							   <img alt="image" class="img-responsive" src="../premium/Eventimages/<?php echo $getOffersResult[0]['event_id']; ?>/<?php echo $getOffersResult[0]['photo']; ?>">
                            <?php } ?>
							</div>
							...
							<div class="col-md-12">
								...
								<br>
                                  <a target="_blank" class="fb-xfbml-parse-ignore" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fmedisensecrm.com%2FRefer%2Fshare-post%2F<?php echo $getTitle; ?>%2F<?php echo $getPostKey; ?>" data-layout="button_count" data-size="small" data-mobile-iframe="true"><button class="btn btn-success dim" type="button"><i class="fa fa-facebook"></i></button></a>
								   <a target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo $getOffersResult[0]['title']."...For more info visit : https://medisensecrm.com/Refer/share-post/".$getTitle."/".$getPostKey; ?>"  data-size="small"><button class="btn btn-info dim" type="button"><i class="fa fa-twitter"></i></button></a>
					...
					<div class="modal inmodal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
					 ...
					 <?php } 
						...
						$('.bt-add-com').click(function(){
							...
							<?php $getComment = $objQuery->mysqlSelect("*","home_post_comments","topic_id='".$getOffersResult[0]['event_id']."' and topic_type LIKE'%".$post_type."%'","","","","");
