...
$objQuery = new CLSQueryMaker();
	...
	$patient_tab = $objQuery->mysqlSelect("*","doc_my_patient","md5(patient_id)='".$_GET['pid']."'","","","","");
	//print_r($patient_tab);
	if(COUNT($patient_tab)==0){
		...
		//Episode Details
			...
			$patient_episodes = $objQuery->mysqlSelect("episode_id,date_time,admin_id","doc_patient_episodes","patient_id = '". $patient_id ."' and md5(episode_id)='".$_GET['episode']."'","","","","");
			
			$episode_created_date=date('d M Y, H:i a',strtotime($patient_episodes[0]['date_time']));   //Prescription Date
			
			
			$get_medical_complaint = $objQuery->mysqlSelect("b.symptoms as symptoms","doc_patient_symptoms_active as a left join chief_medical_complaints as b on a.symptoms=b.complaint_id","a.episode_id='".$patient_episodes[0]['episode_id']."'","","","","");
				
			$get_diagnosis = $objQuery->mysqlSelect("b.icd_code as icd_code","patient_diagnosis as a left join icd_code as b on a.icd_id=b.icd_id","a.episode_id='".$patient_episodes[0]['episode_id']."'","","","","");
			
			$get_examination = $objQuery->mysqlSelect("b.examination as examination,a.exam_result as exam_result,a.findings as findings","doc_patient_examination_active as a left join examination as b on a.examination=b.examination_id","a.episode_id='".$patient_episodes[0]['episode_id']."'","","","","");
				
			$get_invest = $objQuery->mysqlSelect("*","patient_temp_investigation","patient_id = '". $patient_id ."' and episode_id='". $patient_episodes[0]['episode_id']."'","","","","");
										
		//Doctors Details	
			$get_doc_details = $objQuery->mysqlSelect("ref_name","referal","ref_id='".$patient_episodes[0]['admin_id']."'","","","","");
			$doctor_name = $get_doc_details[0]['ref_name'];  //Doctor Name
			$_SESSION['doc_name'] = $get_doc_details[0]['ref_name'];
		//Doctors Specialization
			$get_doc_spec = $objQuery->mysqlSelect("a.spec_name as specialization, a.spec_group_id as spec_group_id","specialization as a inner join doc_specialization as b on a.spec_id=b.spec_id","b.doc_id='".$patient_episodes[0]['admin_id']."'","a.spec_id ASC","","","");
		...
		$doc_patient_episode_prescriptions = $objQuery->mysqlSelect("*","doc_patient_episode_prescriptions","episode_id = '". $patient_episodes[0]['episode_id'] ."' "," prescription_seq ASC","","","");
		...
		$get_exam_lids = $objQuery->mysqlSelect("b.lids_name as lids_name,a.lids as lids","doc_patient_lids_active as a left join examination_ophthal_lids as b on a.lids=b.lids_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_type='1'","","","","");
		$get_exam_lidsLE = $objQuery->mysqlSelect("b.lids_name as lids_name,a.lids as lids","doc_patient_lids_active as a left join examination_ophthal_lids as b on a.lids=b.lids_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_type='2'","","","","");
									
		$get_exam_conjuctivaRE = $objQuery->mysqlSelect("b.conjuctiva_name as conjuctiva_name,a.conjuctiva as conjuctiva","doc_patient_conjuctiva_active as a left join examination_ophthal_conjuctiva as b on a.conjuctiva=b.conjuctiva_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1'","","","","");
		$get_exam_conjuctivaLE = $objQuery->mysqlSelect("b.conjuctiva_name as conjuctiva_name,a.conjuctiva as conjuctiva","doc_patient_conjuctiva_active as a left join examination_ophthal_conjuctiva as b on a.conjuctiva=b.conjuctiva_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2'","","","","");
		...
		$get_exam_cornea_anteriorRE = $objQuery->mysqlSelect("b.cornea_ant_name as cornea_ant_name,a.cornea_ant as cornea_ant","doc_patient_cornea_ant_active as a left join examination_ophthal_cornea_anterior as b on a.cornea_ant=b.cornea_ant_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1'","","","","");
		$get_exam_cornea_anteriorLE = $objQuery->mysqlSelect("b.cornea_ant_name as cornea_ant_name,a.cornea_ant as cornea_ant","doc_patient_cornea_ant_active as a left join examination_ophthal_cornea_anterior as b on a.cornea_ant=b.cornea_ant_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2'","","","","");
									
		$get_exam_cornea_posteriorRE = $objQuery->mysqlSelect("b.cornea_post_name as cornea_post_name,a.cornea_post as cornea_post","doc_patient_cornea_post_active as a left join examination_ophthal_cornea_posterior as b on a.cornea_post=b.cornea_post_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1'","","","","");
		$get_exam_cornea_posteriorLE = $objQuery->mysqlSelect("b.cornea_post_name as cornea_post_name,a.cornea_post as cornea_post","doc_patient_cornea_post_active as a left join examination_ophthal_cornea_posterior as b on a.cornea_post=b.cornea_post_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2'","","","","");
									
		$get_exam_anterior_chamberRE = $objQuery->mysqlSelect("b.chamber_name as chamber_name,a.chamber as chamber","doc_patient_anterior_chamber_active as a left join examination_ophthal_chamber as b on a.chamber=b.chamber_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1'","","","","");
		$get_exam_anterior_chamberLE = $objQuery->mysqlSelect("b.chamber_name as chamber_name,a.chamber as chamber","doc_patient_anterior_chamber_active as a left join examination_ophthal_chamber as b on a.chamber=b.chamber_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2'","","","","");
									
		$get_exam_anterior_irisRE = $objQuery->mysqlSelect("b.iris_name as iris_name,a.iris as iris","doc_patient_iris_active as a left join examination_ophthal_iris as b on a.iris=b.iris_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1'","","","","");
		$get_exam_anterior_irisLE = $objQuery->mysqlSelect("b.iris_name as iris_name,a.iris as iris","doc_patient_iris_active as a left join examination_ophthal_iris as b on a.iris=b.iris_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2'","","","","");
									
		$get_exam_pupil_RE = $objQuery->mysqlSelect("b.pupil_name as pupil_name,a.pupil as pupil","doc_patient_pupil_active as a left join examination_ophthal_pupil as b on a.pupil=b.pupil_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1'","","","","");
		$get_exam_pupil_LE = $objQuery->mysqlSelect("b.pupil_name as pupil_name,a.pupil as pupil","doc_patient_pupil_active as a left join examination_ophthal_pupil as b on a.pupil=b.pupil_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2'","","","","");
									
		$get_exam_angle_RE = $objQuery->mysqlSelect("b.angle_name as angle_name,a.angle as angle","doc_patient_angle_active as a left join examination_ophthal_angle as b on a.angle=b.angle_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1'","","","","");
		$get_exam_angle_LE = $objQuery->mysqlSelect("b.angle_name as angle_name,a.angle as angle","doc_patient_angle_active as a left join examination_ophthal_angle as b on a.angle=b.angle_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2'","","","","");
									
		$get_exam_lens_RE = $objQuery->mysqlSelect("b.lens_name as lens_name,a.lens as lens","doc_patient_lens_active as a left join examination_ophthal_lens as b on a.lens=b.lens_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1'","","","","");
		$get_exam_lens_LE = $objQuery->mysqlSelect("b.lens_name as lens_name,a.lens as lens","doc_patient_lens_active as a left join examination_ophthal_lens as b on a.lens=b.lens_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2'","","","","");
									
		$get_exam_viterous_RE = $objQuery->mysqlSelect("b.viterous_name as viterous_name,a.viterous as viterous","doc_patient_viterous_active as a left join examination_ophthal_viterous as b on a.viterous=b.viterous_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1'","","","","");
		$get_exam_viterous_LE = $objQuery->mysqlSelect("b.viterous_name as viterous_name,a.viterous as viterous","doc_patient_viterous_active as a left join examination_ophthal_viterous as b on a.viterous=b.viterous_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2'","","","","");
									
		$get_exam_fundus_RE = $objQuery->mysqlSelect("b.fundus_name as fundus_name,a.fundus as fundus","doc_patient_fundus_active as a left join examination_ophthal_fundus as b on a.fundus=b.fundus_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1'","","","","");
		$get_exam_fundus_LE = $objQuery->mysqlSelect("b.fundus_name as fundus_name,a.fundus as fundus","doc_patient_fundus_active as a left join examination_ophthal_fundus as b on a.fundus=b.fundus_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2'","","","","");
									
		$get_exam_refraction = $objQuery->mysqlSelect("*","examination_opthal_spectacle_prescription","episode_id = '".$patient_episodes[0]['episode_id']."' and doc_id = '".$patient_episodes[0]['admin_id']."' and doc_type = '1'","","","","");
		}							
...
<html>
	...
	<input type="radio" class="checkEMR" value="1" name="checkEMR" checked="checked" autocomplete="off">
     ...
     <label for="inlineRadio1"> Prescription only </label>
		...
		<option value="">Refer to Diagnstic Center</option>
		<?php $getDiagnostic= $objQuery->mysqlSelect("*","Diagnostic_center as a left join doc_diagnostics as b on a.diagnostic_id=b.diagnostic_id","b.doc_id='".$patient_episodes[0]['admin_id']."'","b.doc_diagno_id desc","","","");
	...
	<select class="chosen-select" id="selectPharma" data-patient-id="<?php echo $patient_id; ?>" data-episode-id="<?php echo $patient_episodes[0]['episode_id']; ?>" autocomplete="off">
		...
		<?php $getPharma= $objQuery->mysqlSelect("*","pharma as a left join doc_pharma as b on a.pharma_id=b.pharma_id","b.doc_id='".$patient_episodes[0]['admin_id']."'","b.doc_pharma_id desc","","","");
	...
	<select class="chosen-select" id="selectOpticleCenter" data-patient-id="<?php echo $patient_id; ?>" data-episode-id="<?php echo $patient_episodes[0]['episode_id']; ?>" autocomplete="off">
		...
		<?php $getOpticles= $objQuery->mysqlSelect("*","Opticle_center as a left join doc_opticles as b on a.opticale_id=b.opticale_id","b.doc_id='".$patient_episodes[0]['admin_id']."'","b.doc_opticle_id desc","","","");
