...
$objQuery = new CLSQueryMaker();
	...
	$patient_tab = $objQuery->mysqlSelect("*","my_patient","md5(patient_id)='".$_GET['pid']."'","","","","");
	//print_r($patient_tab);
	if(COUNT($patient_tab)==0){
		...
		//Episode Details
			...
			$patient_episodes = $objQuery->mysqlSelect("episode_id,date_time,admin_id","patient_episodes","patient_id = '". $patient_id ."' and md5(episode_id)='".$_GET['episode']."'","","","","");
			
			$episode_created_date=date('d M Y, H:i a',strtotime($patient_episodes[0]['date_time']));   //Prescription Date
			
			
			$get_medical_complaint = $objQuery->mysqlSelect("b.symptoms as symptoms","doc_patient_symptoms_active as a left join chief_medical_complaints as b on a.symptoms=b.complaint_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.doc_type='2'","","","","");
				
			$get_diagnosis = $objQuery->mysqlSelect("b.icd_code as icd_code","patient_diagnosis as a left join icd_code as b on a.icd_id=b.icd_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.doc_type='2'","","","","");
			
			$get_examination = $objQuery->mysqlSelect("b.examination as examination,a.exam_result as exam_result,a.findings as findings","doc_patient_examination_active as a left join examination as b on a.examination=b.examination_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.doc_type='2'","","","","");
				
			$get_invest = $objQuery->mysqlSelect("*","patient_temp_investigation","patient_id = '". $patient_id ."' and episode_id='". $patient_episodes[0]['episode_id']."' and doc_type='2'","","","","");
										
		//Doctors Details	
			$get_doc_details = $objQuery->mysqlSelect("partner_name","our_partners","partner_id='".$patient_episodes[0]['admin_id']."'","","","","");
			$doctor_name = $get_doc_details[0]['partner_name'];  //Doctor Name
			$_SESSION['doc_name'] = $get_doc_details[0]['partner_name'];
		//Doctors Specialization
			$get_doc_spec = $objQuery->mysqlSelect("a.spec_name as specialization, a.spec_group_id as spec_group_id","specialization as a inner join doc_specialization as b on a.spec_id=b.spec_id","b.doc_id='".$patient_episodes[0]['admin_id']."' and b.doc_type='2'","a.spec_id ASC","","","");
			
		//Get Host Name
			if($get_doc_spec[0]['spec_group_id']==1)
			{
				$hostName = "https://medisensecrm.com/standard/My-Patient-Details";
			}else if($get_doc_spec[0]['spec_group_id']==2)
			{
				$hostName = "https://medisensecrm.com/standard/Ophthal-EMR/";				
			}
			else{
		...
		$patient_episode_prescriptions = $objQuery->mysqlSelect("*","patient_episode_prescriptions","episode_id = '". $patient_episodes[0]['episode_id'] ."' "," prescription_seq ASC","","","");
		...
		$doc_patient_spectacle_prescriptions = $objQuery->mysqlSelect("*","examination_opthal_spectacle_prescription","episode_id = '". $patient_episodes[0]['episode_id'] ."' ","spectacle_id ASC","","","");

		$get_exam_lids = $objQuery->mysqlSelect("b.lids_name as lids_name,a.lids as lids","doc_patient_lids_active as a left join examination_ophthal_lids as b on a.lids=b.lids_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_type='1' and doc_type='2'","","","","");
		$get_exam_lidsLE = $objQuery->mysqlSelect("b.lids_name as lids_name,a.lids as lids","doc_patient_lids_active as a left join examination_ophthal_lids as b on a.lids=b.lids_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_type='2' and doc_type='2'","","","","");
									
		$get_exam_conjuctivaRE = $objQuery->mysqlSelect("b.conjuctiva_name as conjuctiva_name,a.conjuctiva as conjuctiva","doc_patient_conjuctiva_active as a left join examination_ophthal_conjuctiva as b on a.conjuctiva=b.conjuctiva_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1' and doc_type='2'","","","","");
		$get_exam_conjuctivaLE = $objQuery->mysqlSelect("b.conjuctiva_name as conjuctiva_name,a.conjuctiva as conjuctiva","doc_patient_conjuctiva_active as a left join examination_ophthal_conjuctiva as b on a.conjuctiva=b.conjuctiva_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2' and doc_type='2'","","","","");
									
		$get_exam_scleraRE = $objQuery->mysqlSelect("b.scelra_name as scelra_name,a.sclera as sclera","doc_patient_sclera_active as a left join examination_ophthal_sclera as b on a.sclera=b.sclera_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1'","","","","");
		$get_exam_scleraLE = $objQuery->mysqlSelect("b.scelra_name as scelra_name,a.sclera as sclera","doc_patient_sclera_active as a left join examination_ophthal_sclera as b on a.sclera=b.sclera_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2'","","","","");
									
		$get_exam_cornea_anteriorRE = $objQuery->mysqlSelect("b.cornea_ant_name as cornea_ant_name,a.cornea_ant as cornea_ant","doc_patient_cornea_ant_active as a left join examination_ophthal_cornea_anterior as b on a.cornea_ant=b.cornea_ant_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1' and doc_type='2'","","","","");
		$get_exam_cornea_anteriorLE = $objQuery->mysqlSelect("b.cornea_ant_name as cornea_ant_name,a.cornea_ant as cornea_ant","doc_patient_cornea_ant_active as a left join examination_ophthal_cornea_anterior as b on a.cornea_ant=b.cornea_ant_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2' and doc_type='2'","","","","");
									
		$get_exam_cornea_posteriorRE = $objQuery->mysqlSelect("b.cornea_post_name as cornea_post_name,a.cornea_post as cornea_post","doc_patient_cornea_post_active as a left join examination_ophthal_cornea_posterior as b on a.cornea_post=b.cornea_post_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1' and doc_type='2'","","","","");
		$get_exam_cornea_posteriorLE = $objQuery->mysqlSelect("b.cornea_post_name as cornea_post_name,a.cornea_post as cornea_post","doc_patient_cornea_post_active as a left join examination_ophthal_cornea_posterior as b on a.cornea_post=b.cornea_post_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2' and doc_type='2'","","","","");
									
		$get_exam_anterior_chamberRE = $objQuery->mysqlSelect("b.chamber_name as chamber_name,a.chamber as chamber","doc_patient_anterior_chamber_active as a left join examination_ophthal_chamber as b on a.chamber=b.chamber_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1' and doc_type='2'","","","","");
		$get_exam_anterior_chamberLE = $objQuery->mysqlSelect("b.chamber_name as chamber_name,a.chamber as chamber","doc_patient_anterior_chamber_active as a left join examination_ophthal_chamber as b on a.chamber=b.chamber_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2' and doc_type='2'","","","","");
									
		$get_exam_anterior_irisRE = $objQuery->mysqlSelect("b.iris_name as iris_name,a.iris as iris","doc_patient_iris_active as a left join examination_ophthal_iris as b on a.iris=b.iris_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1' and doc_type='2'","","","","");
		$get_exam_anterior_irisLE = $objQuery->mysqlSelect("b.iris_name as iris_name,a.iris as iris","doc_patient_iris_active as a left join examination_ophthal_iris as b on a.iris=b.iris_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2' and doc_type='2'","","","","");
									
		$get_exam_pupil_RE = $objQuery->mysqlSelect("b.pupil_name as pupil_name,a.pupil as pupil","doc_patient_pupil_active as a left join examination_ophthal_pupil as b on a.pupil=b.pupil_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1' and doc_type='2'","","","","");
		$get_exam_pupil_LE = $objQuery->mysqlSelect("b.pupil_name as pupil_name,a.pupil as pupil","doc_patient_pupil_active as a left join examination_ophthal_pupil as b on a.pupil=b.pupil_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2' and doc_type='2'","","","","");
									
		$get_exam_angle_RE = $objQuery->mysqlSelect("b.angle_name as angle_name,a.angle as angle","doc_patient_angle_active as a left join examination_ophthal_angle as b on a.angle=b.angle_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1' and doc_type='2'","","","","");
		$get_exam_angle_LE = $objQuery->mysqlSelect("b.angle_name as angle_name,a.angle as angle","doc_patient_angle_active as a left join examination_ophthal_angle as b on a.angle=b.angle_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2' and doc_type='2'","","","","");
									
		$get_exam_lens_RE = $objQuery->mysqlSelect("b.lens_name as lens_name,a.lens as lens","doc_patient_lens_active as a left join examination_ophthal_lens as b on a.lens=b.lens_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1' and doc_type='2'","","","","");
		$get_exam_lens_LE = $objQuery->mysqlSelect("b.lens_name as lens_name,a.lens as lens","doc_patient_lens_active as a left join examination_ophthal_lens as b on a.lens=b.lens_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2' and doc_type='2'","","","","");
									
		$get_exam_viterous_RE = $objQuery->mysqlSelect("b.viterous_name as viterous_name,a.viterous as viterous","doc_patient_viterous_active as a left join examination_ophthal_viterous as b on a.viterous=b.viterous_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1' and doc_type='2'","","","","");
		$get_exam_viterous_LE = $objQuery->mysqlSelect("b.viterous_name as viterous_name,a.viterous as viterous","doc_patient_viterous_active as a left join examination_ophthal_viterous as b on a.viterous=b.viterous_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2' and doc_type='2'","","","","");
									
		$get_exam_fundus_RE = $objQuery->mysqlSelect("b.fundus_name as fundus_name,a.fundus as fundus","doc_patient_fundus_active as a left join examination_ophthal_fundus as b on a.fundus=b.fundus_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='1' and doc_type='2'","","","","");
		$get_exam_fundus_LE = $objQuery->mysqlSelect("b.fundus_name as fundus_name,a.fundus as fundus","doc_patient_fundus_active as a left join examination_ophthal_fundus as b on a.fundus=b.fundus_id","a.episode_id='".$patient_episodes[0]['episode_id']."' and a.eye_side='2' and doc_type='2'","","","","");
									
		$get_exam_refraction = $objQuery->mysqlSelect("*","examination_opthal_spectacle_prescription","episode_id = '".$patient_episodes[0]['episode_id']."' and doc_id = '".$patient_episodes[0]['admin_id']."' and doc_type = '2'","","","","");
		}							
...
<html>
	...
	<input type="radio" class="checkEMR" value="1" name="checkEMR" checked="checked" autocomplete="off">
     <label for="inlineRadio1"> EMR </label>
	 <input type="radio" class="checkEMR" value="2" name="checkEMR" autocomplete="off">
     <label for="inlineRadio1"> Prescription only </label>
	 </div>
	    <a href="#" class="btn" onclick="window.print(); return false;">PRINT</a>
	    <a href="#" class="btn" id="sendEMAIL" data-id="<?php echo $_GET['pid']; ?>" data-email="<?php echo $patient_email; ?>">Email Prescription</a>
		<a href="#" class="btn" id="sendSMS" data-id="<?php echo $_GET['pid']; ?>" data-mobile="<?php echo $patient_mob; ?>">SMS Prescription</a>
...
<?php if (COUNT($patient_episode_prescriptions) > 0) { ?>
	    <div id="prescription" cellpadding="0" cellspacing="0" border="0">
		<table>
				<thead>
					<tr>
