...
$objQuery = new CLSQueryMaker();
	...
	$get_TrendAnalysisDate = $objQuery->mysqlSelect("date_added","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
	$get_medicineGivenDate = $objQuery->mysqlSelect("date_added","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
	$get_TrendAnalysisPPCount = $objQuery->mysqlSelect("bp_beforefood_count","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
	$get_TrendAnalysisPPAfterCount = $objQuery->mysqlSelect("bp_afterfood_count","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
	$get_TrendAnalysisSystolic = $objQuery->mysqlSelect("systolic","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
	$get_TrendAnalysisDiastolic = $objQuery->mysqlSelect("diastolic","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
	$get_TrendAnalysisHbA1c = $objQuery->mysqlSelect("HbA1c","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
	$get_TrendAnalysisHDL = $objQuery->mysqlSelect("HDL","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
	$get_TrendAnalysisVLDL = $objQuery->mysqlSelect("VLDL","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
	$get_TrendAnalysisLDL = $objQuery->mysqlSelect("LDL","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
	$get_TrendAnalysisTriglyceride = $objQuery->mysqlSelect("triglyceride","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
	$get_TrendAnalysisCholesterol = $objQuery->mysqlSelect("cholesterol","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","date_added desc","","","0,8");
                    ...
                    <div id="vertical-timeline" class="vertical-container light-timeline no-margins">
                        ...
                        <div class="vertical-timeline-block" id="add-visit-dtails">
							...
							<input type="hidden" name="patient_name" value="<?php echo $patient_tab[0]['patient_name']; ?>">
								...
								<h4>Examination</h4>
								<div class="input-group">				
								<?php $last_five_examination = $objQuery->mysqlSelect("b.examination_id as examination_id,b.examination as examination","doctor_frequent_examination as a left join examination as b on a.examination_id=b.examination_id","(a.doc_id='".$admin_id."' and a.doc_type='2') or (a.doc_id='0' and a.doc_type='0')","a.freq_count DESC","","","5");
							...
							$edit_patient_episodes = $objQuery->mysqlSelect("*, DATE_FORMAT(date_time,'%d/%m/%Y') AS formated_date_time","patient_episodes","md5(episode_id) = '".$_GET['episode']."' ","","","","");
							...
							<div class="vertical-timeline-content" id="edit_visist_details">
								...
								<?php 
								$getExamination= $objQuery->mysqlSelect("a.examination_id as examination_id,b.examination as examination,a.exam_result as exam_result,a.findings as findings","doc_patient_examination_active as a left join examination as b on a.examination=b.examination_id","a.episode_id='".$edit_patient_episodes[0]['episode_id']."'","a.examination_id asc","","","");
						...
						<div class="vertical-timeline-block" id="visit-details">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny">
                                ...
                                <tr>
                                    ...
                                    <td><?php 
									$get_medical_complaint = $objQuery->mysqlSelect("b.symptoms as symptoms","doc_patient_symptoms_active as a left join chief_medical_complaints as b on a.symptoms=b.complaint_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.doc_type='2'","","","","");
                                    ...
                                    <td>
									<?php 
									$get_examination = $objQuery->mysqlSelect("b.examination as examination,a.exam_result as exam_result,a.findings as findings","doc_patient_examination_active as a left join examination as b on a.examination=b.examination_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.doc_type='2'","","","","");
									...
									<!-- DISPLAY DIAGNOSIS -->
									<td><?php 
									$get_diagnosis = $objQuery->mysqlSelect("b.icd_code as icd_code","patient_diagnosis as a left join icd_code as b on a.icd_id=b.icd_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.doc_type='2'","","","","");
									...
									<td>
									<?php $get_cardio_invest = $objQuery->mysqlSelect("*","patient_temp_investigation","patient_id = '". $patient_tab[0]['patient_id'] ."' and episode_id='". $patient_episode_val['episode_id']."' and department='1' and doc_type='2'","","","","");
										  $get_ophthal_invest = $objQuery->mysqlSelect("*","patient_temp_investigation","patient_id = '". $patient_tab[0]['patient_id'] ."' and episode_id='". $patient_episode_val['episode_id']."' and department='2' and doc_type='2'","","","","");
									...
									<!-- DISPLAY TREATMENT -->
									<td><?php 
									$get_treatment = $objQuery->mysqlSelect("b.treatment as treatment","doc_patient_treatment_active as a left join doctor_frequent_treatment as b on a.dft_id=b.dft_id","a.episode_id='".$patient_episode_val['episode_id']."' and a.doc_type='2'","","","","");
									if(!empty($get_examination)){
									...
									<td>
											<?php
											$doc_patient_episode_prescriptions = $objQuery->mysqlSelect("*","patient_episode_prescriptions","episode_id = '". $patient_episode_val['episode_id'] ."' "," prescription_seq ASC","","","");
...
<!-- Chosen -->
   ...
   <!-- Page-Level Scripts -->
    ...
    <script>
        $(document).ready(function(){
		<?php 
	$get_PatientDetails = $objQuery->mysqlSelect("patient_id,patient_name,patient_mob","my_patient","partner_id='".$admin_id."'","","","","");
...
<?php
	...
	$get_TrendAnalysisDate1 = $objQuery->mysqlSelect("date_added","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","trend_id asc","","","0,5");
	$get_TrendAnalysisPPCount1 = $objQuery->mysqlSelect("bp_beforefood_count","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","trend_id asc","","","0,5");
	$get_TrendAnalysisPPAfterCount1 = $objQuery->mysqlSelect("bp_afterfood_count","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","trend_id asc","","","0,5");
	$get_TrendAnalysisSystolic1 = $objQuery->mysqlSelect("systolic","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","trend_id asc","","","0,5");
	$get_TrendAnalysisDiastolic1 = $objQuery->mysqlSelect("diastolic","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","trend_id asc","","","0,5");
	$get_TrendAnalysisHbA1c1 = $objQuery->mysqlSelect("HbA1c","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","trend_id asc","","","0,5");
	$get_TrendAnalysisHDL1 = $objQuery->mysqlSelect("HDL","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","trend_id asc","","","0,5");
	$get_TrendAnalysisVLDL1 = $objQuery->mysqlSelect("VLDL","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","trend_id asc","","","0,5");
	$get_TrendAnalysisLDL1 = $objQuery->mysqlSelect("LDL","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","trend_id asc","","","0,5");
	$get_TrendAnalysisTriglyceride1 = $objQuery->mysqlSelect("triglyceride","trend_analysis","patient_id=' and patient_type = '2'".$patient_id."'","trend_id asc","","","0,5");
	$get_TrendAnalysisCholesterol1 = $objQuery->mysqlSelect("cholesterol","trend_analysis","patient_id='".$patient_id."' and patient_type = '2'","trend_id asc","","","0,5");
