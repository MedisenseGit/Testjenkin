<div class="col-lg-12" style="background-color:#f8f8f8; border:1px dashed #cecdcb; padding-top:20px; margin-bottom:20px;">
								...
								<?php $last_five_icd = $objQuery->mysqlSelect("a.icd_id as icd_id,b.icd_code as icd_code","doctor_frequent_diagnosis as a inner join icd_code as b on a.icd_id=b.icd_id","a.doc_id='".$admin_id."' and a.doc_type='2'","a.freq_count DESC","","","6");
								...
								<div class="input-group">
                                       ...
                                       <input type="text" placeholder="Enter ICD Code/investigation name here..." data-episode-id="0" data-patient-id="<?php echo $patient_tab[0]['patient_id']; ?>" id="get_diagnosis" name="srchSymptoms" value="" class="form-control input-lg searchDiagnosis" tabindex="4">
