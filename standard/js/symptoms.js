$(document).ready(function() {
	var hostUrl="https://medisensecrm.com/standard/";
	...
	$("body").on("blur", ".Spectacle", function() {
		var spectacle_id = $(this).attr("data-spectacle-id");
		var slctDistVisionRE = $(this).val("#slctDistVisionRE");
		var slctDistVisionLE = $(this).val("#slctDistVisionLE");
		var slctNearVisionRE = $(this).val("#slctNearVisionRE");
		var slctNearVisionLE = $(this).val("#slctNearVisionLE");
		var IpdLE = $(this).val("#IpdLE");	
		var IpdRE = $(this).val("#IpdRE");
		var NvAxisLE = $(this).val("#NvAxisLE");
		var NvCylLE = $(this).val("#NvCylLE");
		var NvSpeherLE = $(this).val("#NvSpeherLE");
		var NvAxisRE = $(this).val("#NvAxisRE");
		var NvCylRE = $(this).val("#NvCylRE");
		var NvSpeherRE = $(this).val("#NvSpeherRE");
		var DvAxisLE = $(this).val("#DvAxisLE");
		var DvCylLE = $(this).val("#DvCylLE");
		var DvSpeherLE = $(this).val("#DvSpeherLE");
		var DvAxisRE = $(this).val("#DvAxisRE");
		var DvCylRE = $(this).val("#DvCylRE");
		var DvSpeherRE = $(this).val("#DvSpeherRE");
		var se_refractionLE_value2 = $(this).val("#se_refractionLE_value2");
		var se_refractionLE_value1 = $(this).val("#se_refractionLE_value1");
		var se_refractionRE_value2 = $(this).val("#se_refractionRE_value2");
		var se_refractionRE_value1 = $(this).val("#se_refractionRE_value1");
		
		
		var url = hostUrl+"Ophthal-EMR/my_patient_profile_ophthal_save.php?updateSpectacle=1&spectacle_id="+spectacle_id+"&slctDistVisionRE="+slctDistVisionRE+"&slctDistVisionLE="+slctDistVisionLE+"&slctNearVisionRE="+slctNearVisionRE+"&slctNearVisionLE="+slctNearVisionLE+"&IpdLE="+IpdLE+"&IpdRE="+IpdRE+"&NvAxisLE="+NvAxisLE+"&NvCylLE="+NvCylLE+"&NvSpeherLE="+NvSpeherLE+"&NvAxisRE="+NvAxisRE+"&NvCylRE="+NvCylRE+"&NvSpeherRE="+NvSpeherRE+"&DvAxisLE="+DvAxisLE+"&DvCylLE="+DvCylLE+
		"&DvSpeherLE="+DvSpeherLE+"&DvAxisRE="+DvAxisRE+"&DvCylRE="+DvCylRE+"&DvSpeherRE="+DvSpeherRE+"&se_refractionLE_value2="+se_refractionLE_value2+"&se_refractionLE_value1="+se_refractionLE_value1+"&se_refractionRE_value2="+se_refractionRE_value2+"&se_refractionRE_value1="+se_refractionRE_value1;
		console.log(spectacle_id,url);
							...
							if(!theUserMobile.val()){ 
								...
								$.ajax({
									...
									swal({
											...
											text: "Share a link with the patients for them to upload their old reports",
											type: "success"
										});
									}  
								});
