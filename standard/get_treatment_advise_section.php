<div class="col-lg-12" style="background-color:#f8f8f8; border:1px dashed #cecdcb; padding-top:20px; margin-bottom:20px;">
								...
								<?php $last_five_treatment = $objQuery->mysqlSelect("*","doctor_frequent_treatment","(doc_id='0' and doc_type='0') or (doc_id='".$admin_id."' and doc_type='2')","freq_count DESC","","","6");
								...
								<div class="col-lg-6">
								<dl>
								 <dt>Treatment Details</dt><br> <dd><textarea class="form-control" id="treatment_details"  name="treatment_details" rows="3"><?php echo $patient_tab[0]['other_details']; ?></textarea></dd><br>
								</dl>
								</div>
