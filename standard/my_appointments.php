...
$getRefDet = $objQuery->mysqlSelect("state,location","our_partners","partner_id='".$admin_id."'","","","","");
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
			...
			<?php if($_GET['response']=="appointment-success"){ ?>
					<div class="alert alert-success alert-dismissable">
                               ...
                               <strong>Appointment has been booked successfully </strong>
                     </div>
					<?php } ?>
                <div class="col-lg-6">
                        ...
                        <div class="panel-body">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-4"><select data-placeholder="Choose Preferred Time..." class="chosen-select" name="check_time"  tabindex="2">
												<option value="">Select Timing</option>
													<?php
													$GetTiming= $objQuery->mysqlSelect("*","timings","","","","","");
								...
								<div class="form-group"><label class="col-sm-2 control-label">State <span class="required">*</span></label>
                                    ...
                                    <div class="col-sm-10"><select data-placeholder="Choose a State..." class="chosen-select" required="required" name="se_state" id="se_state" tabindex="2">
													...
													if(!empty($getRefDet[0]['state'])){
													?><option value="<?php echo $getRefDet[0]['state']; ?>"><?php echo $getRefDet[0]['state']; ?></option>
													<?php } else{ ?>
								...
								<div class="form-group"><label class="col-sm-2 control-label">City <span class="required">*</span></label>
                                    ...
                                    <div class="col-sm-10"><input type="text" name="se_city" value="<?php echo $getRefDet[0]['location']; ?>" class="form-control"></div>
                                </div>
