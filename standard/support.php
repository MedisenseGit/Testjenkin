...
function seachSpec(str) {
	alert(str.val);
    if (str == "") {
        document.getElementById("editFavour").innerHTML = "";
        return;
    } else { 
        if (window.XMLHttpRequest) {
            // code for IE7+, Firefox, Chrome, Opera, Safari
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("editFavour").innerHTML = this.responseText;
            }
        };
        xmlhttp.open("GET","edit_favour.php?favour_id="+str,true);
        xmlhttp.send();
    }
...
function addFavour(str) {
    if (str == "") {
        document.getElementById("addFavour").innerHTML = "";
        return;
    } else { 
        if (window.XMLHttpRequest) {
            // code for IE7+, Firefox, Chrome, Opera, Safari
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("addFavour").innerHTML = this.responseText;
            }
        };
        xmlhttp.open("GET","add_favour.php?doc_id="+str,true);
        xmlhttp.send();
    }
