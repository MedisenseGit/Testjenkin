...
if(isset($_POST['cmdSearch'])){
	...
	if($params[0]!=0){
	$patientid = $params[0];
	header("Location:Customer_Profile_Info?p=".md5($patientid));
	}
	else
	{
	$patientid = "0";	
	header("Location:Customer_Profile_Info?p=".$patientid."&n=".$params[0]);
	}
...
if(isset($_POST['add_button'])){
	...
	$arrValues_payment[] = "3";   //User type 1 for Prime Doctor,and 2 for non prime doctor, 3 for diagnostic
	...
	$patientid = $transactioncreate;  //Get Patient Id
...
//SAVE CUSTOMER
if(isset($_POST['cmdSave']) || isset($_POST['update_patient'])){

	$custName = $_POST['custName'];
	$custAge = $_POST['custAge'];
	$custGender = $_POST['radioInline'];
	$custMobile = $_POST['custMobile'];
	$custEmail = $_POST['custEmail'];
	$custCity = $_POST['custCity'];
	
	$diagnostic_cust_country = $_POST['diagnostic_cust_country'];
	$diagnostic_cust_state = $_POST['diagnostic_cust_state'];
	$diagnostic_cust_address = $_POST['diagnostic_cust_address'];
	...
	$arrValues[] = $admin_id;
	$arrFields[] = 'diagnostic_customer_name';
	$arrValues[] = $custName;
	$arrFields[] = 'diagnostic_cust_age';
	$arrValues[] = $custAge;
	$arrFields[] = 'diagnostic_cust_gender';
	$arrValues[] = $custGender;
	$arrFields[] = 'diagnostic_customer_phone';
	$arrValues[] = $custMobile;
	$arrFields[] = 'diagnostic_customer_email';
	$arrValues[] = $custEmail;
	$arrFields[] = 'diagnostic_cust_city';
	$arrValues[] = $custCity;
	
	$arrFields[] = 'diagnostic_cust_address';
	$arrValues[] = $diagnostic_cust_address;
	$arrFields[] = 'diagnostic_cust_state';
	$arrValues[] = $diagnostic_cust_state;
	$arrFields[] = 'diagnostic_cust_country';
	$arrValues[] = $diagnostic_cust_country;
	if(isset($_POST['cmdSave'])){
	$createJob=mysqlInsert('diagnostic_customer',$arrFields,$arrValues);
	$cust_id = $createJob;
	$arrFields_cust[] = 'diagnostic_customer_id';
	$arrValues_cust[] = $cust_id;
	$arrFields_cust[] = 'diagnostic_id';
	$arrValues_cust[] = $admin_id;
	$arrFields_cust[] = 'referred_date';
	$arrValues_cust[] = $curDate;
	
	//$createReferral=mysqlInsert('diagnostic_referrals',$arrFields_cust,$arrValues_cust);
	}
	if(isset($_POST['update_patient'])){
		$userupdate=mysqlUpdate('diagnostic_customer',$arrFields,$arrValues, "diagnostic_customer_id = '". $_POST['patient_id'] ."' ");
		$cust_id = $_POST['patient_id'];		
	}
				
	header("location:Customer_Profile_Info?p=".md5($cust_id));
}
//APPLY JOB
...
if(isset($_POST['change_password'])){
	...
	//$result = mysqlSelect('ref_id','Diagnostic_center',"ref_id='".$_POST['Prov_Id']."'");
	if($txtPass==$txtRePass){
		...
		$editrecord=mysqlUpdate('Diagnostic_center',$arrFields,$arrValues,"diagnostic_id='".$_POST['Prov_Id']."'");
...
if(isset($_POST['edit_doctor'])){
	...
	$arrValues = array();
		...
		$arrFields[] = 'diagnosis_name';
		$arrValues[] = $txtDoc;		
		$arrFields[] = 'diagnosis_contact_num';
		$arrValues[] = $txtMobile;
		$arrFields[] = 'diagnosis_email';
		$arrValues[] = $txtEmail;
		$arrFields[] = 'diagnosis_city';
		$arrValues[] = $txtCity;
		$arrFields[] = 'diagnosis_state';
		$arrValues[] = $slctState;
		$arrFields[] = 'diagnosis_country';
		$arrValues[] = $txtCountry;

		
		
	$updateProvider=mysqlUpdate('Diagnostic_center',$arrFields,$arrValues,"diagnostic_id='".$_POST['Prov_Id']."'");
