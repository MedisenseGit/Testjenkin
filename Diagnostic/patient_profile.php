...
require_once("../classes/querymaker.class.php");
	...
	$diagno_referal = mysqlSelect("*","health_lab_test_request","md5(id)='".$_GET['p']."'","","","","");
  ...
  $attachments = mysqlSelect("*","health_lab_test_request_attachments","customer_id = '".$diagno_referal[0]['id']."'","","","","");
$payment_amount = mysqlSelect("*","payment_diagno_pharma","referred_id='".$diagno_referal[0]['id']."' and type='2' and request_from='1'","","","","");
?>
<!DOCTYPE html>
<html>
                    ...
                    <div id="vertical-timeline" class="vertical-container light-timeline no-margins">
						...
						<div class="vertical-timeline-block" id="visit-details">
                            ...
                            <div class="vertical-timeline-content">
                               ...
                               <h2>Attachments <?php if($diagno_referal[0]['order_status'] == '2') { echo '<span class="label label-warning" style="float: right;font-size: 13px;margin-right: 30px;padding: 7px;">Payment Link Sent</span>'; } 
							...
							<form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left"  action="my_patient_profile_save.php"  name="frmSMSSubmit" id="frmSMSSubmit">
								<input type="hidden" name="patient_id" value="<?php echo $patient_tab[0]['login_id']; ?>">
								 ...
								 <?php if($diagno_referal[0]['order_status']=='1' || $diagno_referal[0]['order_status']=='2'){ ?>
									...
									<!-- <select id="currency_code" name="currency_code" style="font-size:14px;">
									...
									<div class="col-lg-12 pull-left" style="font-size:13px;">
							 ...
							 <h2>View Reports</h2>
								<?php 
					$doc_patient_reports = mysqlSelect("*","attachment_diagno_pharma","referred_id='".$diagno_referal[0]['id']."'  and type='2' and request_from='1'","id desc","","","");
