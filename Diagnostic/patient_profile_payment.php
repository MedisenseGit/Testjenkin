...
$diagno_referal = mysqlSelect("*","diagnostic_referrals","md5(dr_id)='".$_GET['r']."'","","","","");
...
$payment_amount = mysqlSelect("*","payment_diagno_pharma","referred_id='".$diagno_referal[0]['dr_id']."'  and type='".$_GET['t']."' and request_from='1'","","","","");
$pat_mob=$patient_tab[0]['diagnostic_customer_phone'];
$pat_email=$patient_tab[0]['diagnostic_customer_email'];
$pat_name=$patient_tab[0]['diagnostic_customer_name'];
$pat_age=$patient_tab[0]['diagnostic_cust_age'];
$refer_id=$diagno_referal[0]['dr_id'];
$address=$patient_tab[0]['diagnostic_cust_address'].", ".$patient_tab[0]['diagnostic_cust_city'].", ".$patient_tab[0]['diagnostic_cust_state'].", ".$patient_tab[0]['diagnostic_cust_country'];
...
$TransId=time();	
		...
		$check_pay_trans = mysqlSelect("*","payment_diag_pha_transaction","referred_id='".$refer_id."' and type='".$_GET['t']."' and request_from='1'","","","","");
		if(COUNT($check_pay_trans)>0){	
		   $usercreate1=mysqlUpdate('payment_diag_pha_transaction',$arrFields_arr1,$arrValues_arr1,"referred_id='".$refer_id."' and type='".$_GET['t']."' and request_from='1'");
...
<head>
    ...
    <title>Diagnostic Payment</title>
                ...
                <div class="col-md-10">
					...
					<form method="post" action="<?php echo $gatewayUrl; ?>">
                        <div class="">
							...
							<input type="hidden" name="CALLBACK_URL" value="<?php echo HOST_MAIN_URL;?>Diagnostic/payment_success.php">
