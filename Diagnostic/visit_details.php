...
/*if($checkPatient[0]['patient_gen']=="1"){
	...
	$checkPatient= mysqlSelect("*","diagnostic_customer","md5(diagnostic_customer_id)='".$_GET['d']."'","","","","");
	$getReferredDetails= mysqlSelect("*","diagnostic_referrals","md5(diagnostic_customer_id)='".$_GET['d']."'","referred_date desc","","","");
	if($checkPatient[0]['diagnostic_cust_gender']=="1"){
		$gender="Male";
	}
	else if($checkPatient[0]['diagnostic_cust_gender']=="2"){
		$gender="Female";
	}
	else if($checkPatient[0]['diagnostic_cust_gender']=="3"){
		$gender="Other";
	}
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            <div class="navbar-header">
                ...
                <a href="#" class="navbar-brand"><img alt="image" class="img" src="../assets/img/PRACTICE_ logo_diagno.png" width="80"/></a>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="profile-info">
                        <div class="">
                            <div>
                                <h2 class="no-margins">
                                    <?php echo $checkPatient[0]['diagnostic_customer_name']; ?>
                                </h2>
                                <h4><i class="fa fa-mobile"></i> <?php echo $checkPatient[0]['diagnostic_customer_phone']; ?></h4>
								 <h4><i class="fa fa-stack-exchange"></i> <?php echo $checkPatient[0]['diagnostic_customer_email']; ?></h4>
                                <small>
                                    <?php echo $checkPatient[0]['diagnostic_cust_address'].", ".$checkPatient[0]['diagnostic_cust_city'].", ".$checkPatient[0]['diagnostic_cust_state']; ?>
                                </small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <table class="table small m-b-xs">
                        ...
                        <tr>
                            ...
                            <td>
                                <strong>AGE</strong> <?php echo $checkPatient[0]['diagnostic_cust_age']; ?>
                            </td>
				...
				<!-- <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left"  action="my_patient_profile_save.php"  name="frmAddPatient" id="frmAddPatient">-->
					...
					<input type="hidden" name="episode_id" value="<?php echo $getEpisode[0]['episode_id']; ?>">-->
						...
						<?php }
						 $get_invest = mysqlSelect("*","diagnostic_patient_temp_investigation","md5(diagnostic_customer_id) = '". $_GET['d'] ."' and md5(episode_id)='". $_GET['e']."'","","","","");
						$get_examination = mysqlSelect("a.examination as diagno_examination_id, a.examination_id as diagno_exam_id, a.exam_result as exam_result,a.findings as findings, a.diagnostic_customer_id as diagnostic_customer_id, a.episode_id as episode_id, b.examination_id as examination_id,b.examination as examination","diagnostic_patient_examination_active as a left join examination as b on a.examination=b.examination_id","md5(a.episode_id)='".$_GET['e']."'","","","","");
