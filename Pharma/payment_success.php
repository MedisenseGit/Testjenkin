...
if($isValidChecksum == "TRUE") {
	...
	$getTransactionDetails= mysqlSelect("*","payment_diag_pha_transaction","transaction_id='".$_POST["ORDERID"]."'","","","","");
					...
					$diagno_referal = mysqlSelect("*","pharma_referrals","pr_id='".$getTransactionDetails[0]['referred_id']."'","","","","");					
					$checkPatient = mysqlSelect("*","pharma_customer","pharma_customer_id='".$diagno_referal[0]['diagnostic_customer_id']."'","","","",""); 
					
					$Name=$checkPatient[0]['pharma_customer_name'];
					$Email=$checkPatient[0]['pharma_customer_email'];
					$Mobile=$checkPatient[0]['pharma_customer_phone'];
					...
					$update_pay=mysqlUpdate('pharma_referrals',$arrFiedPay1,$arrValuePay1,"pr_id='".$getTransactionDetails[0]['referred_id']."'");
		...
		$mailSubject='Pharma Payment Details';  
		$fromContent='Pharma';
		$contentSection='Received a message from Pharma Page - Your Payment Transaction Details- <br/><br/> Contact Name: '.$Name.'<br/>Email : '.$Email.'  <br/> Mobile number: '.$Mobile.'  <br/> Transaction Id: '.$trans_id.'  <br/> Amount Paid: '.$trans_amount.'  <br/> Transaction Date: '.$trans_date.'<br/> Transaction Mode: '.$trans_mode.'';
