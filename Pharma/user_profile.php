...
$get_diagnoInfo = mysqlSelect("*","pharma","pharma_id='".$admin_id."'","","","","");
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div>
                            ...
                            <div class="ibox-content profile-content">
                                <h4><strong><?php echo $get_diagnoInfo[0]['pharma_name']; ?></strong></h4>
                                <p><i class="fa fa-map-marker"></i> <?php if(!empty($get_diagnoInfo[0]['pharma_city'])){ echo ", ".$get_diagnoInfo[0]['pharma_city'];} if(!empty($get_diagnoInfo[0]['pharma_state'])){ echo ", ".$get_diagnoInfo[0]['pharma_state']; } if(!empty($get_diagnoInfo[0]['pharma_country'])){ echo ", ".$get_diagnoInfo[0]['pharma_country']; } ?></p>
                        ...
                        <div class="tab-content">
                           ...
                           <form enctype="multipart/form-data" action="add_details.php" method="post" class="form-horizontal" id="frmAddDoctor">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10"><input type="text" id="txtDoc" name="txtDoc" value="<?php echo $get_diagnoInfo[0]['pharma_name']; ?>" class="form-control"></div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Mobile <span class="required">*</span></label>
                                    ...
                                    <div class="col-sm-4"><input type="text" class="form-control" id="txtMobile" name="txtMobile" value="<?php echo $get_diagnoInfo[0]['pharma_contact_num']; ?>" placeholder="10 digit mobile no."></div>
									<!--<label class="col-sm-2 control-label">Email</label>

                                    <div class="col-sm-4"><input id="txtEmail" name="txtEmail" value="<?php echo $get_diagnoInfo[0]['pharma_email']; ?>" class="form-control"></div>-->
								...
								<div class="form-group"><label class="col-sm-2 control-label">Country </label>
                                    ...
                                    <div class="col-sm-10"><select data-placeholder="Choose a Country..." class="chosen-select" name="txtCountry"  tabindex="2" onchange="return getState(this.value);">
											<option value="<?php echo $get_diagnoInfo[0]['pharma_country']; ?>" selected><?php echo $get_diagnoInfo[0]['pharma_country']; ?></option>
												<?php 
								...
								<div class="form-group"><label class="col-sm-2 control-label">State </label>
                                    ...
                                    <div class="col-sm-10"><select data-placeholder="Choose a State..."  name="slctState" id="slctState" tabindex="2" class="form-control">
											<option value="<?php echo $get_diagnoInfo[0]['pharma_state']; ?>" selected><?php echo $get_diagnoInfo[0]['pharma_state']; ?></option>
												<?php
								...
								<div class="form-group"><label class="col-sm-2 control-label">City </label>
                                    ...
                                    <div class="col-sm-10"><input type="text" name="se_city" value="<?php echo $get_diagnoInfo[0]['pharma_city']; ?>"  class="form-control"></div>
                                </div>
