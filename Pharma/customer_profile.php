...
//
	...
	$patient_labtest = mysqlSelect("*","order_medicine","pr_id = '".$pharma_referal[0]['pr_id']."'","","","","");
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="vertical-container no-margins"style="padding-left:70px;">
						<div class="vertical-timeline-block" id="visit-details">
							...
							<div class="hrline"><hr></div>
								<div class="row">
									...
									<div class="col-lg-2 m-b-lg"><?php echo $patient_tab[0]['pharma_customer_name']; ?></div>
									<div class="col-lg-2 m-b-lg"><strong>CONTACT NO</strong></div>
									<div class="col-lg-2 m-b-lg"><?php echo $patient_tab[0]['pharma_customer_phone']; ?></div>
									<div class="col-lg-2 m-b-lg"><strong>STATUS</strong></div>
									<div class="col-lg-2 m-b-lg">
									<h2><?php if($patient_tab[0]['order_status'] == '2') { echo '<span class="label label-warning" style="float: right;font-size: 13px;margin-right: 30px;padding: 7px;">Payment Link Sent</span>'; } 
										else if($patient_tab[0]['order_status'] == '3') { echo '<span class="label label-info" style="float: right;font-size: 13px;margin-right: 30px;padding: 7px;">Paid</span>'; }
										else if($patient_tab[0]['order_status'] == '4') { echo '<span class="label label-success" style="float: right;font-size: 13px;margin-right: 30px;padding: 7px;">Completed</span>'; }
								...
								<div class="row">
									...
									<div class="col-lg-2 m-b-lg"><?php echo $patient_tab[0]['pharma_customer_email']; ?></div>
									<div class="col-lg-2 m-b-lg"><strong>ADDRESS</strong></div>
									<div class="col-lg-2 m-b-lg"><?php echo $patient_tab[0]['pharma_cust_address']; ?></div>
								</div>
								<div class="row">
									...
									<div class="col-lg-2 m-b-lg"><?php echo $patient_tab[0]['pharma_cust_age']; ?></div>
								</div>
								<div class="row">
						...
						<div class="vertical-timeline-block" id="visit-details">
							...
							<div class="hrline"><hr></div>
								<div class="row">
									<div class="col-lg-2 m-b-lg"><strong>ADDRESS</strong></div>
									<div class="col-lg-2 m-b-lg"><?php echo $patient_tab[0]['pharma_shipping_address']; ?></div>
									<div class="col-lg-2 m-b-lg"><strong>CITY</strong></div>
									<div class="col-lg-2 m-b-lg"><?php echo $patient_tab[0]['pharma_shipping_city']; ?></div>
								</div>
								
								<div class="row">
									
									<div class="col-lg-2 m-b-lg"><strong>STATE</strong></div>
									<div class="col-lg-2 m-b-lg"><?php echo $patient_tab[0]['pharma_shipping_state']; ?></div>
									<div class="col-lg-2 m-b-lg"><strong>COUNTRY</strong></div>
									<div class="col-lg-2 m-b-lg"><?php echo $patient_tab[0]['pharma_shipping_country']; ?></div>
								</div>
								<div class="row">
									<div class="col-lg-2 m-b-lg"><strong>PINCODE</strong></div>
									<div class="col-lg-2 m-b-lg"><?php echo $patient_tab[0]['pharma_shipping_pincode']; ?></div>
								</div>
							</div>
						</div>
						<div class="vertical-timeline-block" id="visit-details">
							<div class="ibox-content">
								<h2>Customer Note</h2>
								<hr>
								<span style="font-weight: 500;font-size:13px;margin-left:8px;"><?php echo $pharma_referal[0]['customer_note']; ?>
							</div>
						</div>
						...
						<div class="vertical-timeline-block" id="visit-details">
							...
							<?php
								...
								if($pharma_referal[0]['referral_type'] == 1){				//For attachements
											...
											<div class="file-box">
												<div class="file">
													<a href="#">
														...
														<a href="../HealthPharmaAttachments/<?php echo stripslashes($attachList['id']);?>/<?php echo stripslashes($attachList['attachments']);?>" target="_blank"  title="<?php echo stripslashes($attachList['attachments']);?>">
														<div class="image">
							...
							<?php }
								...
								else if($pharma_referal[0]['referral_type'] == 0){											//For EMR 
									if (count($patient_episodes) > 0){ ?>
									<h2>Prescription Details</h2>
									<hr>
								<?php 

								//	echo $pharma_referal[0]['patient_id'];
									
									$patient_episode_count = 0;
									while (list($patient_episode_key, $patient_episode_val) = each($patient_episodes))
									{
										$patient_episode_count--;
										//echo"<br>patient_episode_val =".$patient_episode_val['episode_id'];
								?>
                             
									<?php $get_invest = mysqlSelect("*","doc_patient_episode_prescriptions"," episode_id='". $patient_episode_val['episode_id']."'","","","","");
									if(!empty($get_invest))
									{
									?>
									...
									<tbody>
										...
										<?php
											$count=0;
											foreach($get_invest as $prescription)
											{
												//echo $prescription['prescription_trade_name'];
													
												$count=$count+1;
											?>
										<tr>
											<td><?php echo $count."."; ?></td>
											<td><?php echo $prescription['prescription_trade_name']; ?></td>
											<td><?php echo $prescription['prescription_generic_name']; ?></td>
											<!--td><?php echo $prescription['prescription_frequency'];?></td>
											<td><?php echo $prescription['timing']; ?></td>
							...
							<?php }
									...
									else if($pharma_referal[0]['referral_type'] == 2){						//For Search order medicine  
											...
											?>
												<table class="table table-bordered">
													...
													<tbody>												
														...
														<input type="hidden" name="investigation_id[]" value="<?php echo $value_invest['pti_id']; ?>"/><?php echo $value_invest['prescription_trade_name']; ?></td>
														</tr>												
														<?php }
														?>												
													   </tbody>
									...
									<?php }
								 	...
								 	<div class="vertical-container light-timeline no-margins"style="padding-left:70px; padding-top:35px;" id="visit-details">
										<div class="ibox-content">
											<form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left"  action="my_patient_profile_save.php"  name="frmSMSSubmit" id="frmSMSSubmit">
												<input type="hidden" name="patient_id" value="<?php if($pharma_referal[0]['referral_type'] == 1){ echo $patient_tab[0]['login_id']; } else{ echo $patient_tab[0]['patient_id']; } ?>">
												 <input type="hidden" name="episode_id" value="<?php echo $patient_episodes[0]['episode_id']; ?>">
												 <input type="hidden" name="type" value="<?php if($pharma_referal[0]['referral_type'] == 1){ echo '2'; } else{ echo '1'; } ?>">
												 ...
												 <?php if($pharma_referal[0]['order_status']=='1' || $pharma_referal[0]['order_status']=='2'){ ?>
												 <div class="col-lg-12">
						...
						<?php $doc_patient_reports = mysqlSelect("*","attachment_diagno_pharma","referred_id='".$pharma_referal[0]['pr_id']."' and request_from='2' ","id desc","","","");
					
					?>
						<div class="vertical-container light-timeline no-margins"style="padding-left:70px; padding-top:35px;">
                                ...
                                <div class="feed-activity-list">
									...
									if(in_array($extractPath,$img_type) ) {
										$imgIcon="../HealthPharmaAttachments/".$attachList['id']."/".$attachList['image_name'];
									}
									else if($extractPath=="docx"){
											$imgIcon="../assets/images/doc.png";
									}
									...
									<div class="file-box">
										<div class="file">
											<a href="#">
												<span class="corner"></span>
												<a href="../HealthPharmaAttachments/<?php echo stripslashes($attachList['id']);?>/<?php echo stripslashes($attachList['image_name']);?>" target="_blank"  title="<?php echo stripslashes($attachList['image_name']);?>">
												<div class="image">
													<img alt="image" class="img-responsive" src="<?php echo $imgIcon; ?>">
											...
											<div class="file-name">
													...
													<br/>
													<small><a href="<?php echo "../HealthPharmaAttachments/".$attachList['id']."/".$attachList['image_name']?>" target="_blank"  title="<?php echo stripslashes($attachList['image_name']);?>">View</a> 
													</small>
												</div>
											</a>
