...
{*/
	...
	$TotalRecord = mysqlSelect("*","pharma_referrals","pharma_id='".$admin_id."'","pr_id desc","","","");	
	$total_rows = count($TotalRecord);
	$total_pages = ceil($total_rows / $no_of_records_per_page);
	$allRecord = mysqlSelect("*","pharma_referrals","pharma_id='".$admin_id."'","pr_id desc","","","$offset, $no_of_records_per_page");
	//echo $admin_id;
					...
					<?php if($disp==1) { ?>	
                        <table class="table table-striped">
                            ...
                            <tbody>
							 ...
							 //var_dump($list);
							 //echo"<br>";
							//echo $list['pharma_customer_id'];
								 $getPat = mysqlSelect("pharma_customer_name,pharma_customer_email,pharma_customer_phone","pharma_customer","pharma_customer_id='".$list['pharma_customer_id']."'","","","",""); 
								//var_dump($getPat);
								if($list['referred_by']== "1"){
									//$getRefByDet = mysqlSelect("sub_name","login_user","login_id='".$list['login_id']."'","","","",""); 
									 $refBy='<i class="fa fa-user"></i>  '.$getPat[0]['pharma_customer_name'];
								}
								else{
                            ...
                            <a href="Home"><tr>
                               <td><a href="Customer_Profile_Info?p=<?php echo md5($list['pr_id']); ?>"><?php echo $getPat[0]['pharma_customer_name'];  ?></a></td>
								 <td><?php echo date('M d, Y',strtotime($list['referred_date']));  ?></td>
                                <td><i class="fa fa-envelope"></i> <?php echo $getPat[0]['pharma_customer_email'];  ?><br>
											<i class="fa fa-mobile"></i> <?php echo $getPat[0]['pharma_customer_phone'];  ?></td>
