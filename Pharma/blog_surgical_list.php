...
<head>
    ...
    <title>Welcome to FDC-PIXEL</title>
                    ...
                    <div class="social-feed-box">
                        ...
                        <div class="social-body">
						   ...
						   <?php 
							...
							<div class="btn-group pull-right m-r-xs">
							<a target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo $getPostResult[0]['post_tittle']."...For more info visit : ".HOST_MAIN_URL."Refer/share-blogs/".$getTitle."/".$getPostKey; ?>"  data-size="small"><button class="btn btn-info btn-circle btn-outline" type="button"><i class="fa fa-twitter"></i> 
                            </button></a>
							</div>	
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        <table class="table table-hover no-margins">
                                            ...
                                            <tbody>
											<?php $myPatient = mysqlSelect("patient_name,patient_email,patient_mob","doc_my_patient","doc_id='".$admin_id."'","patient_id desc","","","0,3");
											if(empty($myPatient)){ ?>
