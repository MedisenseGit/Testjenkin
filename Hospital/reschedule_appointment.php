...
function getDocTiming1(val) {
	...
	function getDateFun(date_result,day,selec_date)
	{
		...
		var hosp_id=<?php  echo $admin_id; ?>;//$('#se_depart :selected').val();
					 ...
					 <table class="footable table table-stripped" data-page-size="100" data-filter=#filter>
						...
						<tbody>
							...
							function getDocTiming<?php echo $list['appoint_trans_id']; ?>(docid,val) {
								...
								<td><center>
									<?php if($list['status']!="Cancelled"){ ?>	<a href="#"><i class="fa fa-edit"></i></a> </center><?php } ?>
                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane active">
								...
								<form enctype="multipart/form-data" method="post" action="add_details.php"  name="frmAddPatient" autocomplete="off" >
                                    ...
                                    <div class="col-sm-10"><select data-placeholder="Choose doctor..." class="chosen-select" name="doc_id" id="doc_id" required="required"  tabindex="2" onchange="return getDocDatefun(this.value);">
								...
								<div class="form-group" id="date_section" >
									...
									<!--<label class="col-sm-2 control-label" for="date_added">Preferred Date 4<span class="required">*</span></label>
