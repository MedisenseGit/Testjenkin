...
$checkComplaint= mysqlSelect("drug_abuse_id","drug_abuse_auto","doc_id='".$getpatient[0]['doc_id']."' and doc_type='1'","","","","");
if(COUNT($checkComplaint)>0){
$select= mysqlSelect("*","drug_abuse_auto","(drug_abuse LIKE '%".$searchTerm."%') and ((doc_id='0' and doc_type='0') or (doc_id='".$getpatient[0]['doc_id']."' and doc_type='1'))","drug_abuse asc","","","0,20");
}
else
{
