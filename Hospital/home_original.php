    ...
    <?php include_once('sidemenu.php'); ?>
		...
		<?php include_once('header_top.php'); ?>
			...
			<!--<div class="row" style="margin-left:20px;padding:0px;">
				<div class="col-lg-2" style="margin:40px;padding:10px;background-color:#0040ff; border-radius:10px; box-shadow: 5px 10px 10px;">
					<h3 style="text-align:center;color:#337ab7;margin:35px;color:#ffff"><a><span style="color:#ffff;"><?php echo $_SESSION['tot_result_count']; ?></span></a><br>Teleconsultation</h3>
				</div>
				<div href="Cases-Recieved" class="col-lg-2" style="margin:40px;padding:5px; background-color:#bf00ff;border-radius:10px;box-shadow: 5px 10px 10px;">
					<h3 style="text-align:center;color:#337ab7;margin:38px;color:#ffff"><a><span style="color:#ffff;"><?php echo $_SESSION['tot_result_count']; ?></span></a><br> Second Opinion</h3>
				</div>
				<div class="col-lg-2" style="margin:40px;padding:10px; background-color:#ffbf00;border-radius:5px; box-shadow: 5px 10px 10px;">
					<h3 style="text-align:center;color:#337ab7; margin:35px;color:#ffff"><a><span style="color:#ffff;"><?php echo $_SESSION['tot_result_count']; ?></span></a><br>Order Medicine</h3>
				</div>	
				<div class="col-lg-2" style="margin:40px;padding:10px; background-color:#00ffff;border-radius:10px; box-shadow: 5px 10px 10px;">
					<h3 style="text-align:center;color:#337ab7; margin:35px; color:#ffff"><a><span style="color:#ffff;"><?php echo $_SESSION['tot_result_count']; ?></span></a><br>Order Lab Test</h3>
				</div>		
			</div>
			<div class="row" style="margin-right:100px;padding:0px;">
				<div class="col-lg-6">
					<h2 style="text-align:center;color:#0040ff;">Teleconsultation</h2>
				...
				<div class="col-lg-6">
					<h2 style="text-align:center;color:#bf00ff;">Second Opinion</h2>
					<div class="vertical-timeline-content">
                                <div class="ibox float-e-margins">
			...
			<div class="row" style="margin-right:100px;padding:0px;">
				<div class="col-lg-6">
					<h2 style="text-align:center;color:#ffbf00;">Order Medicine</h2>
					 <div class="vertical-timeline-content">
                                <div class="ibox float-e-margins">
				...
				<div class="col-lg-6">
					<h2 style="text-align:center;">Order Lab Test</h2>
					<div class="vertical-timeline-content">
                                <div class="ibox float-e-margins">
                ...
                <div class="col-md-4">
                    ...
                    <div class="profile-info">
                        <div class="">
                            <div>
                                <h2 class="no-margins">
                                    <?php echo $getCompanyProfile[0]['hosp_name']; ?>
                                </h2>
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        <table class="table table-hover no-margins">
                                            ...
                                            <tbody>
											<?php $casesReceived = mysqlSelect("DISTINCT(a.patient_id) as Patient_Id","patient_tab as a inner join patient_referal as b on a.patient_id=b.patient_id inner join doctor_hosp as c on c.doc_id=b.ref_id inner join hosp_tab as d on d.hosp_id=c.hosp_id","d.hosp_id='".$admin_id."'","b.timestamp desc","","","0,3");
