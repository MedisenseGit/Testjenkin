...
if(isset($_GET['historyid']) && !empty($_GET['historyid'])){
	...
	} else
	{
		...
		$insert_drug=mysqlInsert('doc_patient_family_history_active',$arrFileds,$arrValues);
				...
				$check_history = mysqlSelect("*","doctor_frequent_family_history","family_history_id='".$history_id."' and doc_id='".$getpatient[0]['doc_id']."' and doc_type='1'","","","","");
