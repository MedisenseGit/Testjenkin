    ...
    <?php include_once('sidemenu.php'); ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
				 ...
				 <div class="col-lg-2 mgTop pull-right">
					<a href="Add-Jobs"> <button type="button" class="btn btn-w-m btn-success"><i class="fa fa-rss"></i> Add Jobs</button></a>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
				<?php 
				$getEventResult = mysqlSelect("*","offers_events","company_id='".$admin_id."' and event_type=3","","","","");
												
				if(empty($getEventResult)) { ?>
				<div class="tab-content">			
					<div class="tab-pane m-l-xxl active">
						<center><p>You haven't shared any content on this page so far. <br>Would you like to add a Jobs ?<br>Click here to add</p>
