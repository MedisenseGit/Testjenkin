    ...
    <?php include_once('sidemenu.php'); ?>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
				<?php  
				if($_GET['response']=="Added"){ ?>
					<div class="alert alert-success alert-dismissable">
                                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                               <strong>SUCCESS !! Blogs are posted successfully.</strong>
                     </div>
					<?php 
						}
				$getPostResult = mysqlSelect("*","home_posts","company_id='".$admin_id."' and post_type='blog'","post_id desc","","","");
				...
				<?php } else { ?>
					...
					foreach($getPostResult as $postResultList){
							...
							$postdate=$postResultList['post_date'];	
							$posttitle=$postResultList['post_tittle'];
							$numviews=$postResultList['num_views'];
							$postDescription="<p>".substr(strip_tags($postResultList['post_description']),0,400)."</p>";
