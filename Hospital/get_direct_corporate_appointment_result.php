					...
					<div class="form-horizontal">
							...
							<!-- <h1><?php  //echo "hi". $_SESSION['name'] ?></h1> -->
								...
								<div class="form-group"><label class="col-sm-2 control-label">Subscribe Company <span class="required">*</span></label>
                                    ...
                                    <div class="col-sm-10"><select data-placeholder="Choose doctor..." class="form-control" name="doc_id" id="doc_id" required="required"  tabindex="2" onchange="return getDocDate(this.value);">
